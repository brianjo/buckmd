...
## Class WatchmanDiagnosticEvent {#class-watchmandiagnosticevent .title title="Class WatchmanDiagnosticEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.io.watchman.WatchmanDiagnosticEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class WatchmanDiagnosticEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------- -------------
          `WatchmanDiagnosticEvent​(WatchmanDiagnostic diagnostic)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------- -------------------- -------------
          `WatchmanDiagnostic`   `getDiagnostic()`     
          `String`               `getEventName()`      
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.io.watchman.WatchmanDiagnostic)}
