...
## Class XCodeDescriptionProvider {#class-xcodedescriptionprovider .title title="Class XCodeDescriptionProvider"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.apple.common.XCodeDescriptionProvider
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Extension
        public class XCodeDescriptionProvider
        extends Object
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### XCodeDescriptionProvider
                ...
                public XCodeDescriptionProvider()
    :::
