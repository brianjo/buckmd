...
## Class FinalizingBuildRuleEvent {#class-finalizingbuildruleevent .title title="Class FinalizingBuildRuleEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.core.build.event.FinalizingBuildRuleEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class FinalizingBuildRuleEvent
        extends AbstractBuckEvent

    ::: block
    Event to signal the end of finalize BuildRule stage during building
    of a rule.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +-----------------------+-----------------------+-----------------------+
        | `static void`         | `post                 | ::: block             |
        |                       | Event​(BuckEventBus bu | Posts event of type   |
        |                       | ckEventBus,           | Fin                   |
        |                       | BuildRule buildRule)` | alizingBuildRuleEvent |
        |                       |                       | into                  |
        |                       |                       | [`Buc                 |
        |                       |                       | kEventBus`](../../../ |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        []{#postEvent(com.facebook.buck.event.BuckEventBus,com.facebook.buck.core.rules.BuildRule)}
        ...
        -   #### postEvent
            ...
            ::: block
            Posts event of type FinalizingBuildRuleEvent into
