...
## Class GwtBinaryDescriptionArg {#class-gwtbinarydescriptionarg .title title="Class GwtBinaryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.gwt.GwtBinaryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class GwtBinaryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `GwtBinaryDe          | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static GwtBinaryDe   | `builder()`           | ::: block             |
        ...
        | rtedSet<BuildTarget>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<Boolean>`   | `getDraftCompile()`   | ::: block             |
        |                       |                       | If `true`, the GWT    |
        |                       |                       | Compiler\'s           |
        |                       |                       | `-draftCompile` flag  |
        |                       |                       | will be set.          |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `g                    | ::: block             |
        | ogle.common.collect.I | etExperimentalArgs()` | In practice, these    |
        | mmutableList<String>` |                       | may be values such as |
        |                       |                       | `-Xen                 |
        |                       |                       | ableClosureCompiler`, |
        |                       |                       | `  -Xd                |
        |                       |                       | isableClassMetadata`, |
        ...
        | tableSet<SourcePath>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<Integer>`   | `getLocalWorkers()`   | ::: block             |
        |                       |                       | This will be passed   |
        |                       |                       | to the GWT            |
        |                       |                       | Compiler\'s           |
        |                       |                       | `-localWorkers` flag. |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `com.google.commo     | `getModuleDeps()`     |                       |
        | n.collect.ImmutableSo |                       |                       |
        | rtedSet<BuildTarget>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<Integer>`   | `getOptimize()`       | ::: block             |
        |                       |                       | This will be passed   |
        |                       |                       | to the GWT            |
        |                       |                       | Compiler\'s           |
        |                       |                       | `-optimize` flag.     |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<Boolean>`   | `getStrict()`         | ::: block             |
        |                       |                       | If `true`, the GWT    |
        |                       |                       | Compiler\'s `-strict` |
        |                       |                       | flag will be set.     |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<com.fa      | `getStyle()`          | ::: block             |
        | cebook.buck.features. |                       | This will be passed   |
        | gwt.GwtBinary.Style>` |                       | to the GWT            |
        |                       |                       | Compiler\'s `-style`  |
        |                       |                       | flag.                 |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `getVmArgs()`         | ::: block             |
        | ogle.common.collect.I |                       | In practice, these    |
        | mmutableList<String>` |                       | may be values such as |
        |                       |                       | `-Xmx512m`.           |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getModuleDeps
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSortedSet<BuildTarget> getModuleDeps()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `moduleDeps` attribute
        ...
        -   #### getVmArgs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableList<String> getVmArgs()
            ```
        ...
        -   #### getStyle
            ...
            ``` methodSignature
            public Optional<com.facebook.buck.features.gwt.GwtBinary.Style> getStyle()
            ```
        ...
        -   #### getDraftCompile
            ...
            ``` methodSignature
            public Optional<Boolean> getDraftCompile()
            ```

            ::: block
            If `true`, the GWT Compiler\'s `-draftCompile` flag will be
            set.
            :::
        ...
        -   #### getOptimize
            ...
            ``` methodSignature
            public Optional<Integer> getOptimize()
            ```
        ...
        -   #### getLocalWorkers
            ...
            ``` methodSignature
            public Optional<Integer> getLocalWorkers()
            ```
        ...
        -   #### getExperimentalArgs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableList<String> getExperimentalArgs()
            ```

            ::: block
            In practice, these may be values such as
            `-XenableClosureCompiler`, `  -XdisableClassMetadata`,
            `-XdisableCastChecking`, or `-XfragmentMerge`.
            :::
        ...
        -   #### hashCode
            ...
            `moduleDeps`, `vmArgs`, `style`, `draftCompile`, `optimize`,
            `localWorkers`, `strict`, `experimentalArgs`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `GwtBinaryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static GwtBinaryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new GwtBinaryDescriptionArg builder
    :::
:::
:::
:::
