...
## Enum HaskellLibraryDescription.Type {#enum-haskelllibrarydescription.type .title title="Enum HaskellLibraryDescription.Type"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [java.lang.Enum](http://docs.oracle.com/javase/7/docs/api/java/lang/Enum.html?is-external=true "class or interface in java.lang"){.externalLink}\<[HaskellLibraryDescription.Type](HaskellLibraryDescription.Type.html "enum in com.facebook.buck.features.haskell")\>

    -   -   com.facebook.buck.features.haskell.HaskellLibraryDescription.Type
...
-   
    ...
    :   `FlavorConvertible`, `Serializable`,
        `Comparable<HaskellLibraryDescription.Type>`
    ...
    Enclosing class:
    :   [HaskellLibraryDescription](HaskellLibraryDescription.html "class in com.facebook.buck.features.haskell")

    ------------------------------------------------------------------------

        protected static enum HaskellLibraryDescription.Type
        extends Enum<HaskellLibraryDescription.Type>
...
-   ::: {.section role="region"}
    ...
    -   []{#field.summary}
        ...
        ### Field Summary
          ...
          --------------------------------------------------------- ----------------- -------------
          `static com.google.common.collect.ImmutableSet<Flavor>`   `FLAVOR_VALUES`    
    ...
    -   []{#method.summary}
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `static HaskellLibra  | `values()`            | ::: block             |
    ...
    -   []{#method.detail}
        ...
        -   #### values
            ...
            iterate over the constants as follows:
                for (HaskellLibraryDescription.Type c : HaskellLibraryDescription.Type.values())
