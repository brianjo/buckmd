...
## Class SourceSortedSetTypeCoercer {#class-sourcesortedsettypecoercer .title title="Class SourceSortedSetTypeCoercer"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.rules.coercer.SourceSortedSetConcatable](SourceSortedSetConcatable.html "class in com.facebook.buck.rules.coercer")

    -   -   com.facebook.buck.rules.coercer.SourceSortedSetTypeCoercer

::: description
-   

    All Implemented Interfaces:
    :   `Concatable<SourceSortedSet>`,
        `TypeCoercer<Object,​SourceSortedSet>`

    ------------------------------------------------------------------------

        public class SourceSortedSetTypeCoercer
        extends SourceSortedSetConcatable
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        |                       | urceSortedSet object, | TypeCoercer.          |
        |                       |          TypeCoercer. | :::                   |
        |                       | Traversal traversal)` |                       |
        +-----------------------+-----------------------+-----------------------+
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.rules.coercer.SourceSortedSetConcatable}

            ### Methods inherited from class com.facebook.buck.rules.coercer.[SourceSortedSetConcatable](SourceSortedSetConcatable.html "class in com.facebook.buck.rules.coercer")
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getOutputType
            ...
            ``` methodSignature
            public com.google.common.reflect.TypeToken<SourceSortedSet> getOutputType()
            ```

            [Specified by:]{.overrideSpecifyLabel}
            :   `getOutputType` in
                interface `TypeCoercer<Object,​SourceSortedSet>`
        ...
        []{#traverse(com.facebook.buck.core.cell.nameresolver.CellNameResolver,com.facebook.buck.rules.coercer.SourceSortedSet,com.facebook.buck.rules.coercer.TypeCoercer.Traversal)}

        -   #### traverse

            ``` methodSignature
            public void traverse​(CellNameResolver cellRoots,
                                 SourceSortedSet object,
        ...
        -   #### coerce
            ...
            ``` methodSignature
            public SourceSortedSet coerce​(CellNameResolver cellRoots,
                                          ProjectFilesystem filesystem,
                                          ForwardRelativePath pathRelativeToProjectRoot,
