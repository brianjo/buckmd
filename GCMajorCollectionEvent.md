...
## Class GCMajorCollectionEvent {#class-gcmajorcollectionevent .title title="Class GCMajorCollectionEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.support.jvm.GCCollectionEvent](GCCollectionEvent.html "class in com.facebook.buck.support.jvm")

        -   -   com.facebook.buck.support.jvm.GCMajorCollectionEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public final class GCMajorCollectionEvent
        extends GCCollectionEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------- -------------
          `GCMajorCollectionEvent​(com.sun.management.GcInfo info)`    
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.support.jvm.GCCollectionEvent}

            ### Methods inherited from class com.facebook.buck.support.jvm.[GCCollectionEvent](GCCollectionEvent.html "class in com.facebook.buck.support.jvm")

            `getDurationInMillis, getId, getMemoryUsageAfterGC, getMemoryUsageBeforeGC, getValueString`
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.sun.management.GcInfo)}

        -   #### GCMajorCollectionEvent

                public GCMajorCollectionEvent​(com.sun.management.GcInfo info)
    :::
