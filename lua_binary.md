...
A `lua_library()` rule is used to group together Lua sources to be
packaged into a top-level [`lua_binary`](/rule/lua_binary.html) rule.
...
-   ::: {#main_module}
    ### `main_module`{.argName} [(required)]{.argDefault} [\#](#main_module){.inline-link}
...
-   ::: {#deps}
    ...
    [`lua_library`](/rule/lua_library.html) rules to this binary will
    access.
    :::
