...
## Class GroovyTestDescriptionArg {#class-groovytestdescriptionarg .title title="Class GroovyTestDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.jvm.groovy.GroovyTestDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class GroovyTestDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `GroovyTestDescription.AbstractGroovyTestDescriptionArg`.
    Use the builder to create immutable instances:
    `GroovyTestDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `GroovyTestDe         | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static GroovyTestDe  | `builder()`           | ::: block             |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `getExt               |                       |
        | ogle.common.collect.I | raGroovycArguments()` |                       |
        | mmutableList<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        ...
        <!-- -->
        ```
        -   []{#methods.inherited.from.class.com.facebook.buck.jvm.groovy.GroovyLibraryDescription.CoreArg}

            ### Methods inherited from interface com.facebook.buck.jvm.groovy.[GroovyLibraryDescription.CoreArg](GroovyLibraryDescription.CoreArg.html "interface in com.facebook.buck.jvm.groovy")
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getExtraGroovycArguments
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableList<String> getExtraGroovycArguments()
            ```

            [Specified by:]{.overrideSpecifyLabel}
            :   `getExtraGroovycArguments` in
                interface `GroovyLibraryDescription.CoreArg`

            [Returns:]{.returnLabel}
            :   The value of the `extraGroovycArguments` attribute
        ...
        -   #### equals
            ...
            `GroovyTestDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            `extraGroovycArguments`, `resources`, `proguardConfig`,
            `postprocessClassesCommands`, `resourcesRoot`,
            `unbundledResourcesRoot`, `manifestFile`, `mavenCoords`,
            `mavenPomTemplate`, `exportedDeps`, `sourceOnlyAbiDeps`,
            `runtimeDeps`, `source`, `target`, `javaVersion`, `javac`,
            `javacJar`, `compilerClassName`, `compiler`,
            `extraArguments`, `removeClasses`,
            `annotationProcessorDeps`, `annotationProcessorParams`,
            `javaPluginParams`, `annotationProcessors`,
            `annotationProcessorOnly`, `plugins`, `compileAgainst`,
            ...
            `exportedProvidedDeps`, `srcs`, `tests`, `vmArgs`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `GroovyTestDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static GroovyTestDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new GroovyTestDescriptionArg builder
    :::
:::
:::
:::
