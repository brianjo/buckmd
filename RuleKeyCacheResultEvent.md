...
## Class RuleKeyCacheResultEvent {#class-rulekeycacheresultevent .title title="Class RuleKeyCacheResultEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.artifact_cache.RuleKeyCacheResultEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class RuleKeyCacheResultEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------- -------------
          `RuleKeyCacheResultEvent​(RuleKeyCacheResult ruleKeyCacheResult,                        boolean cacheHitExpected)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------- --------------------------- -------------
          `String`               `getEventName()`             
          `RuleKeyCacheResult`   `getRuleKeyCacheResult()`    
          `protected String`     `getValueString()`           
          `boolean`              `isCacheHitExpected()`       
