...
The host_info() function is used to get processor and OS information
about the host machine The `host_info()` function is used to get the
current OS and processor architecture on the host. This will likely
change as better cross compilation tooling comes to Buck.
