...
## Class DTestDescriptionArg {#class-dtestdescriptionarg .title title="Class DTestDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.d.DTestDescriptionArg
...
-   
    ...
    :   `BuildRuleArg`, `ConstructorArg`, `DataTransferObject`,
        `HasContacts`, `HasDeclaredDeps`, `HasTestTimeout`
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class DTestDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `DTestDescription.AbstractDTestDescriptionArg`.
    Use the builder to create immutable instances:
    `DTestDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `DTestDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            `licenses`, `name`, `contacts`, `deps`, `testRuleTimeoutMs`.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `DTestDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static DTestDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new DTestDescriptionArg builder
    :::
:::
:::
:::
