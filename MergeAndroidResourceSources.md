...
## Class MergeAndroidResourceSources {#class-mergeandroidresourcesources .title title="Class MergeAndroidResourceSources"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../../core/rules/impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   com.facebook.buck.android.aapt.MergeAndroidResourceSources
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class MergeAndroidResourceSources
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `MergeAndroidResourceSources​(BuildTarget buildTarget,                            ProjectFilesystem projectFilesystem,                            SourcePathRuleFinder ruleFinder,                            com.google.common.collect.ImmutableCollection<SourcePath> directories)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### MergeAndroidResourceSources
                ...
                public MergeAndroidResourceSources​(BuildTarget buildTarget,
                                                   ProjectFilesystem projectFilesystem,
                                                   SourcePathRuleFinder ruleFinder,
                                                   com.google.common.collect.ImmutableCollection<SourcePath> directories)
    :::
