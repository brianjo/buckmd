...
::: overview
Kill *all* the [Buck Daemon (`buckd`)](/concept/buckd.html) processes
that are running on the host computer.

To kill only the Buck Daemon process for the *current* Buck
[project](/about/overview.html), use [`buck kill`](/command/kill.html).
