...
## Class ExperimentEvent {#class-experimentevent .title title="Class ExperimentEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.ExperimentEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `ExperimentEvent​(String tag,                String variant,                String propertyName,                Long value,                String content)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(java.lang.String,java.lang.String,java.lang.String,java.lang.Long,java.lang.String)}

        -   #### ExperimentEvent

                public ExperimentEvent​(String tag,
                                       String variant,
                                       String propertyName,
                                       @Nullable
                                       Long value,
