...
## Interface RuleKeyCalculationEvent.Finished {#interface-rulekeycalculationevent.finished .title title="Interface RuleKeyCalculationEvent.Finished"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static interface RuleKeyCalculationEvent.Finished
        extends RuleKeyCalculationEvent
:::
