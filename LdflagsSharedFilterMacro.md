...
## Class LdflagsSharedFilterMacro {#class-ldflagssharedfiltermacro .title title="Class LdflagsSharedFilterMacro"}
:::
...
-   -   [com.facebook.buck.rules.macros.CxxGenruleFilterAndTargetsMacro](CxxGenruleFilterAndTargetsMacro.html "class in com.facebook.buck.rules.macros")
    ...
    -   -   com.facebook.buck.rules.macros.LdflagsSharedFilterMacro
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class LdflagsSharedFilterMacro
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static LdflagsSharedFilterMacro`   `of​(Optional<Pattern> pattern,   com.google.common.collect.ImmutableList<BuildTarget> buildTargets)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### LdflagsSharedFilterMacro
                ...
                public LdflagsSharedFilterMacro()
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### of
            ...
            ``` methodSignature
            public static LdflagsSharedFilterMacro of​(Optional<Pattern> pattern,
