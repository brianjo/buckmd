...
## Class ScalaTestDescriptionArg {#class-scalatestdescriptionarg .title title="Class ScalaTestDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ScalaTestDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `ScalaTestDescription.AbstractScalaTestDescriptionArg`.
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `ScalaTestDe          | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static ScalaTestDe   | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `ScalaTestDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `ScalaTestDescriptionArg` with
            attribute values.
            :::
