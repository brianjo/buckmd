...
## Class RetryingException {#class-retryingexception .title title="Class RetryingException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class RetryingException
        extends IOException

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.core.exceptions.RetryingException)
:::
