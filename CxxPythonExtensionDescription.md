...
## Class CxxPythonExtensionDescription {#class-cxxpythonextensiondescription .title title="Class CxxPythonExtensionDescription"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.python.CxxPythonExtensionDescription

::: description
-   

    All Implemented Interfaces:
    :   `ImplicitDepsInferringDescription<com.facebook.buck.features.python.CxxPythonExtensionDescription.AbstractCxxPythonExtensionDescriptionArg>`,
        `BaseDescription<CxxPythonExtensionDescriptionArg>`,
        `Description<CxxPythonExtensionDescriptionArg>`, `Flavored`,
        `DescriptionWithTargetGraph<CxxPythonExtensionDescriptionArg>`,
    ...
    ------------------------------------------------------------------------
        ...
        extends Object
        implements DescriptionWithTargetGraph<CxxPythonExtensionDescriptionArg>, ImplicitDepsInferringDescription<com.facebook.buck.features.python.CxxPythonExtensionDescription.AbstractCxxPythonExtensionDescriptionArg>, VersionPropagator<CxxPythonExtensionDescriptionArg>, Flavored
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- -------------------------------------- -------------
          `static class `     `CxxPythonExtensionDescription.Type`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------------------------- -------------
          `CxxPythonExtensionDescription​(ToolchainProvider toolchainProvider,                              CxxBuckConfig cxxBuckConfig)`    
    ...
    -   []{#method.summary}
        ...
        |                       | ionContextWithTargetG | [`Buil                |
        |                       | raph context,         | dRule`](../../core/ru |
        ...
        |                       |    CxxPythonExtension | [`BuildRulePara       |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `void`                | `findDepsFo           |                       |
        |                       | rTargetFromConstructo |                       |
        |                       | rArgs​(BuildTarget bui |                       |
        |                       | ldTarget,             |                       |
        |                       |                       |                       |
        |                       |     CellNameResolver  |                       |
        |                       | cellRoots,            |                       |
        |                       |                       |                       |
        |                       |      com.facebook.buc |                       |
        |                       | k.features.python.Cxx |                       |
        |                       | PythonExtensionDescri |                       |
        |                       | ption.AbstractCxxPyth |                       |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `Class<CxxPythonExte  | `get                  | ::: block             |
        | nsionDescriptionArg>` | ConstructorArgType()` | The type of the       |
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### CxxPythonExtensionDescription
                ...
                public CxxPythonExtensionDescription​(ToolchainProvider toolchainProvider,
    ...
    -   []{#method.detail}
        ...
        -   #### getConstructorArgType
            ...
            :   `getConstructorArgType` in
                interface `BaseDescription<CxxPythonExtensionDescriptionArg>`

        []{#createBuildRule(com.facebook.buck.core.rules.BuildRuleCreationContextWithTargetGraph,com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.features.python.CxxPythonExtensionDescriptionArg)}
        ...
        -   #### createBuildRule
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createBuildRule` in
                interface `DescriptionWithTargetGraph<CxxPythonExtensionDescriptionArg>`
        ...
        -   #### findDepsForTargetFromConstructorArgs
            ...
            public void findDepsForTargetFromConstructorArgs​(BuildTarget buildTarget,
                                                             ...
                                                             com.facebook.buck.features.python.CxxPythonExtensionDescription.AbstractCxxPythonExtensionDescriptionArg constructorArg,
            ...
            :   `findDepsForTargetFromConstructorArgs` in
                interface `ImplicitDepsInferringDescription<com.facebook.buck.features.python.CxxPythonExtensionDescription.AbstractCxxPythonExtensionDescriptionArg>`
        ...
        -   #### producesCacheableSubgraph
            ...
            :   `producesCacheableSubgraph` in
                interface `Description<CxxPythonExtensionDescriptionArg>`
