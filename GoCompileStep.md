...
## Class GoCompileStep {#class-gocompilestep .title title="Class GoCompileStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.go.GoCompileStep
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `GoCompileStep​(Path workingDirectory,              com.google.common.collect.ImmutableMap<String,​String> environment,              com.google.common.collect.ImmutableList<String> compilerCommandPrefix,              com.google.common.collect.ImmutableList<String> flags,              Path packageName,              Iterable<Path> srcs,              Iterable<Path> asmSrcs,              com.google.common.collect.ImmutableMap<Path,​Path> importPathMap,              com.google.common.collect.ImmutableList<Path> includeDirectories,              Optional<Path> asmHeaderPath,              boolean allowExternalReferences,              com.facebook.buck.features.go.GoPlatform platform,              Optional<Path> asmSymabisPath,              Path output)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(java.nio.file.Path,com.google.common.collect.ImmutableMap,com.google.common.collect.ImmutableList,com.google.common.collect.ImmutableList,java.nio.file.Path,java.lang.Iterable,java.lang.Iterable,com.google.common.collect.ImmutableMap,com.google.common.collect.ImmutableList,java.util.Optional,boolean,com.facebook.buck.features.go.GoPlatform,java.util.Optional,java.nio.file.Path)}

        -   #### GoCompileStep

                public GoCompileStep​(Path workingDirectory,
                                     com.google.common.collect.ImmutableMap<String,​String> environment,
                                     com.google.common.collect.ImmutableList<String> compilerCommandPrefix,
                                     ...
                                     com.google.common.collect.ImmutableList<Path> includeDirectories,
