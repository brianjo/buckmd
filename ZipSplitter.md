...
## Interface ZipSplitter {#interface-zipsplitter .title title="Interface ZipSplitter"}
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- -------------------------------- -------------
          `static class `     `ZipSplitter.DexSplitStrategy`    
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### execute
            ...
            ``` methodSignature
            com.google.common.collect.ImmutableMultimap<APKModule,​Path> execute()
                                                                               throws IOException
            ```
