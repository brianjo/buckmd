...
## Class OcamlCCompileStep {#class-ocamlccompilestep .title title="Class OcamlCCompileStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.ocaml.OcamlCCompileStep
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class OcamlCCompileStep
        extends ShellStep
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `Oc                   | ::: block             |
        |                       | amlCCompileStep.Args` | OcamlCCompile rule    |
        |                       |                       | args.                 |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
