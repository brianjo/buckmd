...
## Class TestSuiteDescriptionArg {#class-testsuitedescriptionarg .title title="Class TestSuiteDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.shell.TestSuiteDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class TestSuiteDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `TestSuiteDe          | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static TestSuiteDe   | `builder()`           | ::: block             |
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `com.google.commo     | `getTests()`          | ::: block             |
        | n.collect.ImmutableSo |                       | Test or TestSuite     |
        | rtedSet<BuildTarget>` |                       | targets that should   |
        |                       |                       | be invoked when this  |
        |                       |                       | rule run through buck |
        |                       |                       | test                  |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `int`                 | `hashCode()`          | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getTests
            ...
            ::: block
            Test or TestSuite targets that should be invoked when this
            rule run through buck test
            :::
        ...
        -   #### equals
            ...
            `TestSuiteDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `tests`, `licenses`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `TestSuiteDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static TestSuiteDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new TestSuiteDescriptionArg builder
    :::
:::
:::
:::
