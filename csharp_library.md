...
-   ::: {#dll_name}
    ### `dll_name`{.argName} [(defaults to `The name of the target appended with .dll`)]{.argDefault} [\#](#dll_name){.inline-link}
...
-   ::: {#resources}
    ### `resources`{.argName} [(required)]{.argDefault} [\#](#resources){.inline-link}
...
-   ::: {#framework_ver}
    ### `framework_ver`{.argName} [(required)]{.argDefault} [\#](#framework_ver){.inline-link}
...
-   ::: {#deps}
    ...
    values that are targets must be either csharp_library or
...
tests](https://github.com/facebook/buck/tree/master/test/com/facebook/buck/features/rust/testdata/).
