...
## Class PBXContainerItem {#class-pbxcontaineritem .title title="Class PBXContainerItem"}
:::
...
-   
    ...
    :   `PBXContainerItemProxy`, `PBXProjectItem`, `PBXReference`

    ------------------------------------------------------------------------

        public abstract class PBXContainerItem
        extends PBXObject

    ::: block
    Superclass in Xcode\'s object hierarchy, has no non-structural
    functionality here.
    :::
:::
