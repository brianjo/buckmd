...
## Interface Protocol.OutputDirectory {#interface-protocol.outputdirectory .title title="Interface Protocol.OutputDirectory"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static interface Protocol.OutputDirectory
