...
## Class JarGenruleDescriptionArg {#class-jargenruledescriptionarg .title title="Class JarGenruleDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class JarGenruleDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `JarGenruleDe         | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static JarGenruleDe  | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `bash`, `cmd`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `JarGenruleDescriptionArg` with
            attribute values.
            :::
