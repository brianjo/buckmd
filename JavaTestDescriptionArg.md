...
## Class JavaTestDescriptionArg {#class-javatestdescriptionarg .title title="Class JavaTestDescriptionArg"}
:::
...
-   
    ...
    :   `BuildRuleArg`, `ConstructorArg`, `DataTransferObject`,
        ...
        `HasTests`, `HasTestTimeout`, `HasTestRunner`,
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class JavaTestDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static JavaTestDe    | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `vmArgs`, `testType`,
            `runTestSeparately`, `forkMode`, `stdErrLogLevel`,
            `stdOutLogLevel`, `useCxxLibraries`, `cxxLibraryWhitelist`,
            `testCaseTimeoutMs`, `env`, `defaultCxxPlatform`,
            `contacts`, `testRuleTimeoutMs`, `resources`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `JavaTestDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static JavaTestDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new JavaTestDescriptionArg builder
    :::
:::
:::
:::
