...
## Class CoreDataModelDescription {#class-coredatamodeldescription .title title="Class CoreDataModelDescription"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.apple.CoreDataModelDescription
...
-   
    ...
    ::: block
    Description for a core_data_model rule, which identifies a model
    file for use with Apple\'s Core Data.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        |                       | TargetConfiguration)` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `static boolean`      | `isVersio             |                       |
        |                       | nedDataModel​(AppleWra |                       |
        |                       | pperResourceArg arg)` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### CoreDataModelDescription
                ...
                public CoreDataModelDescription()
    :::
    ...
    -   []{#method.detail}
        ...
        []{#isVersionedDataModel(com.facebook.buck.apple.AppleWrapperResourceArg)}

        -   #### isVersionedDataModel
