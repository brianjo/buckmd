...
## Interface FilterResourcesSteps.DrawableFinder {#interface-filterresourcessteps.drawablefinder .title title="Interface FilterResourcesSteps.DrawableFinder"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static interface FilterResourcesSteps.DrawableFinder
:::
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### findDrawables
            ...
            ``` methodSignature
            com.google.common.collect.ImmutableSet<Path> findDrawables​(Collection<Path> dirs,
