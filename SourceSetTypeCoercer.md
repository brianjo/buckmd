...
## Class SourceSetTypeCoercer {#class-sourcesettypecoercer .title title="Class SourceSetTypeCoercer"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.rules.coercer.SourceSetConcatable](SourceSetConcatable.html "class in com.facebook.buck.rules.coercer")

    -   -   com.facebook.buck.rules.coercer.SourceSetTypeCoercer

::: description
-   

    All Implemented Interfaces:
    :   `Concatable<SourceSet>`, `TypeCoercer<Object,​SourceSet>`

    ------------------------------------------------------------------------

        public class SourceSetTypeCoercer
        extends SourceSetConcatable
        implements TypeCoercer<Object,​SourceSet>

    ::: block
    Coerce to
    [`SourceSet`](SourceSet.html "class in com.facebook.buck.rules.coercer").
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `void`                | `traverse​(CellNameRes | ::: block             |
        |                       | olver cellRoots,      | Traverse an object    |
        |                       |     SourceSet object, | guided by this        |
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.rules.coercer.SourceSetConcatable}

            ### Methods inherited from class com.facebook.buck.rules.coercer.[SourceSetConcatable](SourceSetConcatable.html "class in com.facebook.buck.rules.coercer")
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getOutputType
            ...
            ``` methodSignature
            public com.google.common.reflect.TypeToken<SourceSet> getOutputType()
            ```

            [Specified by:]{.overrideSpecifyLabel}
            :   `getOutputType` in
                interface `TypeCoercer<Object,​SourceSet>`
        ...
        []{#traverse(com.facebook.buck.core.cell.nameresolver.CellNameResolver,com.facebook.buck.rules.coercer.SourceSet,com.facebook.buck.rules.coercer.TypeCoercer.Traversal)}
        ...
        -   #### traverse
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `traverse` in interface `TypeCoercer<Object,​SourceSet>`
        ...
        -   #### coerce
            ...
            ``` methodSignature
            public SourceSet coerce​(CellNameResolver cellRoots,
                                    ProjectFilesystem filesystem,
                                    ForwardRelativePath pathRelativeToProjectRoot,
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `coerce` in interface `TypeCoercer<Object,​SourceSet>`
