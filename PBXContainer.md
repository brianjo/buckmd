...
## Class PBXContainer {#class-pbxcontainer .title title="Class PBXContainer"}
:::
...
-   -   [com.facebook.buck.apple.xcode.xcodeproj.PBXObject](PBXObject.html "class in com.facebook.buck.apple.xcode.xcodeproj")
    ...
    -   -   com.facebook.buck.apple.xcode.xcodeproj.PBXContainer
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class PBXContainer
        extends PBXObject

    ::: block
    Superclass of all container types. This is here to reflect Xcode\'s
    object hierarchy, and does not implement any special functionality.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.apple.xcode.xcodeproj.PBXObject}
            ...
            `generateGid, getGlobalID, serializeInto, setGlobalID, stableHash, toString`
