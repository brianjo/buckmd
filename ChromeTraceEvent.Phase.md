...
## Enum ChromeTraceEvent.Phase {#enum-chrometraceevent.phase .title title="Enum ChromeTraceEvent.Phase"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [java.lang.Enum](http://docs.oracle.com/javase/7/docs/api/java/lang/Enum.html?is-external=true "class or interface in java.lang"){.externalLink}\<[ChromeTraceEvent.Phase](ChromeTraceEvent.Phase.html "enum in com.facebook.buck.event.chrome_trace")\>

    -   -   com.facebook.buck.event.chrome_trace.ChromeTraceEvent.Phase

::: description
-   

    All Implemented Interfaces:
    :   `Serializable`, `Comparable<ChromeTraceEvent.Phase>`
    ...
    ------------------------------------------------------------------------
        ...
        public static enum ChromeTraceEvent.Phase
        extends Enum<ChromeTraceEvent.Phase>
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static Ch            | `                     | ::: block             |
        | romeTraceEvent.Phase` | valueOf​(String name)` | Returns the enum      |
        |                       |                       | constant of this type |
        |                       |                       | with the specified    |
        |                       |                       | name.                 |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `static Chro          | `values()`            | ::: block             |
        | meTraceEvent.Phase[]` |                       | Returns an array      |
        |                       |                       | containing the        |
        |                       |                       | constants of this     |
        |                       |                       | enum type, in the     |
        |                       |                       | order they are        |
    ...
    -   []{#method.detail}
        ...
        -   #### values
            ...
            iterate over the constants as follows:
                for (ChromeTraceEvent.Phase c : ChromeTraceEvent.Phase.values())
