...
## Class PrebuiltDotnetLibraryDescriptionArg {#class-prebuiltdotnetlibrarydescriptionarg .title title="Class PrebuiltDotnetLibraryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.dotnet.PrebuiltDotnetLibraryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class PrebuiltDotnetLibraryDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `PrebuiltDotnetLibraryDescription.AbstractPrebuiltDotnetLibraryDescriptionArg`.
    Use the builder to create immutable instances:
    `PrebuiltDotnetLibraryDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        |                       | ebuiltDotnetLibraryDe | Builds instances of   |
    ...
    -   []{#method.summary}
        ...
        | ebuiltDotnetLibraryDe |                       | Creates a builder for |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getAssembly
            ...
            ``` methodSignature
            public SourcePath getAssembly()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `assembly` attribute
        ...
        -   #### equals
            ...
            `PrebuiltDotnetLibraryDescriptionArg` that have equal
            attribute values.
            :::
        ...
        -   #### toString
            ...
            `PrebuiltDotnetLibraryDescriptionArg` with attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static PrebuiltDotnetLibraryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new PrebuiltDotnetLibraryDescriptionArg builder
    :::
:::
:::
:::
