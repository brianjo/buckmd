...
## Class LoadBalancedServiceEvent {#class-loadbalancedserviceevent .title title="Class LoadBalancedServiceEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.slb.LoadBalancedServiceEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class LoadBalancedServiceEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          --------------------- --------------------------------------------------------- -------------
          `static interface `   `LoadBalancedServiceEvent.LoadBalancedServiceEventData`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- ---------------------------------------------------------------------------------------- -------------
          `protected `   `LoadBalancedServiceEvent​(LoadBalancedServiceEvent.LoadBalancedServiceEventData data)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          --------------------------------------------------------- -------------------- -------------
          `LoadBalancedServiceEvent.LoadBalancedServiceEventData`   `getData()`           
          `String`                                                  `getEventName()`      
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.slb.LoadBalancedServiceEvent.LoadBalancedServiceEventData)}
    ...
    -   []{#method.detail}
        ...
        -   #### getData
            ...
            ``` methodSignature
            public LoadBalancedServiceEvent.LoadBalancedServiceEventData getData()
            ```
