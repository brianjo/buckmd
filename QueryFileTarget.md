...
## Class QueryFileTarget {#class-queryfiletarget .title title="Class QueryFileTarget"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public final class QueryFileTarget
        extends Object
...
-   ::: {.section role="region"}
    -   []{#method.summary}
        ...
        | `int`                 | `hashCode()`          |                       |
        +-----------------------+-----------------------+-----------------------+
        | `st                   | `of​(SourcePath path)` | ::: block             |
        | atic QueryFileTarget` |                       | Construct a new       |
        |                       |                       | immutable             |
        |                       |                       | `QueryFileTarget`     |
        |                       |                       | instance.             |
        |                       |                       | :::                   |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### of
            ...
            [Returns:]{.returnLabel}
            :   An immutable QueryFileTarget instance
