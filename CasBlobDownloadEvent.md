...
## Class CasBlobDownloadEvent {#class-casblobdownloadevent .title title="Class CasBlobDownloadEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.remoteexecution.event.CasBlobDownloadEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class CasBlobDownloadEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `CasBlobDo            | ::: block             |
        |                       | wnloadEvent.Finished` | Download to the CAS   |
        |                       |                       | has finished.         |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `static class `       | `CasBlobD             | ::: block             |
        |                       | ownloadEvent.Started` | Download to the CAS   |
        |                       |                       | has started.          |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
