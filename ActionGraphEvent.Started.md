...
## Class ActionGraphEvent.Started {#class-actiongraphevent.started .title title="Class ActionGraphEvent.Started"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.event.ActionGraphEvent](ActionGraphEvent.html "class in com.facebook.buck.event")
        ...
        -   -   com.facebook.buck.event.ActionGraphEvent.Started
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class ActionGraphEvent.Started
