...
## Class VersionException {#class-versionexception .title title="Class VersionException"}
:::
...
-   
    ...
    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../serialized-form.html#com.facebook.buck.versions.VersionException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------------------- -------------
          `VersionException​(BuildTarget root,                 String message)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### VersionException
                ...
                public VersionException​(BuildTarget root,
                                        String message)

            [Parameters:]{.paramLabel}
            :   `root` - The root of the version sub-graph that failed.
    :::
:::
:::
:::
