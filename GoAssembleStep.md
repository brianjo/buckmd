...
## Class GoAssembleStep {#class-goassemblestep .title title="Class GoAssembleStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.go.GoAssembleStep
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `GoAssembleStep​(AbsPath workingDirectory,               com.google.common.collect.ImmutableMap<String,​String> environment,               com.google.common.collect.ImmutableList<String> asmCommandPrefix,               com.google.common.collect.ImmutableList<String> flags,               Iterable<Path> srcs,               com.google.common.collect.ImmutableList<Path> includeDirectories,               com.facebook.buck.features.go.GoPlatform platform,               Path output)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.google.common.collect.ImmutableMap,com.google.common.collect.ImmutableList,com.google.common.collect.ImmutableList,java.lang.Iterable,com.google.common.collect.ImmutableList,com.facebook.buck.features.go.GoPlatform,java.nio.file.Path)}

        -   #### GoAssembleStep

                public GoAssembleStep​(AbsPath workingDirectory,
                                      com.google.common.collect.ImmutableMap<String,​String> environment,
                                      com.google.common.collect.ImmutableList<String> asmCommandPrefix,
