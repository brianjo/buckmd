...
## Class ArtifactCacheConnectEvent {#class-artifactcacheconnectevent .title title="Class ArtifactCacheConnectEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.artifact_cache.ArtifactCacheConnectEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class ArtifactCacheConnectEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- -------------------------------------- -------------
          `static class `     `ArtifactCacheConnectEvent.Finished`    
          `static class `     `ArtifactCacheConnectEvent.Started`     
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------ -------------
          `ArtifactCacheConnectEvent​(EventKey eventKey)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          --------------------------------------------- ------------------------------------------------------- -------------
          `static ArtifactCacheConnectEvent.Finished`   `finished​(ArtifactCacheConnectEvent.Started started)`    
          `String`                                      `getCategory()`                                          
          `String`                                      `getValueString()`                                       
          `static ArtifactCacheConnectEvent.Started`    `started()`                                              
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### started
            ...
            ``` methodSignature
            public static ArtifactCacheConnectEvent.Started started()
            ```

        []{#finished(com.facebook.buck.artifact_cache.ArtifactCacheConnectEvent.Started)}

        -   #### finished

            ``` methodSignature
            public static ArtifactCacheConnectEvent.Finished finished​(ArtifactCacheConnectEvent.Started started)
            ```
    :::
:::
:::
