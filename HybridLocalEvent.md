...
## Class HybridLocalEvent {#class-hybridlocalevent .title title="Class HybridLocalEvent"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class HybridLocalEvent
        extends AbstractBuckEvent

    ::: block
    Tracks events related to
    [`HybridLocalStrategy`](HybridLocalStrategy.html "class in com.facebook.buck.rules.modern.builders").
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `Hyb                  | ::: block             |
        |                       | ridLocalEvent.Stolen` | When the              |
        |                       |                       | HybridLocalStrategy   |
        |                       |                       | steals a delegate     |
        |                       |                       | strategy and starts   |
        |                       |                       | processing it         |
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------------------- ----------------------------------------- -------------
          `static HybridLocalEvent.Stolen`   `createStolen​(BuildTarget buildTarget)`    
          `String`                           `getEventName()`                           
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        []{#createStolen(com.facebook.buck.core.model.BuildTarget)}
