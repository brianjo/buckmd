...
## Class TestSuiteDescription {#class-testsuitedescription .title title="Class TestSuiteDescription"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        extends Object
        implements DescriptionWithTargetGraph<TestSuiteDescriptionArg>

    ::: block
    Produces rules used to logically group tests, allowing \`buck test
    //:some_test_suite\` behavior that invokes all tests that this suite
    depends on. Also validates that created rules only depend on Test
    rules and TestSuite rules.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `Class<Test           | `get                  | ::: block             |
        | SuiteDescriptionArg>` | ConstructorArgType()` | The type of the       |
    ...
    -   []{#method.detail}
        ...
        -   #### getConstructorArgType
            ...
            :   `getConstructorArgType` in
                interface `BaseDescription<TestSuiteDescriptionArg>`

        []{#createBuildRule(com.facebook.buck.core.rules.BuildRuleCreationContextWithTargetGraph,com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.shell.TestSuiteDescriptionArg)}

        -   #### createBuildRule

            ``` methodSignature
            public TestSuite createBuildRule​(BuildRuleCreationContextWithTargetGraph context,
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createBuildRule` in
                interface `DescriptionWithTargetGraph<TestSuiteDescriptionArg>`
