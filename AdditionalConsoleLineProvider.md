...
::: header
::: subTitle
[Package]{.packageLabelInType} [com.facebook.buck.event.listener.interfaces](package-summary.html)
:::

## Interface AdditionalConsoleLineProvider {#interface-additionalconsolelineprovider .title title="Interface AdditionalConsoleLineProvider"}
:::
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### createConsoleLinesAtTime
            ...
            ``` methodSignature
            com.google.common.collect.ImmutableList<String> createConsoleLinesAtTime​(long currentTimeMillis)
            ```
