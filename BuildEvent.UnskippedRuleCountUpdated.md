...
## Class BuildEvent.UnskippedRuleCountUpdated {#class-buildevent.unskippedrulecountupdated .title title="Class BuildEvent.UnskippedRuleCountUpdated"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.core.build.event.BuildEvent](BuildEvent.html "class in com.facebook.buck.core.build.event")
        ...
        -   -   com.facebook.buck.core.build.event.BuildEvent.UnskippedRuleCountUpdated
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class BuildEvent.UnskippedRuleCountUpdated
        extends BuildEvent
:::
