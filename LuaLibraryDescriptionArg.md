...
## Class LuaLibraryDescriptionArg {#class-lualibrarydescriptionarg .title title="Class LuaLibraryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.lua.LuaLibraryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class LuaLibraryDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `LuaLibraryDescription.AbstractLuaLibraryDescriptionArg`.
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `LuaLibraryDe         | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static LuaLibraryDe  | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `LuaLibraryDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `srcs`, `baseModule`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `LuaLibraryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static LuaLibraryDescriptionArg.Builder builder()
            ```

            ::: block
            Creates a builder for
            [`LuaLibraryDescriptionArg`](LuaLibraryDescriptionArg.html "class in com.facebook.buck.features.lua").
            :::

            [Returns:]{.returnLabel}
            :   A new LuaLibraryDescriptionArg builder
    :::
:::
:::
:::
