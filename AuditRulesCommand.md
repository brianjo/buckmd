...
## Class AuditRulesCommand {#class-auditrulescommand .title title="Class AuditRulesCommand"}
:::
...
-   -   [com.facebook.buck.cli.CommandWithPluginManager](CommandWithPluginManager.html "class in com.facebook.buck.cli")
    ...
    -   -   [com.facebook.buck.cli.AbstractCommand](AbstractCommand.html "class in com.facebook.buck.cli")
        ...
        -   -   com.facebook.buck.cli.AuditRulesCommand
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class AuditRulesCommand
        extends AbstractCommand

    ::: block
    Evaluates a build file and prints out an equivalent build file with
    all includes/macros expanded. When complex macros are in play, this
    helps clarify what the resulting build rule definitions are.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `com.google.common.collect.ImmutableSet<String>`   `getTypes()`                                    
          `boolean`                                          `isReadOnly()`                                  
