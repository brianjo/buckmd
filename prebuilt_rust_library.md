...
Note: Buck is currently tested with (and therefore supports) version
1.32.0 of Rust.
...
-   ::: {#rlib}
    ### `rlib`{.argName} [(required)]{.argDefault} [\#](#rlib){.inline-link}
...
-   ::: {#crate}
    ### `crate`{.argName} [(defaults to `rule name`)]{.argDefault} [\#](#crate){.inline-link}
