...
## Class KotlinLibraryDescriptionArg {#class-kotlinlibrarydescriptionarg .title title="Class KotlinLibraryDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class KotlinLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `KotlinLibraryDe      | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `s                    | `builder()`           | ::: block             |
        | tatic KotlinLibraryDe |                       | Creates a builder for |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `KotlinLibraryDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `KotlinLibraryDescriptionArg`
