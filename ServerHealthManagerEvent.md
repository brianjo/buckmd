...
## Class ServerHealthManagerEvent {#class-serverhealthmanagerevent .title title="Class ServerHealthManagerEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.slb.ServerHealthManagerEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class ServerHealthManagerEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- --------------------------------------------------------- -------------
          `static class `     `ServerHealthManagerEvent.PerServerData`                   
          `static class `     `ServerHealthManagerEvent.ServerHealthManagerEventData`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- ---------------------------------------------------------------------------------------- -------------
          `protected `   `ServerHealthManagerEvent​(ServerHealthManagerEvent.ServerHealthManagerEventData data)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          --------------------------------------------------------- -------------------- -------------
          `ServerHealthManagerEvent.ServerHealthManagerEventData`   `getData()`           
          `String`                                                  `getEventName()`      
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.slb.ServerHealthManagerEvent.ServerHealthManagerEventData)}
    ...
    -   []{#method.detail}
        ...
        -   #### getData
            ...
            ``` methodSignature
            public ServerHealthManagerEvent.ServerHealthManagerEventData getData()
            ```
