...
## Class ZipFileDescriptionArg {#class-zipfiledescriptionarg .title title="Class ZipFileDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.zip.rules.ZipFileDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ZipFileDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `ZipFileDescription.AbstractZipFileDescriptionArg`.
    Use the builder to create immutable instances:
    `ZipFileDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static ZipFileDe     | `builder()`           | ::: block             |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `g                    |                       |
        | ogle.common.collect.I | etEntriesToExclude()` |                       |
        | mmutableSet<Pattern>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getSrcs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSet<SourcePath> getSrcs()
            ```
        ...
        -   #### getEntriesToExclude
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSet<Pattern> getEntriesToExclude()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `entriesToExclude` attribute
        ...
        -   #### getZipSrcs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableList<SourcePath> getZipSrcs()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `zipSrcs` attribute
        ...
        -   #### getOnDuplicateEntry
            ...
            ``` methodSignature
            public OnDuplicateEntry getOnDuplicateEntry()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `onDuplicateEntry` attribute
        ...
        -   #### equals
            ...
            `ZipFileDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `out`, `srcs`,
            `entriesToExclude`, `zipSrcs`, `onDuplicateEntry`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `ZipFileDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static ZipFileDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new ZipFileDescriptionArg builder
    :::
:::
:::
:::
