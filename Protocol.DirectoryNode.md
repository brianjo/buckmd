...
## Interface Protocol.DirectoryNode {#interface-protocol.directorynode .title title="Interface Protocol.DirectoryNode"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static interface Protocol.DirectoryNode
