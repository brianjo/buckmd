...
## Class HttpFileDescriptionArg {#class-httpfiledescriptionarg .title title="Class HttpFileDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.file.HttpFileDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class HttpFileDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static HttpFileDe    | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `HttpFileDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `HttpFileDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static HttpFileDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new HttpFileDescriptionArg builder
    :::
:::
:::
:::
