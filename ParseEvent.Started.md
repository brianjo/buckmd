...
## Class ParseEvent.Started {#class-parseevent.started .title title="Class ParseEvent.Started"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.parser.ParseEvent](ParseEvent.html "class in com.facebook.buck.parser")
        ...
        -   -   com.facebook.buck.parser.ParseEvent.Started
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class ParseEvent.Started
        extends ParseEvent
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- ----------------------------------------------------------------------------- -------------
          `protected `   `Started​(com.google.common.collect.ImmutableSet<BuildTarget> buildTargets)`    
