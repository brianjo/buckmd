...
## Class WeakMemoizer\<T\> {#class-weakmemoizert .title title="Class WeakMemoizer"}
:::
...
-   
    ...
    ::: block
    Memoizes a value with a weak reference, supporting passing in a
    supplier when getting the value, unlike
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `T`                   | `get                  | ::: block             |
        |                       | ​(java.util.function.S | Get the value and     |
        |                       | upplier<T> delegate)` | memoize the result.   |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
