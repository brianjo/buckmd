...
## Class NdkBuildStep {#class-ndkbuildstep .title title="Class NdkBuildStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.android.NdkBuildStep
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `NdkBuildStep​(ProjectFilesystem filesystem,             AndroidNdk androidNdk,             Path root,             Path makefile,             Path buildArtifactsDirectory,             Path binDirectory,             Iterable<String> flags)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.io.filesystem.ProjectFilesystem,com.facebook.buck.android.toolchain.ndk.AndroidNdk,java.nio.file.Path,java.nio.file.Path,java.nio.file.Path,java.nio.file.Path,java.lang.Iterable)}

        -   #### NdkBuildStep

                public NdkBuildStep​(ProjectFilesystem filesystem,
