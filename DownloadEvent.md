...
## Class DownloadEvent {#class-downloadevent .title title="Class DownloadEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.file.downloader.impl.DownloadEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- -------------------------- -------------
          `static class `     `DownloadEvent.Finished`    
          `static class `     `DownloadEvent.Started`     
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          --------------------------------- ------------------------------------------- -------------
          `static DownloadEvent.Finished`   `finished​(DownloadEvent.Started started)`    
          `protected String`                `getValueString()`                           
          `static DownloadEvent.Started`    `started​(URI uri)`                           
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        []{#started(java.net.URI)}

        -   #### started

            ``` methodSignature
            public static DownloadEvent.Started started​(URI uri)
            ```

        []{#finished(com.facebook.buck.file.downloader.impl.DownloadEvent.Started)}

        -   #### finished

            ``` methodSignature
            public static DownloadEvent.Finished finished​(DownloadEvent.Started started)
            ```
    :::
:::
:::
