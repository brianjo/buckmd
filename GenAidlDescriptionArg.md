...
## Class GenAidlDescriptionArg {#class-genaidldescriptionarg .title title="Class GenAidlDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.android.GenAidlDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class GenAidlDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `GenAidlDescription.AbstractGenAidlDescriptionArg`.
    Use the builder to create immutable instances:
    `GenAidlDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static GenAidlDe     | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getAidl
            ...
            ``` methodSignature
            public SourcePath getAidl()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `aidl` attribute
        ...
        -   #### getImportPath
            ...
            [Returns:]{.returnLabel}
            :   The value of the `importPath` attribute
        ...
        -   #### getAidlSrcs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSortedSet<SourcePath> getAidlSrcs()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `aidlSrcs` attribute
        ...
        -   #### equals
            ...
            `GenAidlDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `aidl`, `importPath`,
            `aidlSrcs`, `licenses`, `labels`, `defaultTargetPlatform`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `GenAidlDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static GenAidlDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new GenAidlDescriptionArg builder
    :::
:::
:::
:::
