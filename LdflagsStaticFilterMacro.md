...
## Class LdflagsStaticFilterMacro {#class-ldflagsstaticfiltermacro .title title="Class LdflagsStaticFilterMacro"}
:::
...
-   -   [com.facebook.buck.rules.macros.CxxGenruleFilterAndTargetsMacro](CxxGenruleFilterAndTargetsMacro.html "class in com.facebook.buck.rules.macros")
    ...
    -   -   com.facebook.buck.rules.macros.LdflagsStaticFilterMacro
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class LdflagsStaticFilterMacro
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static LdflagsStaticFilterMacro`   `of​(Optional<Pattern> pattern,   com.google.common.collect.ImmutableList<BuildTarget> buildTargets)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### LdflagsStaticFilterMacro
                ...
                public LdflagsStaticFilterMacro()
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### of
            ...
            ``` methodSignature
            public static LdflagsStaticFilterMacro of​(Optional<Pattern> pattern,
