...
## Class JsDescriptionsProvider {#class-jsdescriptionsprovider .title title="Class JsDescriptionsProvider"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.js.JsDescriptionsProvider
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Extension
        public class JsDescriptionsProvider
        extends Object
