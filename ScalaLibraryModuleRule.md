...
::: header
::: subTitle
[Package]{.packageLabelInType} [com.facebook.buck.features.project.intellij.lang.scala](package-summary.html)
:::

## Class ScalaLibraryModuleRule {#class-scalalibrarymodulerule .title title="Class ScalaLibraryModuleRule"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.features.project.intellij.BaseIjModuleRule](../../BaseIjModuleRule.html "class in com.facebook.buck.features.project.intellij")\<[ScalaLibraryDescriptionArg](../../../../../jvm/scala/ScalaLibraryDescriptionArg.html "class in com.facebook.buck.jvm.scala")\>

    -   -   com.facebook.buck.features.project.intellij.lang.scala.ScalaLibraryModuleRule

::: description
-   

    All Implemented Interfaces:
    :   `IjModuleRule<ScalaLibraryDescriptionArg>`

    ------------------------------------------------------------------------

        public class ScalaLibraryModuleRule
        extends BaseIjModuleRule<ScalaLibraryDescriptionArg>
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `ScalaLibraryModuleRule​(ProjectFilesystem projectFilesystem,                       IjModuleFactoryResolver moduleFactoryResolver,                       IjProjectConfig projectConfig)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------------------------------------- ----------------------------------------------------------------------------------------- -------------
          `void`                                             `apply​(TargetNode<ScalaLibraryDescriptionArg> target,      ModuleBuildContext context)`    
          `IjModuleType`                                     `detectModuleType​(TargetNode<ScalaLibraryDescriptionArg> targetNode)`                      
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### ScalaLibraryModuleRule

                public ScalaLibraryModuleRule​(ProjectFilesystem projectFilesystem,
    ...
    -   []{#method.detail}
        ...
        -   #### apply
            ...
            ``` methodSignature
            public void apply​(TargetNode<ScalaLibraryDescriptionArg> target,
