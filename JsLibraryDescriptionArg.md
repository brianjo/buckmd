...
## Class JsLibraryDescriptionArg {#class-jslibrarydescriptionarg .title title="Class JsLibraryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.js.JsLibraryDescriptionArg
...
-   
    ...
    :   `BuildRuleArg`, `ConstructorArg`, `DataTransferObject`,
        `HasDeclaredDeps`, `HasDepsQuery`, `HasTests`, `HasExtraJson`
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class JsLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `JsLibraryDe          | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static JsLibraryDe   | `builder()`           | ::: block             |
        ...
        | llect.ImmutableSet<Ei |                       |                       |
        | ther<SourcePath,​Pair< |                       |                       |
        | SourcePath,​String>>>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getBasePath
            ...
            [Returns:]{.returnLabel}
            :   The value of the `basePath` attribute
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `srcs`, `worker`,
            `basePath`, `compatibleWith`, `defaultTargetPlatform`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `JsLibraryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static JsLibraryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new JsLibraryDescriptionArg builder
        ...
        -   #### withDepsQuery
            ...
            ``` methodSignature
            public default JsLibraryDescriptionArg withDepsQuery​(Query query)
            ```
