...
-   Rules in `java/com/facebook/common/` can reference any files under
    ...
    `java/com/facebook/common/collect/`, as those \"belong\" to the
    `BUCK` file in the `collect` directory.
