...
## Class GCCollectionEvent {#class-gccollectionevent .title title="Class GCCollectionEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.support.jvm.GCCollectionEvent
...
-   
    ...
    :   `GCMajorCollectionEvent`, `GCMinorCollectionEvent`

    ------------------------------------------------------------------------

        public abstract class GCCollectionEvent
        extends AbstractBuckEvent

    ::: block
    Base class for GC collection events emitting by
    [`GCNotificationEventEmitter`](GCNotificationEventEmitter.html "class in com.facebook.buck.support.jvm").
    Subclasses contain information about the nature of this collection
    (major or minor), while this class contains information about the
    duration and memory statistics of this GC.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `long`                                                                                                 `getId()`                     
          `com.google.common.collect.ImmutableMap<String,​com.google.common.collect.ImmutableMap<String,​Long>>`   `getMemoryUsageAfterGC()`     
          `com.google.common.collect.ImmutableMap<String,​com.google.common.collect.ImmutableMap<String,​Long>>`   `getMemoryUsageBeforeGC()`    
