...
## Class CgoLibraryDescriptionArg {#class-cgolibrarydescriptionarg .title title="Class CgoLibraryDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class CgoLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `CgoLibraryDe         | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static CgoLibraryDe  | `builder()`           | ::: block             |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `g                    |                       |
        | ogle.common.collect.I | etCgoCompilerFlags()` |                       |
        | mmutableList<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `g                    |                       |
        | ogle.common.collect.I | etGoAssemblerFlags()` |                       |
        | mmutableList<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `                     |                       |
        | ogle.common.collect.I | getGoCompilerFlags()` |                       |
        | mmutableList<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.google.comm      | `getGoSrcs()`         |                       |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getCgoCompilerFlags
            ...
            [Returns:]{.returnLabel}
            :   The value of the `cgoCompilerFlags` attribute
        ...
        -   #### getGoCompilerFlags
            ...
            [Returns:]{.returnLabel}
            :   The value of the `goCompilerFlags` attribute
        ...
        -   #### getGoAssemblerFlags
            ...
            [Returns:]{.returnLabel}
            :   The value of the `goAssemblerFlags` attribute
        ...
        -   #### getGoSrcs
            ...
            [Returns:]{.returnLabel}
            :   The value of the `goSrcs` attribute
        ...
        -   #### hashCode
            ...
            `goCompilerFlags`, `goAssemblerFlags`, `packageName`,
            `goSrcs`, `exportedDeps`, `compilerFlags`,
            `linkDepsQueryWhole`, `fatLto`, `linkGroup`, `linkGroupMap`,
            `linkStyle`, `thinLto`, `cxxDeps`, `cxxRuntimeType`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `CgoLibraryDescriptionArg` with
            attribute values.
            :::
