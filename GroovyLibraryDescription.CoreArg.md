...
## Interface GroovyLibraryDescription.CoreArg {#interface-groovylibrarydescription.corearg .title title="Interface GroovyLibraryDescription.CoreArg"}
:::
...
-   
    ...
    Enclosing class:
    :   [GroovyLibraryDescription](GroovyLibraryDescription.html "class in com.facebook.buck.jvm.groovy")

    ------------------------------------------------------------------------

        public static interface GroovyLibraryDescription.CoreArg
