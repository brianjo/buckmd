...
## Class DownloadProgressEvent {#class-downloadprogressevent .title title="Class DownloadProgressEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.file.downloader.impl.DownloadProgressEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------- -------------
          `DownloadProgressEvent​(URI uri,                      long size,                      long downloadedSoFar)`    
