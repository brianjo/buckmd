...
## Class RetryingCacheDecorator {#class-retryingcachedecorator .title title="Class RetryingCacheDecorator"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.artifact_cache.RetryingCacheDecorator
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class RetryingCacheDecorator
        extends Object
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `RetryingCacheDecorator​(ArtifactCacheMode cacheMode,                       ArtifactCache delegate,                       int maxFetchRetries,                       BuckEventBus buckEventBus)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.artifact_cache.config.ArtifactCacheMode,com.facebook.buck.artifact_cache.ArtifactCache,int,com.facebook.buck.event.BuckEventBus)}

        -   #### RetryingCacheDecorator

                public RetryingCacheDecorator​(ArtifactCacheMode cacheMode,
