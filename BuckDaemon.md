...
## Class BuckDaemon {#class-buckdaemon .title title="Class BuckDaemon"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.cli.BuckDaemon
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        |                       |                       | The command ran when  |
        |                       |                       | starting a new long   |
        |                       |                       | living buckd session. |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### main
            ...
            ::: block
            The command ran when starting a new long living buckd
            session.
            :::
    :::
:::
