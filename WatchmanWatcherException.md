...
## Class WatchmanWatcherException {#class-watchmanwatcherexception .title title="Class WatchmanWatcherException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class WatchmanWatcherException
        extends RuntimeException

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.io.watchman.WatchmanWatcherException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------- -------------
          `WatchmanWatcherException​(String message)`    
