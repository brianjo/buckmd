...
## Class ExternalTestRunEvent.Finished {#class-externaltestrunevent.finished .title title="Class ExternalTestRunEvent.Finished"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.test.external.ExternalTestRunEvent](ExternalTestRunEvent.html "class in com.facebook.buck.test.external")
        ...
        -   -   com.facebook.buck.test.external.ExternalTestRunEvent.Finished
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class ExternalTestRunEvent.Finished
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------- -------------
          `Finished​(int secret,         ExitCode exitCode)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(int,com.facebook.buck.util.ExitCode)}
