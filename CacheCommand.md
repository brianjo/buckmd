...
## Class CacheCommand {#class-cachecommand .title title="Class CacheCommand"}
:::
...
-   -   [com.facebook.buck.cli.CommandWithPluginManager](CommandWithPluginManager.html "class in com.facebook.buck.cli")
    ...
    -   -   [com.facebook.buck.cli.AbstractCommand](AbstractCommand.html "class in com.facebook.buck.cli")
        ...
        -   -   com.facebook.buck.cli.CacheCommand
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------- ---------------------------------------------- -------------
          `void`              `fakeOutParseEvents​(BuckEventBus eventBus)`     
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        []{#fakeOutParseEvents(com.facebook.buck.event.BuckEventBus)}
