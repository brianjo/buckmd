...
## Class ShBinaryDescriptionArg {#class-shbinarydescriptionarg .title title="Class ShBinaryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.shell.ShBinaryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ShBinaryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `ShBinaryDe           | ::: block             |
        |                       | scriptionArg.Builder` | Builds instances of   |
        |                       |                       | type                  |
        |                       |                       | [`ShBin               |
        |                       |                       | aryDescriptionArg`](S |
        |                       |                       | hBinaryDescriptionArg |
        |                       |                       | .html "class in com.f |
        |                       |                       | acebook.buck.shell"). |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static ShBinaryDe    | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getResources
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSet<SourcePath> getResources()
            ```
        ...
        -   #### equals
            ...
            `ShBinaryDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `main`, `resources`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `ShBinaryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static ShBinaryDescriptionArg.Builder builder()
            ```

            ::: block
            Creates a builder for
            [`ShBinaryDescriptionArg`](ShBinaryDescriptionArg.html "class in com.facebook.buck.shell").
            :::

            [Returns:]{.returnLabel}
            :   A new ShBinaryDescriptionArg builder
    :::
:::
:::
:::
