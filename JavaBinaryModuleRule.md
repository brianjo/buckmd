...
## Class JavaBinaryModuleRule {#class-javabinarymodulerule .title title="Class JavaBinaryModuleRule"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.features.project.intellij.BaseIjModuleRule](../../BaseIjModuleRule.html "class in com.facebook.buck.features.project.intellij")\<[JavaBinaryDescriptionArg](../../../../../jvm/java/JavaBinaryDescriptionArg.html "class in com.facebook.buck.jvm.java")\>

    -   -   com.facebook.buck.features.project.intellij.lang.java.JavaBinaryModuleRule

::: description
-   

    All Implemented Interfaces:
    :   `IjModuleRule<JavaBinaryDescriptionArg>`

    ------------------------------------------------------------------------

        public class JavaBinaryModuleRule
        extends BaseIjModuleRule<JavaBinaryDescriptionArg>
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `JavaBinaryModuleRule​(ProjectFilesystem projectFilesystem,                     IjModuleFactoryResolver moduleFactoryResolver,                     IjProjectConfig projectConfig)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------------------------------------- --------------------------------------------------------------------------------------- -------------
          `void`                                             `apply​(TargetNode<JavaBinaryDescriptionArg> target,      ModuleBuildContext context)`    
          `IjModuleType`                                     `detectModuleType​(TargetNode<JavaBinaryDescriptionArg> target)`                          
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### JavaBinaryModuleRule

                public JavaBinaryModuleRule​(ProjectFilesystem projectFilesystem,
    ...
    -   []{#method.detail}
        ...
        -   #### apply
            ...
            ``` methodSignature
            public void apply​(TargetNode<JavaBinaryDescriptionArg> target,
