...
## Class PrebuiltNativeLibrary {#class-prebuiltnativelibrary .title title="Class PrebuiltNativeLibrary"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../core/rules/impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   [com.facebook.buck.core.rules.impl.AbstractBuildRuleWithDeclaredAndExtraDeps](../core/rules/impl/AbstractBuildRuleWithDeclaredAndExtraDeps.html "class in com.facebook.buck.core.rules.impl")
        ...
        -   -   com.facebook.buck.android.PrebuiltNativeLibrary
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class PrebuiltNativeLibrary
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `protected `   `PrebuiltNativeLibrary​(BuildTarget buildTarget,                      ProjectFilesystem projectFilesystem,                      BuildRuleParams params,                      Path nativeLibsDirectory,                      boolean isAsset,                      com.google.common.collect.ImmutableSortedSet<? extends SourcePath> librarySources)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.model.BuildTarget,com.facebook.buck.io.filesystem.ProjectFilesystem,com.facebook.buck.core.rules.BuildRuleParams,java.nio.file.Path,boolean,com.google.common.collect.ImmutableSortedSet)}

        -   #### PrebuiltNativeLibrary

                protected PrebuiltNativeLibrary​(BuildTarget buildTarget,
                                                ProjectFilesystem projectFilesystem,
                                                BuildRuleParams params,
                                                Path nativeLibsDirectory,
                                                boolean isAsset,
                                                com.google.common.collect.ImmutableSortedSet<? extends SourcePath> librarySources)
    :::
