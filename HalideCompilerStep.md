...
## Class HalideCompilerStep {#class-halidecompilerstep .title title="Class HalideCompilerStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.halide.HalideCompilerStep
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class HalideCompilerStep
        extends ShellStep
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `HalideCompilerStep​(AbsPath workingDirectory,                   com.google.common.collect.ImmutableMap<String,​String> environment,                   com.google.common.collect.ImmutableList<String> compilerPrefix,                   Path outputDir,                   String funcName,                   String halideTarget,                   Optional<com.google.common.collect.ImmutableList<String>> compilerInvocationFlags)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.google.common.collect.ImmutableMap,com.google.common.collect.ImmutableList,java.nio.file.Path,java.lang.String,java.lang.String,java.util.Optional)}

        -   #### HalideCompilerStep

                public HalideCompilerStep​(AbsPath workingDirectory,
                                          com.google.common.collect.ImmutableMap<String,​String> environment,
                                          com.google.common.collect.ImmutableList<String> compilerPrefix,
                                          Path outputDir,
                                          String funcName,
                                          String halideTarget,
