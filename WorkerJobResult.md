...
## Interface WorkerJobResult {#interface-workerjobresult .title title="Interface WorkerJobResult"}
:::
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        []{#of(int,java.util.Optional,java.util.Optional)}

        -   #### of

            ``` methodSignature
            static WorkerJobResult of​(int exitCode,
