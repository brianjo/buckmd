...
## Class FrameworkPathTypeCoercer {#class-frameworkpathtypecoercer .title title="Class FrameworkPathTypeCoercer"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.rules.coercer.FrameworkPathTypeCoercer

::: description
-   

    All Implemented Interfaces:
    :   `Concatable<FrameworkPath>`, `TypeCoercer<Object,​FrameworkPath>`

    ------------------------------------------------------------------------

        public class FrameworkPathTypeCoercer
        extends Object
        implements TypeCoercer<Object,​FrameworkPath>

    ::: block
    Coerce to
    [`FrameworkPath`](FrameworkPath.html "class in com.facebook.buck.rules.coercer").
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------- -------------
          `FrameworkPathTypeCoercer​(TypeCoercer<UnconfiguredSourcePath,​SourcePath> sourcePathTypeCoercer)`    
    ...
    -   []{#method.summary}
        ...
        |                       |       Object object)` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.googl            | `getOutputType()`     |                       |
        | e.common.reflect.Type |                       |                       |
        | Token<FrameworkPath>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `co                   | `g                    |                       |
        ...
        |                       | r cellRoots,          | guided by this        |
        |                       | FrameworkPath object, | TypeCoercer.          |
        |                       |          TypeCoercer. | :::                   |
        |                       | Traversal traversal)` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### FrameworkPathTypeCoercer
                ...
                public FrameworkPathTypeCoercer​(TypeCoercer<UnconfiguredSourcePath,​SourcePath> sourcePathTypeCoercer)
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### getOutputType
            ...
            ``` methodSignature
            public com.google.common.reflect.TypeToken<FrameworkPath> getOutputType()
            ```

            [Specified by:]{.overrideSpecifyLabel}
            :   `getOutputType` in
                interface `TypeCoercer<Object,​FrameworkPath>`
        ...
        []{#traverse(com.facebook.buck.core.cell.nameresolver.CellNameResolver,com.facebook.buck.rules.coercer.FrameworkPath,com.facebook.buck.rules.coercer.TypeCoercer.Traversal)}

        -   #### traverse

            ``` methodSignature
            public void traverse​(CellNameResolver cellRoots,
                                 FrameworkPath object,
        ...
        -   #### coerce
            ...
            ``` methodSignature
            public FrameworkPath coerce​(CellNameResolver cellRoots,
                                        ProjectFilesystem filesystem,
                                        ForwardRelativePath pathRelativeToProjectRoot,
