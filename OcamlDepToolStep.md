...
## Class OcamlDepToolStep {#class-ocamldeptoolstep .title title="Class OcamlDepToolStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.ocaml.OcamlDepToolStep
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class OcamlDepToolStep
        extends ShellStep

    ::: block
    This step runs ocamldep tool to compute dependencies among source
    files (\*.mli and \*.ml)
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `OcamlDepToolStep​(AbsPath workingDirectory,                 SourcePathResolverAdapter resolver,                 Tool ocamlDepTool,                 List<SourcePath> input,                 List<String> flags)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.facebook.buck.core.sourcepath.resolver.SourcePathResolverAdapter,com.facebook.buck.core.toolchain.tool.Tool,java.util.List,java.util.List)}

        -   #### OcamlDepToolStep

                public OcamlDepToolStep​(AbsPath workingDirectory,
    ...
    -   []{#method.detail}
        ...
        -   #### getShellCommandInternal
            ...
            ``` methodSignature
            protected com.google.common.collect.ImmutableList<String> getShellCommandInternal​(@Nullable
