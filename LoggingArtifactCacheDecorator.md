...
## Class LoggingArtifactCacheDecorator {#class-loggingartifactcachedecorator .title title="Class LoggingArtifactCacheDecorator"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.artifact_cache.LoggingArtifactCacheDecorator
...
-   
    ...
    for the start and finish of each event. The underlying cache must
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `LoggingArtifactCacheDecorator​(BuckEventBus eventBus,                              ArtifactCache delegate,                              ArtifactCacheEventFactory eventFactory)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.event.BuckEventBus,com.facebook.buck.artifact_cache.ArtifactCache,com.facebook.buck.artifact_cache.ArtifactCacheEventFactory)}
