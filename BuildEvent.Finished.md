...
## Class BuildEvent.Finished {#class-buildevent.finished .title title="Class BuildEvent.Finished"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.core.build.event.BuildEvent](BuildEvent.html "class in com.facebook.buck.core.build.event")
        ...
        -   -   com.facebook.buck.core.build.event.BuildEvent.Finished
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class BuildEvent.Finished
        extends BuildEvent
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- ------------------------------------------------------------------- -------------
          `protected `   `Finished​(BuildEvent.Started started,         ExitCode exitCode)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.build.event.BuildEvent.Started,com.facebook.buck.util.ExitCode)}

        -   #### Finished

                protected Finished​(BuildEvent.Started started,
                                   ExitCode exitCode)
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### getBuildArgs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSet<String> getBuildArgs()
            ```
