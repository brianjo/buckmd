...
## Class CountersSnapshotEvent {#class-counterssnapshotevent .title title="Class CountersSnapshotEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.counters.CountersSnapshotEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class CountersSnapshotEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------- -------------
          `CountersSnapshotEvent​(Iterable<CounterSnapshot> snapshots)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------------------------------------ -------------------- -------------
          `String`                                                     `getEventName()`      
          `com.google.common.collect.ImmutableList<CounterSnapshot>`   `getSnapshots()`      
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### getSnapshots
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableList<CounterSnapshot> getSnapshots()
            ```
