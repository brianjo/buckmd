...
## Enum FileHashCacheMode {#enum-filehashcachemode .title title="Enum FileHashCacheMode"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [java.lang.Enum](http://docs.oracle.com/javase/7/docs/api/java/lang/Enum.html?is-external=true "class or interface in java.lang"){.externalLink}\<[FileHashCacheMode](FileHashCacheMode.html "enum in com.facebook.buck.util.cache")\>

    -   -   com.facebook.buck.util.cache.FileHashCacheMode

::: description
-   

    All Implemented Interfaces:
    :   `Serializable`, `Comparable<FileHashCacheMode>`

    ------------------------------------------------------------------------

        public enum FileHashCacheMode
        extends Enum<FileHashCacheMode>
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `stat                 | `                     | ::: block             |
        | ic FileHashCacheMode` | valueOf​(String name)` | Returns the enum      |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `static               | `values()`            | ::: block             |
        |  FileHashCacheMode[]` |                       | Returns an array      |
        |                       |                       | containing the        |
        |                       |                       | constants of this     |
        |                       |                       | enum type, in the     |
        |                       |                       | order they are        |
    ...
    -   []{#method.detail}
        ...
        -   #### values
            ...
            iterate over the constants as follows:
                for (FileHashCacheMode c : FileHashCacheMode.values())
