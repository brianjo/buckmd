...
## Class JavaLibraryDescriptionArg {#class-javalibrarydescriptionarg .title title="Class JavaLibraryDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class JavaLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `JavaLibraryDe        | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static JavaLibraryDe | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `JavaLibraryDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `JavaLibraryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static JavaLibraryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new JavaLibraryDescriptionArg builder
    :::
:::
:::
:::
