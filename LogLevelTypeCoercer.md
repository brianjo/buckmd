...
## Class LogLevelTypeCoercer {#class-logleveltypecoercer .title title="Class LogLevelTypeCoercer"}
:::
...
-   -   [com.facebook.buck.rules.coercer.LeafTypeNewCoercer](LeafTypeNewCoercer.html "class in com.facebook.buck.rules.coercer")\<T,​T\>
    ...
    -   -   [com.facebook.buck.rules.coercer.LeafUnconfiguredOnlyCoercer](LeafUnconfiguredOnlyCoercer.html "class in com.facebook.buck.rules.coercer")\<[Level](http://docs.oracle.com/javase/7/docs/api/java/util/logging/Level.html?is-external=true "class or interface in java.util.logging"){.externalLink}\>

        -   -   com.facebook.buck.rules.coercer.LogLevelTypeCoercer

::: description
-   

    All Implemented Interfaces:
    :   `Concatable<Level>`, `TypeCoercer<Level,​Level>`

    ------------------------------------------------------------------------

        public class LogLevelTypeCoercer
        extends LeafUnconfiguredOnlyCoercer<Level>

    ::: block
    Coercer for
    [`Level`](http://docs.oracle.com/javase/7/docs/api/java/util/logging/Level.html?is-external=true "class or interface in java.util.logging"){.externalLink}.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +-----------------------+-----------------------+-----------------------+
        | `c                    | `g                    |                       |
        | om.google.common.refl | etUnconfiguredType()` |                       |
        | ect.TypeToken<Level>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### getUnconfiguredType
            ...
            ``` methodSignature
            public com.google.common.reflect.TypeToken<Level> getUnconfiguredType()
            ```
        ...
        -   #### coerceToUnconfigured
            ...
            ``` methodSignature
            public Level coerceToUnconfigured​(CellNameResolver cellRoots,
