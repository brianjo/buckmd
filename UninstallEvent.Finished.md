...
## Class UninstallEvent.Finished {#class-uninstallevent.finished .title title="Class UninstallEvent.Finished"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.event.UninstallEvent](UninstallEvent.html "class in com.facebook.buck.event")

        -   -   com.facebook.buck.event.UninstallEvent.Finished
...
-   
    ...
    Enclosing class:
    :   [UninstallEvent](UninstallEvent.html "class in com.facebook.buck.event")

    ------------------------------------------------------------------------

        public static class UninstallEvent.Finished
        extends UninstallEvent
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        -   []{#nested.classes.inherited.from.class.com.facebook.buck.event.UninstallEvent}

            ### Nested classes/interfaces inherited from class com.facebook.buck.event.[UninstallEvent](UninstallEvent.html "class in com.facebook.buck.event")
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- --------------------------------------------------------------------- -------------
          `protected `   `Finished​(UninstallEvent.Started started,         boolean success)`    
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.event.UninstallEvent}

            ### Methods inherited from class com.facebook.buck.event.[UninstallEvent](UninstallEvent.html "class in com.facebook.buck.event")

            `finished, getCategory, getPackageName, getValueString, started`
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.event.UninstallEvent.Started,boolean)}

        -   #### Finished

                protected Finished​(UninstallEvent.Started started,
                                   boolean success)
    :::
