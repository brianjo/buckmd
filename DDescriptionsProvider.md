...
## Class DDescriptionsProvider {#class-ddescriptionsprovider .title title="Class DDescriptionsProvider"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.d.DDescriptionsProvider
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Extension
        public class DDescriptionsProvider
        extends Object
