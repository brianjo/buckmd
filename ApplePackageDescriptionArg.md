...
## Class ApplePackageDescriptionArg {#class-applepackagedescriptionarg .title title="Class ApplePackageDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ApplePackageDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `ApplePackageDe       | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `                     | `builder()`           | ::: block             |
        | static ApplePackageDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`ApplePackageD       |
        |                       |                       | escriptionArg`](Apple |
        |                       |                       | PackageDescriptionArg |
        |                       |                       | .html "class in com.f |
        |                       |                       | acebook.buck.apple"). |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### isNeedAndroidTools
            ...
            ::: block
            This argument allows to specify if it needs android tools
            (like dex, aapt, ndk, sdk).
            :::
        ...
        -   #### equals
            ...
            `ApplePackageDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            `needAndroidTools`, `licenses`, `labels`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `ApplePackageDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static ApplePackageDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new ApplePackageDescriptionArg builder
    :::
:::
:::
:::
