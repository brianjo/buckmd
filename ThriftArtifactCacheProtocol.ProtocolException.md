...
## Class ThriftArtifactCacheProtocol.ProtocolException {#class-thriftartifactcacheprotocol.protocolexception .title title="Class ThriftArtifactCacheProtocol.ProtocolException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class ThriftArtifactCacheProtocol.ProtocolException
        extends IOException

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../serialized-form.html#com.facebook.buck.artifact_cache.ThriftArtifactCacheProtocol.ProtocolException)
:::
