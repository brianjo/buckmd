...
## Class JavaAnnotationProcessor {#class-javaannotationprocessor .title title="Class JavaAnnotationProcessor"}
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `JavaAnnotationProcessor​(BuildTarget buildTarget,                        ProjectFilesystem projectFilesystem,                        BuildRuleParams params,                        com.facebook.buck.jvm.java.JavacPluginProperties properties)`    
