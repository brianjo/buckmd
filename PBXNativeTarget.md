...
## Class PBXNativeTarget {#class-pbxnativetarget .title title="Class PBXNativeTarget"}
:::
...
-   
    ...
    ::: block
    Concrete target type representing targets built by xcode itself,
    rather than an external build system.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------------------------------------- -------------
          `PBXNativeTarget​(String name,                AbstractPBXObjectFactory objectFactory)`    
