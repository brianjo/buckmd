...
## Class GwtBinary {#class-gwtbinary .title title="Class GwtBinary"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../../core/rules/impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   [com.facebook.buck.core.rules.impl.AbstractBuildRuleWithDeclaredAndExtraDeps](../../core/rules/impl/AbstractBuildRuleWithDeclaredAndExtraDeps.html "class in com.facebook.buck.core.rules.impl")
        ...
        -   -   com.facebook.buck.features.gwt.GwtBinary
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class GwtBinary
        extends AbstractBuildRuleWithDeclaredAndExtraDeps

    ::: block
    Buildable that produces a GWT application as a WAR file, which is a
    zip of the outputs produced by the GWT compiler.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getSourcePathToOutput
            ...
            [Returns:]{.returnLabel}
            :   The `.zip` file produced by this rule.
    :::
:::
:::
:::
