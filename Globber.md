...
## Interface Globber {#interface-globber .title title="Interface Globber"}
:::
...
-   
    ...
    :   `CachingGlobber`, `HybridGlobber`, `NativeGlobber`
    ...
    ::: block
    A contract for globbing functionality that allows resolving file
    paths based on include patterns (file patterns that should be
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### run
            ...
            ``` methodSignature
            Set<String> run​(Collection<String> include,
