...
## Class LuaBinaryDescriptionArg {#class-luabinarydescriptionarg .title title="Class LuaBinaryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.lua.LuaBinaryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class LuaBinaryDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `LuaBinaryDescription.AbstractLuaBinaryDescriptionArg`.
    Use the builder to create immutable instances:
    `LuaBinaryDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `LuaBinaryDe          | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static LuaBinaryDe   | `builder()`           | ::: block             |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `O                    | `getNa                |                       |
        | ptional<BuildTarget>` | tiveStarterLibrary()` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<LuaPl       | `getPackageStyle()`   |                       |
        | atform.PackageStyle>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getNativeStarterLibrary
            ...
            [Returns:]{.returnLabel}
            :   The value of the `nativeStarterLibrary` attribute
        ...
        -   #### getPythonPlatform
            ...
            ``` methodSignature
            public Optional<String> getPythonPlatform()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `pythonPlatform` attribute
        ...
        -   #### getPackageStyle
            ...
            ``` methodSignature
            public Optional<LuaPlatform.PackageStyle> getPackageStyle()
            ```
        ...
        -   #### equals
            ...
            `LuaBinaryDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            `nativeStarterLibrary`, `pythonPlatform`, `platform`,
            `packageStyle`, `platformDeps`, `compatibleWith`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `LuaBinaryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static LuaBinaryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new LuaBinaryDescriptionArg builder
    :::
:::
:::
:::
