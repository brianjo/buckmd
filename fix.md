...
Commands such as [`buck build`](/command/build.html) may fail with
errors from Buck itself or another tool (such as a compiler or linker)
that is invoked by Buck. In some cases, such errors can be fixed
