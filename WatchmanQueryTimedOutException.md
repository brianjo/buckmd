...
## Class WatchmanQueryTimedOutException {#class-watchmanquerytimedoutexception .title title="Class WatchmanQueryTimedOutException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class WatchmanQueryTimedOutException
        extends IOException
    ...
    does not throw this exception itself.
    :::

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.io.watchman.WatchmanQueryTimedOutException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### WatchmanQueryTimedOutException
                ...
                public WatchmanQueryTimedOutException()
    :::
:::
:::
:::
