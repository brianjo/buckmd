...
## Class ShTestDescriptionArg {#class-shtestdescriptionarg .title title="Class ShTestDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.shell.ShTestDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ShTestDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getTest
            ...
            ``` methodSignature
            public Optional<SourcePath> getTest()
            ```
        ...
        -   #### equals
            ...
            `ShTestDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `test`, `args`,
            `type`, `runTestSeparately`, `resources`, `env`, `licenses`,
            `labels`, `defaultTargetPlatform`, `compatibleWith`, `name`,
            `contacts`, `deps`, `testRuleTimeoutMs`.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `ShTestDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static ShTestDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new ShTestDescriptionArg builder
    :::
:::
:::
:::
