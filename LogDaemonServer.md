...
## Interface LogDaemonServer {#interface-logdaemonserver .title title="Interface LogDaemonServer"}
:::
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### start
            ...
            ::: block
            logD starts listening for requests from clients via the
            defined LogDService
            :::
