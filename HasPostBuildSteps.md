...
## Interface HasPostBuildSteps {#interface-haspostbuildsteps .title title="Interface HasPostBuildSteps"}
:::
...
-   
    ...
    :   `AppleDsym`, `JavaTest`, `RobolectricTest`
    ...
    which perform operations after the build. Prefer creating a
    [`BuildRule`](../BuildRule.html "interface in com.facebook.buck.core.rules")
    that returns false from
    [`BuildRule.isCacheable()`](../BuildRule.html#isCacheable()).
    :::
:::
