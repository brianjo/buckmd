...
## Interface NetworkStatsTracker.Listener {#interface-networkstatstracker.listener .title title="Interface NetworkStatsTracker.Listener"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static interface NetworkStatsTracker.Listener
