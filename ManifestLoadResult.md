...
## Class ManifestLoadResult {#class-manifestloadresult .title title="Class ManifestLoadResult"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.core.build.engine.manifest.ManifestLoadResult
...
-   
    ...
    ::: block
    A union of results of loading a
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------- ------------------------------ -------------
          `static ManifestLoadResult`     `error​(String error)`           
          `abstract Optional<String>`     `getError()`                    
          `abstract Optional<Manifest>`   `getManifest()`                 
          `static ManifestLoadResult`     `success​(Manifest manifest)`    
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        []{#success(com.facebook.buck.core.build.engine.manifest.Manifest)}
