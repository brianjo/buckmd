...
## Interface MaybeRequiredForSourceOnlyAbi {#interface-mayberequiredforsourceonlyabi .title title="Interface MaybeRequiredForSourceOnlyAbi"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public interface MaybeRequiredForSourceOnlyAbi
        extends BuildRule
:::
