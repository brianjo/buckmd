...
## Class BuildEvent.BuildReport {#class-buildevent.buildreport .title title="Class BuildEvent.BuildReport"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.core.build.event.BuildEvent](BuildEvent.html "class in com.facebook.buck.core.build.event")
        ...
        -   -   com.facebook.buck.core.build.event.BuildEvent.BuildReport
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class BuildEvent.BuildReport
        extends BuildEvent
