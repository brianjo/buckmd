...
-   ::: {#apk}
    ...
    Can be either a [`android_binary`](/rule/android_binary.html) or a
...
Here is an example of an `android_instrumentation_apk()` rule that tests
a `android_binary()`, and depends on a test package.
