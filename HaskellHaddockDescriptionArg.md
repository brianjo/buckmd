...
## Class HaskellHaddockDescriptionArg {#class-haskellhaddockdescriptionarg .title title="Class HaskellHaddockDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.haskell.HaskellHaddockDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class HaskellHaddockDescriptionArg
        extends Object
    ...
    `HaskellHaddockDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `HaskellHaddockDe     | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `st                   | `builder()`           | ::: block             |
        | atic HaskellHaddockDe |                       | Creates a builder for |
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `default HaskellH     | `withDe               |                       |
        | addockDescriptionArg` | psQuery​(Query query)` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `HaskellHaddockDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            `haddockFlags`, `compatibleWith`, `defaultTargetPlatform`,
            `labels`, `licenses`, `name`, `depsQuery`, `deps`.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `HaskellHaddockDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static HaskellHaddockDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new HaskellHaddockDescriptionArg builder
        ...
        -   #### withDepsQuery
            ...
            ``` methodSignature
            public default HaskellHaddockDescriptionArg withDepsQuery​(Query query)
            ```
