...
## Class TestRuleEvent.Finished {#class-testruleevent.finished .title title="Class TestRuleEvent.Finished"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.test.TestRuleEvent](TestRuleEvent.html "class in com.facebook.buck.test")

        -   -   com.facebook.buck.test.TestRuleEvent.Finished
...
-   
    ...
    Enclosing class:
    :   [TestRuleEvent](TestRuleEvent.html "class in com.facebook.buck.test")

    ------------------------------------------------------------------------

        public static class TestRuleEvent.Finished
        extends TestRuleEvent
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        -   []{#nested.classes.inherited.from.class.com.facebook.buck.test.TestRuleEvent}

            ### Nested classes/interfaces inherited from class com.facebook.buck.test.[TestRuleEvent](TestRuleEvent.html "class in com.facebook.buck.test")

            `TestRuleEvent.Finished, TestRuleEvent.Started`
    :::
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.test.TestRuleEvent}

            ### Methods inherited from class com.facebook.buck.test.[TestRuleEvent](TestRuleEvent.html "class in com.facebook.buck.test")

            `finished, getBuildTarget, getValueString, started`
