...
## Class RemoteExecutionActionEvent.Scheduled {#class-remoteexecutionactionevent.scheduled .title title="Class RemoteExecutionActionEvent.Scheduled"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.remoteexecution.event.RemoteExecutionActionEvent](RemoteExecutionActionEvent.html "class in com.facebook.buck.remoteexecution.event")
        ...
        -   -   com.facebook.buck.remoteexecution.event.RemoteExecutionActionEvent.Scheduled
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class RemoteExecutionActionEvent.Scheduled
        extends RemoteExecutionActionEvent

    ::: block
    Indicates that a remote execution event has been scheduled. This
    should be sent once for every build target that will have any other
    remote execution action events (and should be sent before any
    others).
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.rules.BuildRule)}
