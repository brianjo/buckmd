...
## Class BaseLocationMacro {#class-baselocationmacro .title title="Class BaseLocationMacro"}
:::
...
-   
    ...
    :   `LocationMacro`, `LocationPlatformMacro`

    ------------------------------------------------------------------------

        public abstract class BaseLocationMacro
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.rules.macros.BuildTargetMacro}
            ...
            `equals, getTarget, getTargetWithOutputs, hashCode, translateTargets, withTargetWithOutputs`
