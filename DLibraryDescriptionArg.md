...
## Class DLibraryDescriptionArg {#class-dlibrarydescriptionarg .title title="Class DLibraryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.d.DLibraryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class DLibraryDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `DLibraryDescription.AbstractDLibraryDescriptionArg`.
    Use the builder to create immutable instances:
    `DLibraryDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static DLibraryDe    | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `DLibraryDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `srcs`, `linkerFlags`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `DLibraryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static DLibraryDescriptionArg.Builder builder()
            ```

            ::: block
            Creates a builder for
            [`DLibraryDescriptionArg`](DLibraryDescriptionArg.html "class in com.facebook.buck.features.d").
            :::

            [Returns:]{.returnLabel}
            :   A new DLibraryDescriptionArg builder
    :::
:::
:::
:::
