...
## Class StartActivityEvent.Finished {#class-startactivityevent.finished .title title="Class StartActivityEvent.Finished"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.event.StartActivityEvent](StartActivityEvent.html "class in com.facebook.buck.event")

        -   -   com.facebook.buck.event.StartActivityEvent.Finished
...
-   
    ...
    Enclosing class:
    :   [StartActivityEvent](StartActivityEvent.html "class in com.facebook.buck.event")

    ------------------------------------------------------------------------

        public static class StartActivityEvent.Finished
        extends StartActivityEvent
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        -   []{#nested.classes.inherited.from.class.com.facebook.buck.event.StartActivityEvent}

            ### Nested classes/interfaces inherited from class com.facebook.buck.event.[StartActivityEvent](StartActivityEvent.html "class in com.facebook.buck.event")
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- ------------------------------------------------------------------------- -------------
          `protected `   `Finished​(StartActivityEvent.Started started,         boolean success)`    
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.event.StartActivityEvent}

            ### Methods inherited from class com.facebook.buck.event.[StartActivityEvent](StartActivityEvent.html "class in com.facebook.buck.event")

            `finished, getActivityName, getBuildTarget, getCategory, getValueString, started`
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.event.StartActivityEvent.Started,boolean)}

        -   #### Finished

                protected Finished​(StartActivityEvent.Started started,
                                   boolean success)
    :::
