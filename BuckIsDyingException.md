...
## Class BuckIsDyingException {#class-buckisdyingexception .title title="Class BuckIsDyingException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class BuckIsDyingException
    ...
    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../serialized-form.html#com.facebook.buck.util.BuckIsDyingException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------- -------------
          `BuckIsDyingException​(String message)`    
