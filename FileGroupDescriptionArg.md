...
## Class FileGroupDescriptionArg {#class-filegroupdescriptionarg .title title="Class FileGroupDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.filegroup.FileGroupDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class FileGroupDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `FilegroupDescription.AbstractFileGroupDescriptionArg`.
    Use the builder to create immutable instances:
    `FileGroupDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `FileGroupDe          | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static FileGroupDe   | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `FileGroupDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `FileGroupDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static FileGroupDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new FileGroupDescriptionArg builder
    :::
:::
:::
:::
