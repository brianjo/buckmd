...
## Class ExtraInfoCollector.ExtraInfoExecutionException {#class-extrainfocollector.extrainfoexecutionexception .title title="Class ExtraInfoCollector.ExtraInfoExecutionException"}
:::
...
-   
    ...
    Enclosing interface:
    :   [ExtraInfoCollector](ExtraInfoCollector.html "interface in com.facebook.buck.doctor")

    ------------------------------------------------------------------------

        public static class ExtraInfoCollector.ExtraInfoExecutionException
        extends Exception

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../serialized-form.html#com.facebook.buck.doctor.ExtraInfoCollector.ExtraInfoExecutionException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------- -------------
          `ExtraInfoExecutionException​(String message)`                                                
          `ExtraInfoExecutionException​(String message,                            Throwable cause)`    
