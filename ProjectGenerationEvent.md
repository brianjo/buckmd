...
## Class ProjectGenerationEvent {#class-projectgenerationevent .title title="Class ProjectGenerationEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.ProjectGenerationEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class ProjectGenerationEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- ------------------------------------ -------------
          `static class `     `ProjectGenerationEvent.Finished`     
          `static class `     `ProjectGenerationEvent.Processed`    
          `static class `     `ProjectGenerationEvent.Started`      
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------------------- -------------------- -------------
          `static ProjectGenerationEvent.Finished`    `finished()`          
          `String`                                    `getValueString()`    
          `static ProjectGenerationEvent.Processed`   `processed()`         
          `static ProjectGenerationEvent.Started`     `started()`           
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### started
            ...
            ``` methodSignature
            public static ProjectGenerationEvent.Started started()
            ```
        ...
        -   #### finished
            ...
            ``` methodSignature
            public static ProjectGenerationEvent.Finished finished()
            ```
        ...
        -   #### processed
            ...
            ``` methodSignature
            public static ProjectGenerationEvent.Processed processed()
            ```
    :::
:::
:::
