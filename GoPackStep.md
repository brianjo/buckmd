...
## Class GoPackStep {#class-gopackstep .title title="Class GoPackStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.go.GoPackStep
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- ------------------------ -------------
          `static class `     `GoPackStep.Operation`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `GoPackStep​(Path workingDirectory,           com.google.common.collect.ImmutableMap<String,​String> environment,           com.google.common.collect.ImmutableList<String> packCommandPrefix,           GoPackStep.Operation op,           com.google.common.collect.ImmutableList<Path> srcs,           Iterable<Path> filteredAsmSrcs,           Path output)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(java.nio.file.Path,com.google.common.collect.ImmutableMap,com.google.common.collect.ImmutableList,com.facebook.buck.features.go.GoPackStep.Operation,com.google.common.collect.ImmutableList,java.lang.Iterable,java.nio.file.Path)}

        -   #### GoPackStep

                public GoPackStep​(Path workingDirectory,
                                  com.google.common.collect.ImmutableMap<String,​String> environment,
                                  com.google.common.collect.ImmutableList<String> packCommandPrefix,
                                  GoPackStep.Operation op,
