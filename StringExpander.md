...
## Class StringExpander\<M extends [Macro](Macro.html "interface in com.facebook.buck.rules.macros")\> {#class-stringexpanderm-extends-macro .title title="Class StringExpander"}
:::
...
-   -   [com.facebook.buck.rules.macros.AbstractMacroExpanderWithoutPrecomputedWork](AbstractMacroExpanderWithoutPrecomputedWork.html "class in com.facebook.buck.rules.macros")\<M\>
    ...
    -   -   [com.facebook.buck.rules.macros.SimpleMacroExpander](SimpleMacroExpander.html "class in com.facebook.buck.rules.macros")\<M\>
        ...
        -   -   com.facebook.buck.rules.macros.StringExpander\<M\>
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class StringExpander<M extends Macro>
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------- -------------
          `StringExpander​(Class<M> clazz,               StringArg toReturn)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(java.lang.Class,com.facebook.buck.rules.args.StringArg)}

        -   #### StringExpander

                public StringExpander​(Class<M> clazz,
                                      StringArg toReturn)
    :::
