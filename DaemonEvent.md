...
## Class DaemonEvent {#class-daemonevent .title title="Class DaemonEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.DaemonEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class DaemonEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- --------------------------------- -------------
          `static class `     `DaemonEvent.NewDaemonInstance`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------------- -------------
          `DaemonEvent​(EventKey eventKey,            String eventName)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static DaemonEvent.NewDaemonInstance`   `newDaemonInstance​(String eventName)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### DaemonEvent
                ...
                public DaemonEvent​(EventKey eventKey,
                                   String eventName)
    :::
    ...
    -   []{#method.detail}
        ...
        []{#newDaemonInstance(java.lang.String)}

        -   #### newDaemonInstance

            ``` methodSignature
            public static DaemonEvent.NewDaemonInstance newDaemonInstance​(String eventName)
            ```
    :::
:::
:::
