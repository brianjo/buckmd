...
## Class RuleAnalysisConfig {#class-ruleanalysisconfig .title title="Class RuleAnalysisConfig"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.core.rules.analysis.config.RuleAnalysisConfig
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class RuleAnalysisConfig
        extends Object
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------- --------------------------- -------------
          `RuleAnalysisComputationMode`   `getComputationMode()`       
          `abstract BuckConfig`           `getDelegate()`              
          `static RuleAnalysisConfig`     `of​(BuckConfig delegate)`    
