...
## Class CacheStatsEvent {#class-cachestatsevent .title title="Class CacheStatsEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.CacheStatsEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------------------- -------------
          `CacheStatsEvent​(String eventName,                CacheStats stats)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(java.lang.String,com.facebook.buck.util.cache.CacheStats)}

        -   #### CacheStatsEvent

                public CacheStatsEvent​(String eventName,
                                       CacheStats stats)
    :::
