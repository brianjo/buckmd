...
## Interface FileContentsScrubber {#interface-filecontentsscrubber .title title="Interface FileContentsScrubber"}
:::
...
-   
    ...
    :   `DylibStubContentsScrubber`, `LcUuidContentsScrubber`,
        `OsoSymbolsContentsScrubber`

    ------------------------------------------------------------------------

        public interface FileContentsScrubber
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### scrubFile
            ...
            ``` methodSignature
            void scrubFile​(FileChannel file)
                    throws IOException,
                           FileScrubber.ScrubException
            ```
