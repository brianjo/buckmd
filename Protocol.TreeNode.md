...
## Interface Protocol.TreeNode {#interface-protocol.treenode .title title="Interface Protocol.TreeNode"}
:::
...
-   
    ...
    :   `Protocol.DirectoryNode`, `Protocol.FileNode`,
    ...
    ------------------------------------------------------------------------
        ...
        public static interface Protocol.TreeNode
