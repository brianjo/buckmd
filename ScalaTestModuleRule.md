...
## Class ScalaTestModuleRule {#class-scalatestmodulerule .title title="Class ScalaTestModuleRule"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.features.project.intellij.BaseIjModuleRule](../../BaseIjModuleRule.html "class in com.facebook.buck.features.project.intellij")\<[ScalaTestDescriptionArg](../../../../../jvm/scala/ScalaTestDescriptionArg.html "class in com.facebook.buck.jvm.scala")\>

    -   -   com.facebook.buck.features.project.intellij.lang.scala.ScalaTestModuleRule

::: description
-   

    All Implemented Interfaces:
    :   `IjModuleRule<ScalaTestDescriptionArg>`

    ------------------------------------------------------------------------

        public class ScalaTestModuleRule
        extends BaseIjModuleRule<ScalaTestDescriptionArg>
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `ScalaTestModuleRule​(ProjectFilesystem projectFilesystem,                    IjModuleFactoryResolver moduleFactoryResolver,                    IjProjectConfig projectConfig)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------------------------------------- -------------------------------------------------------------------------------------- -------------
          `void`                                             `apply​(TargetNode<ScalaTestDescriptionArg> target,      ModuleBuildContext context)`    
          `IjModuleType`                                     `detectModuleType​(TargetNode<ScalaTestDescriptionArg> targetNode)`                      
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### ScalaTestModuleRule
                ...
                public ScalaTestModuleRule​(ProjectFilesystem projectFilesystem,
    ...
    -   []{#method.detail}
        ...
        -   #### apply
            ...
            ``` methodSignature
            public void apply​(TargetNode<ScalaTestDescriptionArg> target,
