...
## Class QueryPathsMacro {#class-querypathsmacro .title title="Class QueryPathsMacro"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class QueryPathsMacro
        extends QueryMacro

    ::: block
    Class providing the type for macros used in \`\$(query_paths \...)\`
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static QueryPathsMacro`   `of​(Query query)`    
