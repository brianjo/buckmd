...
## Interface PluginClassLoader {#interface-pluginclassloader .title title="Interface PluginClassLoader"}
:::
...
-   
    ...
    ::: block
    Utility interface for loading classes that live in Buck\'s Java
    compiler plugin.
    :::
:::
