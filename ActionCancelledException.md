...
## Class ActionCancelledException {#class-actioncancelledexception .title title="Class ActionCancelledException"}
:::
...
-   
    ...
    ::: block
    Represents an action being cancelled (for instance by the action
    being stolen
    :::

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../../serialized-form.html#com.facebook.buck.rules.modern.builders.ActionCancelledException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------- -------------
          `ActionCancelledException​(Throwable t)`    
