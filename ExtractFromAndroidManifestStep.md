...
## Class ExtractFromAndroidManifestStep {#class-extractfromandroidmanifeststep .title title="Class ExtractFromAndroidManifestStep"}
:::
...
-   -   [com.facebook.buck.step.AbstractExecutionStep](../step/AbstractExecutionStep.html "class in com.facebook.buck.step")
    ...
    -   -   com.facebook.buck.android.ExtractFromAndroidManifestStep
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class ExtractFromAndroidManifestStep
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `ExtractFromAndroidManifestStep​(Path manifest,                               ProjectFilesystem filesystem,                               Path pathToRDotJavaPackageFile)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(java.nio.file.Path,com.facebook.buck.io.filesystem.ProjectFilesystem,java.nio.file.Path)}

        -   #### ExtractFromAndroidManifestStep

                public ExtractFromAndroidManifestStep​(Path manifest,
