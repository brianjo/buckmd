...
## Class LdflagsStaticPicMacro {#class-ldflagsstaticpicmacro .title title="Class LdflagsStaticPicMacro"}
:::
...
-   -   [com.facebook.buck.rules.macros.CxxGenruleFilterAndTargetsMacro](CxxGenruleFilterAndTargetsMacro.html "class in com.facebook.buck.rules.macros")
    ...
    -   -   com.facebook.buck.rules.macros.LdflagsStaticPicMacro
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class LdflagsStaticPicMacro
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static LdflagsStaticPicMacro`   `of​(Optional<Pattern> pattern,   com.google.common.collect.ImmutableList<BuildTarget> buildTargets)`    
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### of
            ...
            ``` methodSignature
            public static LdflagsStaticPicMacro of​(Optional<Pattern> pattern,
