...
## Class TestRunEvent {#class-testrunevent .title title="Class TestRunEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.core.test.event.TestRunEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- ------------------------- -------------
          `static class `     `TestRunEvent.Finished`    
          `static class `     `TestRunEvent.Started`     
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------------------- ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `static TestRunEvent.Finished`   `finished​(com.google.common.collect.ImmutableSet<String> targets,         List<TestResults> completedResults)`                                                                             
          `static TestRunEvent.Started`    `started​(boolean isRunAllTests,        TestSelectorList testSelectorList,        boolean shouldExplainTestSelectorList,        com.google.common.collect.ImmutableSet<String> targets)`    
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### started
            ...
            ``` methodSignature
            public static TestRunEvent.Started started​(boolean isRunAllTests,
                                                       TestSelectorList testSelectorList,
                                                       boolean shouldExplainTestSelectorList,
                                                       com.google.common.collect.ImmutableSet<String> targets)
            ```

        []{#finished(com.google.common.collect.ImmutableSet,java.util.List)}

        -   #### finished

            ``` methodSignature
            public static TestRunEvent.Finished finished​(com.google.common.collect.ImmutableSet<String> targets,
