...
## Class CacheCountersSummaryEvent {#class-cachecounterssummaryevent .title title="Class CacheCountersSummaryEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.artifact_cache.CacheCountersSummaryEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class CacheCountersSummaryEvent
        extends AbstractBuckEvent

    ::: block
    This Event is to be used to report
    [`CacheCountersSummary`](CacheCountersSummary.html "class in com.facebook.buck.artifact_cache")
    to listeners that register to the event.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------------ -------------------------------------------- -------------
          `String`                             `getEventName()`                              
          `CacheCountersSummary`               `getSummary()`                                
          `protected String`                   `getValueString()`                            
          `static CacheCountersSummaryEvent`   `newSummary​(CacheCountersSummary summary)`    
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        []{#newSummary(com.facebook.buck.artifact_cache.CacheCountersSummary)}
