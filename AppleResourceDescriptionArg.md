...
## Class AppleResourceDescriptionArg {#class-appleresourcedescriptionarg .title title="Class AppleResourceDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class AppleResourceDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `AppleResourceDe      | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `s                    | `builder()`           | ::: block             |
        | tatic AppleResourceDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`AppleResourceDe     |
        |                       |                       | scriptionArg`](AppleR |
        |                       |                       | esourceDescriptionArg |
        |                       |                       | .html "class in com.f |
        |                       |                       | acebook.buck.apple"). |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.google           | `ge                   |                       |
        | .common.collect.Immut | tResourcesFromDeps()` |                       |
        | ableSet<BuildTarget>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.googl            | `getVariants()`       |                       |
        | e.common.collect.Immu |                       |                       |
        | tableSet<SourcePath>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `int`                 | `hashCode()`          | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getDirs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSet<SourcePath> getDirs()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `dirs` attribute
        ...
        -   #### getFiles
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSet<SourcePath> getFiles()
            ```
        ...
        -   #### getVariants
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSet<SourcePath> getVariants()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `variants` attribute

        []{#getResourcesFromDeps()}

        -   #### getResourcesFromDeps

            ``` methodSignature
            public com.google.common.collect.ImmutableSet<BuildTarget> getResourcesFromDeps()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `resourcesFromDeps` attribute
        ...
        -   #### getDestination
            ...
            ``` methodSignature
            public Optional<AppleBundleDestination> getDestination()
            ```
        ...
        -   #### equals
            ...
            `AppleResourceDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `dirs`, `files`,
            `variants`, `resourcesFromDeps`, `destination`,
            `codesignOnCopy`, `licenses`, `labels`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `AppleResourceDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static AppleResourceDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new AppleResourceDescriptionArg builder
    :::
:::
:::
:::
