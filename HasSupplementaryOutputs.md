...
## Interface HasSupplementaryOutputs {#interface-hassupplementaryoutputs .title title="Interface HasSupplementaryOutputs"}
:::
...
-   
    ...
    :   `AppleTestX`, `CxxBinary`, `CxxLink`, `GoTestX`, `JavaTestX`,
        `PythonTestX`, `RobolectricTestX`

    ------------------------------------------------------------------------

        public interface HasSupplementaryOutputs
        extends BuildRule
