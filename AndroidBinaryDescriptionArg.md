...
## Class AndroidBinaryDescriptionArg {#class-androidbinarydescriptionarg .title title="Class AndroidBinaryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.android.AndroidBinaryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class AndroidBinaryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `AndroidBinaryDe      | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `s                    | `builder()`           | ::: block             |
        | tatic AndroidBinaryDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`AndroidBinaryDesc   |
        |                       |                       | riptionArg`](AndroidB |
        |                       |                       | inaryDescriptionArg.h |
        |                       |                       | tml "class in com.fac |
        |                       |                       | ebook.buck.android"). |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `Android              | `withApplic           |                       |
        | BinaryDescriptionArg` | ationModuleBlacklist​( |                       |
        |                       | List<Query> queries)` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `AndroidBinaryDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            `secondaryDexTailClassesFile`, `androidAppModularityResult`,
            `linearAllocHardLimit`, `dexGroupLibLimit`,
            `resourceFilter`, `preprocessJavaClassesDeps`,
            `xzCompressionLevel`, `packageAssetLibraries`,
            `compressAssetLibraries`, `assetCompressionAlgorithm`,
            `redex`, `redexConfig`, `redexExtraArgs`, `deps`,
            `licenses`, `labels`, `defaultTargetPlatform`,
            `compatibleWith`, `name`, `exopackage`, `exopackageModes`,
            `tests`, `manifest`, `manifestSkeleton`,
            `moduleManifestSkeleton`, `packageType`, `noDx`,
            `disablePreDex`, `androidSdkProguardConfig`,
            ...
            `additionalAaptParams`, `aaptMode`, `trimResourceIds`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `AndroidBinaryDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static AndroidBinaryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new AndroidBinaryDescriptionArg builder
