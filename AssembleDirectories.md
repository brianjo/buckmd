...
## Class AssembleDirectories {#class-assembledirectories .title title="Class AssembleDirectories"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../core/rules/impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   com.facebook.buck.android.AssembleDirectories
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class AssembleDirectories
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `AssembleDirectories​(BuildTarget buildTarget,                    ProjectFilesystem projectFilesystem,                    SourcePathRuleFinder ruleFinder,                    com.google.common.collect.ImmutableCollection<SourcePath> directories)`    
