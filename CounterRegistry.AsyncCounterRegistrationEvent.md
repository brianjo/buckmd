...
## Class CounterRegistry.AsyncCounterRegistrationEvent {#class-counterregistry.asynccounterregistrationevent .title title="Class CounterRegistry.AsyncCounterRegistrationEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.counters.CounterRegistry.AsyncCounterRegistrationEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class CounterRegistry.AsyncCounterRegistrationEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------- -------------
          `AsyncCounterRegistrationEvent​(com.google.common.collect.ImmutableList<Counter> counters)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------------------------------------------- -------------------- -------------
          `com.google.common.collect.ImmutableCollection<Counter>`   `getCounters()`       
          `String`                                                   `getEventName()`      
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### AsyncCounterRegistrationEvent

                public AsyncCounterRegistrationEvent​(com.google.common.collect.ImmutableList<Counter> counters)
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### getCounters
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableCollection<Counter> getCounters()
            ```
