...
## Class GoTestRunnerDescriptionArg {#class-gotestrunnerdescriptionarg .title title="Class GoTestRunnerDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.go.GoTestRunnerDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class GoTestRunnerDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `GoTestRunnerDe       | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `                     | `builder()`           | ::: block             |
        | static GoTestRunnerDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`GoTestRunnerDescrip |
        |                       |                       | tionArg`](GoTestRunne |
        |                       |                       | rDescriptionArg.html  |
        |                       |                       | "class in com.faceboo |
        |                       |                       | k.buck.features.go"). |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getTestRunnerGenerator
            ...
            [Returns:]{.returnLabel}
            :   The value of the `testRunnerGenerator` attribute
        ...
        -   #### equals
            ...
            `GoTestRunnerDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `GoTestRunnerDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static GoTestRunnerDescriptionArg.Builder builder()
            ```

            ::: block
            Creates a builder for
            [`GoTestRunnerDescriptionArg`](GoTestRunnerDescriptionArg.html "class in com.facebook.buck.features.go").
            :::

            [Returns:]{.returnLabel}
            :   A new GoTestRunnerDescriptionArg builder
    :::
:::
:::
:::
