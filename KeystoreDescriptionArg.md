...
## Class KeystoreDescriptionArg {#class-keystoredescriptionarg .title title="Class KeystoreDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class KeystoreDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `KeystoreDe           | ::: block             |
        |                       | scriptionArg.Builder` | Builds instances of   |
        |                       |                       | type                  |
        |                       |                       | [`Keystore            |
        |                       |                       | DescriptionArg`](Keys |
        |                       |                       | toreDescriptionArg.ht |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static KeystoreDe    | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getProperties
            ...
            ``` methodSignature
            public SourcePath getProperties()
            ```
        ...
        -   #### equals
            ...
            `KeystoreDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `store`, `properties`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `KeystoreDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static KeystoreDescriptionArg.Builder builder()
            ```

            ::: block
            Creates a builder for
            [`KeystoreDescriptionArg`](KeystoreDescriptionArg.html "class in com.facebook.buck.jvm.java").
            :::

            [Returns:]{.returnLabel}
            :   A new KeystoreDescriptionArg builder
    :::
:::
:::
:::
