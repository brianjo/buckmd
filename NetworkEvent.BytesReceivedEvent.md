...
## Class NetworkEvent.BytesReceivedEvent {#class-networkevent.bytesreceivedevent .title title="Class NetworkEvent.BytesReceivedEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.event.NetworkEvent](NetworkEvent.html "class in com.facebook.buck.event")

        -   -   com.facebook.buck.event.NetworkEvent.BytesReceivedEvent
...
-   
    ...
    Enclosing class:
    :   [NetworkEvent](NetworkEvent.html "class in com.facebook.buck.event")

    ------------------------------------------------------------------------

        public static class NetworkEvent.BytesReceivedEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        -   []{#nested.classes.inherited.from.class.com.facebook.buck.event.NetworkEvent}

            ### Nested classes/interfaces inherited from class com.facebook.buck.event.[NetworkEvent](NetworkEvent.html "class in com.facebook.buck.event")
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------ -------------
          `BytesReceivedEvent​(long bytesReceived)`    
