...
-   ::: {#tests}
    ...
    A list of [build target](/concept/build_target.html)s that should be
    tested.
    :::
...
This test_suite() sets up two different sets of tests to run, \'all\'
tests and \'slow\' tests. Note that `all_tests` can depend on
`slow_tests`, and all three tests are run.
