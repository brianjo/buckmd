...
## Class AppleTestDescriptionArg {#class-appletestdescriptionarg .title title="Class AppleTestDescriptionArg"}
:::
...
-   
    ...
    :   `AppleNativeTargetDescriptionArg`, `HasAppleBundleFields`,
        `HasAppleCodesignFields`, `HasEntitlementsFile`, `BuildRuleArg`,
        `ConstructorArg`, `DataTransferObject`, `HasContacts`,
        `HasDeclaredDeps`, `HasDefaultPlatform`, `HasTests`,
        `HasTestTimeout`, `HasDefaultFlavors`, `HasTestRunner`,
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class AppleTestDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `AppleTestDe          | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static AppleTestDe   | `builder()`           | ::: block             |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.google.c         | `getDe                |                       |
        | ommon.collect.Immutab | stinationSpecifier()` |                       |
        | leMap<String,​String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `                     | `g                    |                       |
        ...
        |                       | tRunTestSeparately()` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<Either      | `getSnap              |                       |
        | <SourcePath,​String>>` | shotImagesDiffPath()` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<Either      | `getSnapshotR         |                       |
        | <SourcePath,​String>>` | eferenceImagesPath()` |                       |
        +-----------------------+-----------------------+-----------------------+
        ...
        +-----------------------+-----------------------+-----------------------+
        | `O                    | `                     |                       |
        | ptional<BuildTarget>` | getUiTestTargetApp()` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getIsUiTest
            ...
            [Returns:]{.returnLabel}
            :   The value of the `isUiTest` attribute
        ...
        -   #### getTestHostApp
            ...
            [Returns:]{.returnLabel}
            :   The value of the `testHostApp` attribute
        ...
        -   #### getUiTestTargetApp
            ...
            [Returns:]{.returnLabel}
            :   The value of the `uiTestTargetApp` attribute
        ...
        -   #### getSnapshotReferenceImagesPath
            ...
            [Returns:]{.returnLabel}
            :   The value of the `snapshotReferenceImagesPath` attribute
        ...
        -   #### getSnapshotImagesDiffPath
            ...
            [Returns:]{.returnLabel}
            :   The value of the `snapshotImagesDiffPath` attribute
        ...
        -   #### getDestinationSpecifier
            ...
            [Returns:]{.returnLabel}
            :   The value of the `destinationSpecifier` attribute
        ...
        -   #### equals
            ...
            `AppleTestDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            `isUiTest`, `testHostApp`, `uiTestTargetApp`,
            `snapshotReferenceImagesPath`, `snapshotImagesDiffPath`,
            `destinationSpecifier`, `env`, `configs`,
            `headerPathPrefix`, `modular`, `modulemapMode`,
            `targetSdkVersion`, `exportedHeaders`,
            `exportedPlatformHeaders`, `exportedPreprocessorFlags`,
            ...
            `swiftCompilerFlags`, `swiftVersion`, `infoPlist`,
            `xcodeProductType`, `isAppClip`, `infoPlistSubstitutions`,
            `assetCatalogsCompilationOptions`, `codesignFlags`,
            `codesignIdentity`, `contacts`, `entitlementsFile`,
            `testRuleTimeoutMs`, `runner`, `specs`.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `AppleTestDescriptionArg` with
            attribute values.
            :::
