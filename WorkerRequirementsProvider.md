...
## Interface WorkerRequirementsProvider {#interface-workerrequirementsprovider .title title="Interface WorkerRequirementsProvider"}
:::
...
-   ::: {.section role="region"}
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------------------------------------------------- ---------------------------------------------------------------------------------------- -------------
          `com.facebook.buck.remoteexecution.proto.WorkerRequirements`   `resolveRequirements​(BuildTarget target,                    String auxiliaryBuildTag)`    
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### resolveRequirements
            ...
            ``` methodSignature
            com.facebook.buck.remoteexecution.proto.WorkerRequirements resolveRequirements​(BuildTarget target,
