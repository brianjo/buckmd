...
## Interface AuthAwareDownloader {#interface-authawaredownloader .title title="Interface AuthAwareDownloader"}
:::
...
-   ::: {.section role="region"}
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------- ---------------------------------------------------------------------------------------------------------------------- -------------
          `boolean`           `fetch​(BuckEventBus eventBus,      URI uri,      Optional<PasswordAuthentication> authentication,      Path output)`    
