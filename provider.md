...
function can be used to create \"struct-like\" values. Example:\
...
-   `doc` (defaults to `''`) A description of the provider that can be
    extracted by documentation generating tools.
-   `fields` (defaults to `None`) If specified, restricts the set of
    allowed fields.\
    Possible values are:
    -   list of fields:\
