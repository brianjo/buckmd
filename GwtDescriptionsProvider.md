...
## Class GwtDescriptionsProvider {#class-gwtdescriptionsprovider .title title="Class GwtDescriptionsProvider"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.gwt.GwtDescriptionsProvider
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Extension
        public class GwtDescriptionsProvider
        extends Object
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### GwtDescriptionsProvider
                ...
                public GwtDescriptionsProvider()
    :::
