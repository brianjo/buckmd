...
## Interface InputRuleResolver {#interface-inputruleresolver .title title="Interface InputRuleResolver"}
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static interface `   | `InputRuleReso        | ::: block             |
        |                       | lver.UnsafeInternals` | Encapsulates some     |
        |                       |                       | exposed internal      |
        |                       |                       | implementation        |
        |                       |                       | details.              |
        |                       |                       | :::                   |
