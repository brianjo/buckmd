...
## Class NoHealthyServersException {#class-nohealthyserversexception .title title="Class NoHealthyServersException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class NoHealthyServersException
        extends IOException

    ::: block
    Thrown when the load balancer cannot find any healthy servers to
    make the request to.
    :::

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../serialized-form.html#com.facebook.buck.slb.NoHealthyServersException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------- -------------
          `NoHealthyServersException​(String message)`    
