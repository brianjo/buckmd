...
## Class LegacyToolchainDescriptionArg {#class-legacytoolchaindescriptionarg .title title="Class LegacyToolchainDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.core.toolchain.rule.LegacyToolchainDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class LegacyToolchainDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `LegacyToolchainDe    | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `sta                  | `builder()`           | ::: block             |
        | tic LegacyToolchainDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`LegacyToolch        |
        |                       |                       | ainDescriptionArg`](L |
        |                       |                       | egacyToolchainDescrip |
        |                       |                       | tionArg.html "class i |
        |                       |                       | n com.facebook.buck.c |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `LegacyToolchainDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `LegacyToolchainDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static LegacyToolchainDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new LegacyToolchainDescriptionArg builder
    :::
:::
:::
:::
