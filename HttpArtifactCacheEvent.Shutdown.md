...
## Class HttpArtifactCacheEvent.Shutdown {#class-httpartifactcacheevent.shutdown .title title="Class HttpArtifactCacheEvent.Shutdown"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.artifact_cache.HttpArtifactCacheEvent.Shutdown
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class HttpArtifactCacheEvent.Shutdown
