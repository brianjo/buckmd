...
## Class ParseEvent {#class-parseevent .title title="Class ParseEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.parser.ParseEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- ----------------------- -------------
          `static class `     `ParseEvent.Finished`    
          `static class `     `ParseEvent.Started`     
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------------------------------- ---------------------------------------------------------------------------------------------------------- -------------
          `static ParseEvent.Finished`                            `finished​(ParseEvent.Started started,         long processedBytes,         Optional<TargetGraph> graph)`    
          `com.google.common.collect.ImmutableSet<BuildTarget>`   `getBuildTargets()`                                                                                         
          `String`                                                `getCategory()`                                                                                             
          `String`                                                `getValueString()`                                                                                          
          `static ParseEvent.Started`                             `started​(com.google.common.collect.ImmutableSet<BuildTarget> buildTargets)`                                 
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.event.EventKey,com.google.common.collect.ImmutableSet)}

        -   #### ParseEvent

                protected ParseEvent​(EventKey eventKey,
    ...
    -   []{#method.detail}
        ...
        []{#started(com.google.common.collect.ImmutableSet)}
        ...
        []{#finished(com.facebook.buck.parser.ParseEvent.Started,long,java.util.Optional)}

        -   #### finished

            ``` methodSignature
            public static ParseEvent.Finished finished​(ParseEvent.Started started,
                                                       long processedBytes,
