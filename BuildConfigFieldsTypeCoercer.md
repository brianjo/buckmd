...
## Class BuildConfigFieldsTypeCoercer {#class-buildconfigfieldstypecoercer .title title="Class BuildConfigFieldsTypeCoercer"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.rules.coercer.LeafTypeCoercer](LeafTypeCoercer.html "class in com.facebook.buck.rules.coercer")\<[BuildConfigFields](BuildConfigFields.html "class in com.facebook.buck.rules.coercer")\>

    -   -   com.facebook.buck.rules.coercer.BuildConfigFieldsTypeCoercer

::: description
-   

    All Implemented Interfaces:
    :   `Concatable<BuildConfigFields>`,
        `TypeCoercer<Object,​BuildConfigFields>`

    ------------------------------------------------------------------------

        public class BuildConfigFieldsTypeCoercer
        extends LeafTypeCoercer<BuildConfigFields>

    ::: block
    [`TypeCoercer`](TypeCoercer.html "interface in com.facebook.buck.rules.coercer")
    that takes a list of strings and transforms it into a
    [`BuildConfigFields`](BuildConfigFields.html "class in com.facebook.buck.rules.coercer").
    This class takes care of parsing each string, making sure it
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------------------------------------------- ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `BuildConfigFields`                                        `coerce​(CellNameResolver cellRoots,       ProjectFilesystem filesystem,       ForwardRelativePath pathRelativeToProjectRoot,       TargetConfiguration targetConfiguration,       TargetConfiguration hostConfiguration,       Object object)`    
          `com.google.common.reflect.TypeToken<BuildConfigFields>`   `getOutputType()`                                                                                                                                                                                                                                 
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### BuildConfigFieldsTypeCoercer
                ...
                public BuildConfigFieldsTypeCoercer()
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### coerce
            ...
            ``` methodSignature
            public BuildConfigFields coerce​(CellNameResolver cellRoots,
