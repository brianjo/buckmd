...
## Class GoTestCoverStep {#class-gotestcoverstep .title title="Class GoTestCoverStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.go.GoTestCoverStep
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `GoTestCoverStep​(AbsPath workingDirectory,                Path sourceFile,                Path targetFile,                com.google.common.collect.ImmutableMap<String,​String> environment,                com.google.common.collect.ImmutableList<String> generatorCommandPrefix,                com.facebook.buck.features.go.GoTestCoverStep.Mode coverageMode)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,java.nio.file.Path,java.nio.file.Path,com.google.common.collect.ImmutableMap,com.google.common.collect.ImmutableList,com.facebook.buck.features.go.GoTestCoverStep.Mode)}

        -   #### GoTestCoverStep

                public GoTestCoverStep​(AbsPath workingDirectory,
                                       Path sourceFile,
                                       Path targetFile,
