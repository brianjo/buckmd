...
## Interface BuildRuleWithBinary {#interface-buildrulewithbinary .title title="Interface BuildRuleWithBinary"}
:::
...
-   
    ...
    :   `AppleBundle`, `AppleDebuggableBinary`

    ------------------------------------------------------------------------

        public interface BuildRuleWithBinary
        extends BuildRule
