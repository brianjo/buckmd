...
## Class ParseBuckProfilerReportEvent {#class-parsebuckprofilerreportevent .title title="Class ParseBuckProfilerReportEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.parser.events.ParseBuckProfilerReportEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class ParseBuckProfilerReportEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static ParseBuckProfilerReportEvent`   `profilerReport​(String report)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### ParseBuckProfilerReportEvent

                protected ParseBuckProfilerReportEvent​(EventKey eventKey,
                                                       String report)
    :::
    ...
    -   []{#method.detail}
        ...
        []{#profilerReport(java.lang.String)}
