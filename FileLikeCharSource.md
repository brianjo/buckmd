...
## Class FileLikeCharSource {#class-filelikecharsource .title title="Class FileLikeCharSource"}
:::
...
-   -   com.google.common.io.CharSource
    ...
    -   -   com.facebook.buck.jvm.java.classes.FileLikeCharSource
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class FileLikeCharSource
        extends com.google.common.io.CharSource
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------- -------------
          `FileLikeCharSource​(FileLike fileLike)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.jvm.java.classes.FileLike)}
