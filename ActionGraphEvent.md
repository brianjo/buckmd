...
## Class ActionGraphEvent {#class-actiongraphevent .title title="Class ActionGraphEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.ActionGraphEvent
...
-   
    ...
    :   `ActionGraphEvent.Cache`, `ActionGraphEvent.Finished`,
        `ActionGraphEvent.IncrementalLoad`, `ActionGraphEvent.Started`
    ...
    ::: block
    Base class for events about building up the action graph from the
    target graph.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `Ac                   |                       |
        |                       | tionGraphEvent.Cache` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `static class `       | `Actio                |                       |
        |                       | nGraphEvent.Finished` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `static class `       | `ActionGraphE         | ::: block             |
        |                       | vent.IncrementalLoad` | Event for incremental |
        |                       |                       | action graph          |
        |                       |                       | construction.         |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `static class `       | `Acti                 |                       |
        |                       | onGraphEvent.Started` |                       |
        +-----------------------+-----------------------+-----------------------+
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------- -------------
          `ActionGraphEvent​(EventKey eventKey)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------------ ----------------------------------------------------------------- -------------
          `static ActionGraphEvent.Finished`   `finished​(ActionGraphEvent.Started started)`                       
          `static ActionGraphEvent.Finished`   `finished​(ActionGraphEvent.Started started,         int count)`    
          `String`                             `getCategory()`                                                    
          `protected String`                   `getValueString()`                                                 
          `static ActionGraphEvent.Started`    `started()`                                                        
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### started
            ...
            ``` methodSignature
            public static ActionGraphEvent.Started started()
            ```

        []{#finished(com.facebook.buck.event.ActionGraphEvent.Started)}

        -   #### finished

            ``` methodSignature
            public static ActionGraphEvent.Finished finished​(ActionGraphEvent.Started started)
            ```

        []{#finished(com.facebook.buck.event.ActionGraphEvent.Started,int)}
