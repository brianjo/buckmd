...
## Class TestRuleEvent {#class-testruleevent .title title="Class TestRuleEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.test.TestRuleEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class TestRuleEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- -------------------------- -------------
          `static class `     `TestRuleEvent.Finished`    
          `static class `     `TestRuleEvent.Started`     
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          --------------------------------- ------------------------------------- -------------
          `static TestRuleEvent.Finished`   `finished​(BuildTarget buildTarget)`    
          `BuildTarget`                     `getBuildTarget()`                     
          `String`                          `getValueString()`                     
          `static TestRuleEvent.Started`    `started​(BuildTarget buildTarget)`     
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### started
            ...
            ``` methodSignature
            public static TestRuleEvent.Started started​(BuildTarget buildTarget)
            ```
        ...
        -   #### finished
            ...
            ``` methodSignature
            public static TestRuleEvent.Finished finished​(BuildTarget buildTarget)
            ```
    :::
:::
:::
