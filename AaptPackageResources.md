...
## Class AaptPackageResources {#class-aaptpackageresources .title title="Class AaptPackageResources"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../core/rules/impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   com.facebook.buck.android.AaptPackageResources
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class AaptPackageResources
...
-   ::: {.section role="region"}
    -   []{#field.summary}
        ...
        ### Field Summary
          ...
          ------------------- ---------------------------- -------------
          `static String`     `RESOURCE_APK_PATH_FORMAT`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------------------------- --------------------------------------------------------------------------------------- -------------
          `com.facebook.buck.android.AaptOutputInfo`        `getAaptOutputInfo()`                                                                    
...
-   ::: {.section role="region"}
    -   []{#field.detail}
        ...
        -   #### RESOURCE_APK_PATH_FORMAT
                ...
                public static final String RESOURCE_APK_PATH_FORMAT

            [See Also:]{.seeLabel}
            :   [Constant Field
                Values](../../../../constant-values.html#com.facebook.buck.android.AaptPackageResources.RESOURCE_APK_PATH_FORMAT)
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### getAaptOutputInfo
            ...
            ``` methodSignature
            public com.facebook.buck.android.AaptOutputInfo getAaptOutputInfo()
            ```
    :::
:::
:::
