...
## Class BuildEvent.RuleCountCalculated {#class-buildevent.rulecountcalculated .title title="Class BuildEvent.RuleCountCalculated"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.core.build.event.BuildEvent](BuildEvent.html "class in com.facebook.buck.core.build.event")

        -   -   com.facebook.buck.core.build.event.BuildEvent.RuleCountCalculated
...
-   
    ...
    Enclosing class:
    :   [BuildEvent](BuildEvent.html "class in com.facebook.buck.core.build.event")

    ------------------------------------------------------------------------

        public static class BuildEvent.RuleCountCalculated
        extends BuildEvent
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        -   []{#nested.classes.inherited.from.class.com.facebook.buck.core.build.event.BuildEvent}

            ### Nested classes/interfaces inherited from class com.facebook.buck.core.build.event.[BuildEvent](BuildEvent.html "class in com.facebook.buck.core.build.event")

            `BuildEvent.BuildReport, BuildEvent.Finished, BuildEvent.RuleCountCalculated, BuildEvent.Started, BuildEvent.UnskippedRuleCountUpdated`
    :::
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- ------------------------------------------------------------------------------------------------------------------------------- -------------
          `protected `   `RuleCountCalculated​(com.google.common.collect.ImmutableSet<BuildTarget> buildRules,                    int numRulesToBuild)`    
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.core.build.event.BuildEvent}

            ### Methods inherited from class com.facebook.buck.core.build.event.[BuildEvent](BuildEvent.html "class in com.facebook.buck.core.build.event")

            `buildReport, finished, ruleCountCalculated, started, unskippedRuleCountUpdated`
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.google.common.collect.ImmutableSet,int)}

        -   #### RuleCountCalculated

                protected RuleCountCalculated​(com.google.common.collect.ImmutableSet<BuildTarget> buildRules,
                                              int numRulesToBuild)
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### getBuildRules
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSet<BuildTarget> getBuildRules()
            ```
