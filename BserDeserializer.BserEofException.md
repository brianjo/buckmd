...
## Class BserDeserializer.BserEofException {#class-bserdeserializer.bsereofexception .title title="Class BserDeserializer.BserEofException"}
:::
...
-   
    ...
    Enclosing class:
    :   [BserDeserializer](BserDeserializer.html "class in com.facebook.buck.util.bser")

    ------------------------------------------------------------------------

        public static class BserDeserializer.BserEofException
        extends IOException
    ...
    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.util.bser.BserDeserializer.BserEofException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------------------- -------------
          `BserEofException​(String message)`                                     
          `BserEofException​(String message,                 Throwable cause)`    
