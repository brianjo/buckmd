...
::: header
::: subTitle
[Package]{.packageLabelInType} [com.facebook.buck.features.project.intellij.lang.cxx](package-summary.html)
:::

## Class CxxLibraryModuleRule {#class-cxxlibrarymodulerule .title title="Class CxxLibraryModuleRule"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.features.project.intellij.BaseIjModuleRule](../../BaseIjModuleRule.html "class in com.facebook.buck.features.project.intellij")\<[CxxLibraryDescriptionArg](../../../../../cxx/CxxLibraryDescriptionArg.html "class in com.facebook.buck.cxx")\>

    -   -   com.facebook.buck.features.project.intellij.lang.cxx.CxxLibraryModuleRule

::: description
-   

    All Implemented Interfaces:
    :   `IjModuleRule<CxxLibraryDescriptionArg>`

    ------------------------------------------------------------------------

        public class CxxLibraryModuleRule
        extends BaseIjModuleRule<CxxLibraryDescriptionArg>
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `CxxLibraryModuleRule​(ProjectFilesystem projectFilesystem,                     IjModuleFactoryResolver moduleFactoryResolver,                     IjProjectConfig projectConfig)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------------------------------------- --------------------------------------------------------------------------------------- -------------
          `void`                                             `apply​(TargetNode<CxxLibraryDescriptionArg> target,      ModuleBuildContext context)`    
          `IjModuleType`                                     `detectModuleType​(TargetNode<CxxLibraryDescriptionArg> targetNode)`                      
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### CxxLibraryModuleRule

                public CxxLibraryModuleRule​(ProjectFilesystem projectFilesystem,
    ...
    -   []{#method.detail}
        ...
        -   #### apply
            ...
            ``` methodSignature
            public void apply​(TargetNode<CxxLibraryDescriptionArg> target,
