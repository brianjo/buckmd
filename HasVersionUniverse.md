...
## Interface HasVersionUniverse {#interface-hasversionuniverse .title title="Interface HasVersionUniverse"}
:::
...
-   
    ...
    :   `CgoLibraryDescriptionArg`, `CxxBinaryDescriptionArg`,
        ...
        `PythonBinaryDescriptionArg`, `PythonTestDescriptionArg`,
        `RustBinaryDescriptionArg`, `RustTestDescriptionArg`

    ------------------------------------------------------------------------

        public interface HasVersionUniverse
:::
