...
## Class HttpFileDescription {#class-httpfiledescription .title title="Class HttpFileDescription"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.file.HttpFileDescription

::: description
-   

    All Implemented Interfaces:
    :   `BaseDescription<HttpFileDescriptionArg>`,
        `Description<HttpFileDescriptionArg>`,
        `DescriptionWithTargetGraph<HttpFileDescriptionArg>`,
    ...
    ------------------------------------------------------------------------
        ...
        extends Object
        implements DescriptionWithTargetGraph<HttpFileDescriptionArg>, LegacyProviderCompatibleDescription<HttpFileDescriptionArg>

    ::: block
    A description for downloading a single HttpFile (versus the combo
    logic contained in
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +-----------------------+-----------------------+-----------------------+
        | `Pr                   | `createP              |                       |
        | oviderInfoCollection` | roviders​(ProviderCrea |                       |
        |                       | tionContext context,  |                       |
        |                       |                BuildT |                       |
        |                       | arget buildTarget,    |                       |
        |                       |              HttpFile |                       |
    ...
    -   []{#method.detail}
        ...
        -   #### getConstructorArgType
            ...
            :   `getConstructorArgType` in
                interface `BaseDescription<HttpFileDescriptionArg>`

        []{#createBuildRule(com.facebook.buck.core.rules.BuildRuleCreationContextWithTargetGraph,com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.file.HttpFileDescriptionArg)}
        ...
        -   #### createBuildRule
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createBuildRule` in
                interface `DescriptionWithTargetGraph<HttpFileDescriptionArg>`
        ...
        []{#createProviders(com.facebook.buck.core.rules.ProviderCreationContext,com.facebook.buck.core.model.BuildTarget,com.facebook.buck.file.HttpFileDescriptionArg)}
        ...
        -   #### createProviders
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createProviders` in
                interface `LegacyProviderCompatibleDescription<HttpFileDescriptionArg>`
