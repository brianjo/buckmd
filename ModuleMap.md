...
## Interface ModuleMap {#interface-modulemap .title title="Interface ModuleMap"}
:::
...
-   
    ...
    :   `HeadersModuleMap`, `UmbrellaHeaderModuleMap`
    ...
    ::: block
    An interface for classes capable of generating a Clang modulemap
    file.
    :::
:::
