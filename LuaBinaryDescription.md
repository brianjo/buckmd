...
## Class LuaBinaryDescription {#class-luabinarydescription .title title="Class LuaBinaryDescription"}
:::
...
-   
    ...
    :   `ImplicitDepsInferringDescription<com.facebook.buck.features.lua.LuaBinaryDescription.AbstractLuaBinaryDescriptionArg>`,
        `BaseDescription<LuaBinaryDescriptionArg>`,
        `Description<LuaBinaryDescriptionArg>`,
        `DescriptionWithTargetGraph<LuaBinaryDescriptionArg>`,
    ...
    ------------------------------------------------------------------------
        ...
        extends Object
        implements DescriptionWithTargetGraph<LuaBinaryDescriptionArg>, ImplicitDepsInferringDescription<com.facebook.buck.features.lua.LuaBinaryDescription.AbstractLuaBinaryDescriptionArg>, VersionRoot<LuaBinaryDescriptionArg>
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- ------------------------------------ -------------
          `static class `     `LuaBinaryDescription.StarterType`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------- -------------
          `LuaBinaryDescription​(ToolchainProvider toolchainProvider,                     CxxBuckConfig cxxBuckConfig)`    
    ...
    -   []{#method.summary}
        ...
        |                       |                       |                       |
        |                       |      com.facebook.buc |                       |
        |                       | k.features.lua.LuaBin |                       |
        |                       | aryDescription.Abstra |                       |
        |                       | ctLuaBinaryDescriptio |                       |
        |                       | nArg constructorArg,  |                       |
        |                       |                       |                       |
        |                       |                com.go |                       |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `protecte             | `getNative            |                       |
        | d static BuildTarget` | LibsSymlinkTreeTarget |                       |
        |                       | ​(BuildTarget target)` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### LuaBinaryDescription
                ...
                public LuaBinaryDescription​(ToolchainProvider toolchainProvider,
    ...
    -   []{#method.detail}
        ...
        -   #### getConstructorArgType
            ...
            :   `getConstructorArgType` in
                interface `BaseDescription<LuaBinaryDescriptionArg>`

        []{#getNativeLibsSymlinkTreeTarget(com.facebook.buck.core.model.BuildTarget)}

        -   #### getNativeLibsSymlinkTreeTarget

            ``` methodSignature
            protected static BuildTarget getNativeLibsSymlinkTreeTarget​(BuildTarget target)
            ```

        []{#createBuildRule(com.facebook.buck.core.rules.BuildRuleCreationContextWithTargetGraph,com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.features.lua.LuaBinaryDescriptionArg)}
        ...
        -   #### createBuildRule
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createBuildRule` in
                interface `DescriptionWithTargetGraph<LuaBinaryDescriptionArg>`
        ...
        []{#findDepsForTargetFromConstructorArgs(com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.cell.nameresolver.CellNameResolver,com.facebook.buck.features.lua.LuaBinaryDescription.AbstractLuaBinaryDescriptionArg,com.google.common.collect.ImmutableCollection.Builder,com.google.common.collect.ImmutableCollection.Builder)}
        ...
        -   #### findDepsForTargetFromConstructorArgs
            ...
            public void findDepsForTargetFromConstructorArgs​(BuildTarget buildTarget,
                                                             ...
                                                             com.facebook.buck.features.lua.LuaBinaryDescription.AbstractLuaBinaryDescriptionArg constructorArg,
            ...
            :   `findDepsForTargetFromConstructorArgs` in
                interface `ImplicitDepsInferringDescription<com.facebook.buck.features.lua.LuaBinaryDescription.AbstractLuaBinaryDescriptionArg>`
    :::
:::
:::
:::
