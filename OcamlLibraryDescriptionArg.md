...
## Class OcamlLibraryDescriptionArg {#class-ocamllibrarydescriptionarg .title title="Class OcamlLibraryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.ocaml.OcamlLibraryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class OcamlLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `OcamlLibraryDe       | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `                     | `builder()`           | ::: block             |
        | static OcamlLibraryDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`O                   |
        |                       |                       | camlLibraryDescriptio |
        |                       |                       | nArg`](OcamlLibraryDe |
        |                       |                       | scriptionArg.html "cl |
        |                       |                       | ass in com.facebook.b |
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `boolean`             | `getNativePlugin()`   |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `getOcamldepFlags()`  |                       |
        | ogle.common.collect.I |                       |                       |
        | mmutableList<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `                     | `getPlatformDeps()`   |                       |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `OcamlLibraryDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            `compilerFlags`, `ocamldepFlags`, `linkerFlags`,
            `warningsFlags`, `bytecodeOnly`, `nativePlugin`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `OcamlLibraryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static OcamlLibraryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new OcamlLibraryDescriptionArg builder
    :::
:::
:::
:::
