...
## Class LuaLibrary {#class-lualibrary .title title="Class LuaLibrary"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../../core/rules/impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   [com.facebook.buck.core.rules.impl.AbstractBuildRuleWithDeclaredAndExtraDeps](../../core/rules/impl/AbstractBuildRuleWithDeclaredAndExtraDeps.html "class in com.facebook.buck.core.rules.impl")
        ...
        -   -   [com.facebook.buck.core.rules.impl.NoopBuildRuleWithDeclaredAndExtraDeps](../../core/rules/impl/NoopBuildRuleWithDeclaredAndExtraDeps.html "class in com.facebook.buck.core.rules.impl")
            ...
            -   -   com.facebook.buck.features.lua.LuaLibrary
...
-   
    ...
    :   `BuildEngineAction`, `AllowsNonAnnotatedFields`,
        ...
        `LuaPackageable`, `Comparable<BuildRule>`
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------ -------------
          `LuaLibrary​(BuildTarget buildTarget,           ProjectFilesystem projectFilesystem,           BuildRuleParams params)`    
    ...
    -   []{#method.summary}
        ...
        <!-- -->
        ```
        -   []{#methods.inherited.from.class.com.facebook.buck.features.lua.LuaPackageable}

            ### Methods inherited from interface com.facebook.buck.features.lua.[LuaPackageable](LuaPackageable.html "interface in com.facebook.buck.features.lua")

            `getLuaPackageComponents, getLuaPackageDeps`
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### LuaLibrary
                ...
                public LuaLibrary​(BuildTarget buildTarget,
