...
## Class MachoScrubContentSectionsStep {#class-machoscrubcontentsectionsstep .title title="Class MachoScrubContentSectionsStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.cxx.MachoScrubContentSectionsStep
...
-   
    ...
    ::: block
    Uses the strip tool to remove the contents (i.e., compiled code)
    from a dylib.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `MachoScrubContentSectionsStep​(com.google.common.collect.ImmutableList<String> stripToolPrefix,                              ProjectFilesystem inputFilesystem,                              Path inputDylib,                              ProjectFilesystem outputFilesystem,                              Path outputDylib)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.google.common.collect.ImmutableList,com.facebook.buck.io.filesystem.ProjectFilesystem,java.nio.file.Path,com.facebook.buck.io.filesystem.ProjectFilesystem,java.nio.file.Path)}
