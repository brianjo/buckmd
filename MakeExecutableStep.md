...
## Class MakeExecutableStep {#class-makeexecutablestep .title title="Class MakeExecutableStep"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.step.fs.MakeExecutableStep
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class MakeExecutableStep
        extends Object
        implements Step
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------------------------------- -------------
          `MakeExecutableStep​(ProjectFilesystem filesystem,                   Path file)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### MakeExecutableStep
                ...
                public MakeExecutableStep​(ProjectFilesystem filesystem,
                                          Path file)
    :::
