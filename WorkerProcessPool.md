...
## Interface WorkerProcessPool {#interface-workerprocesspool .title title="Interface WorkerProcessPool"}
:::
...
-   
    ...
    :   `WorkerProcessPoolAsync`, `WorkerProcessPoolSync`

    ------------------------------------------------------------------------

        public interface WorkerProcessPool
        extends Closeable
:::
