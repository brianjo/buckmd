...
## Class DaemonEvent.NewDaemonInstance {#class-daemonevent.newdaemoninstance .title title="Class DaemonEvent.NewDaemonInstance"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.event.DaemonEvent](DaemonEvent.html "class in com.facebook.buck.event")

        -   -   com.facebook.buck.event.DaemonEvent.NewDaemonInstance
...
-   
    ...
    Enclosing class:
    :   [DaemonEvent](DaemonEvent.html "class in com.facebook.buck.event")

    ------------------------------------------------------------------------

        public static class DaemonEvent.NewDaemonInstance
        extends DaemonEvent
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        -   []{#nested.classes.inherited.from.class.com.facebook.buck.event.DaemonEvent}

            ### Nested classes/interfaces inherited from class com.facebook.buck.event.[DaemonEvent](DaemonEvent.html "class in com.facebook.buck.event")
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------- -------------
          `NewDaemonInstance​(String eventName)`    
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.event.DaemonEvent}

            ### Methods inherited from class com.facebook.buck.event.[DaemonEvent](DaemonEvent.html "class in com.facebook.buck.event")

            `getEventName, getValueString, newDaemonInstance`
