...
## Class CleanBuildShutdownException {#class-cleanbuildshutdownexception .title title="Class CleanBuildShutdownException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class CleanBuildShutdownException
        extends Exception

    ::: block
    \* Exception sent to BuildEngine to shut it down cleanly, i.e.
    without printing errors to console.
    :::

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../serialized-form.html#com.facebook.buck.util.CleanBuildShutdownException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------------- -------------
          `CleanBuildShutdownException​(String message)`    
