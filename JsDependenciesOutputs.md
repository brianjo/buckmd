...
## Interface JsDependenciesOutputs {#interface-jsdependenciesoutputs .title title="Interface JsDependenciesOutputs"}
:::
...
-   
    ...
    :   `JsBundleGenrule`, `JsDependenciesFile`

    ------------------------------------------------------------------------

        public interface JsDependenciesOutputs
        extends BuildRule
