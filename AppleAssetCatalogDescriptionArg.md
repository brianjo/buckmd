...
## Class AppleAssetCatalogDescriptionArg {#class-appleassetcatalogdescriptionarg .title title="Class AppleAssetCatalogDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class AppleAssetCatalogDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `AppleAssetCatalogDe  | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `stati                | `builder()`           | ::: block             |
        | c AppleAssetCatalogDe |                       | Creates a builder for |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getDirs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSortedSet<SourcePath> getDirs()
            ```
        ...
        -   #### getAppIcon
            ...
            [Returns:]{.returnLabel}
            :   The value of the `appIcon` attribute
        ...
        -   #### getLaunchImage
            ...
            [Returns:]{.returnLabel}
            :   The value of the `launchImage` attribute
        ...
        -   #### equals
            ...
            `AppleAssetCatalogDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `dirs`, `appIcon`,
            `launchImage`, `licenses`, `labels`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `AppleAssetCatalogDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static AppleAssetCatalogDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new AppleAssetCatalogDescriptionArg builder
    :::
:::
:::
:::
