...
## Class LoadBalancerPingEvent {#class-loadbalancerpingevent .title title="Class LoadBalancerPingEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.slb.LoadBalancerPingEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class LoadBalancerPingEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          --------------------- --------------------------------------------------- -------------
          `static interface `   `LoadBalancerPingEvent.LoadBalancerPingEventData`    
          `static interface `   `LoadBalancerPingEvent.PerServerPingData`            
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------- ------------------------------------------------------------------------------- -------------
          `protected `   `LoadBalancerPingEvent​(LoadBalancerPingEvent.LoadBalancerPingEventData data)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          --------------------------------------------------- -------------------- -------------
          `LoadBalancerPingEvent.LoadBalancerPingEventData`   `getData()`           
          `String`                                            `getEventName()`      
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.slb.LoadBalancerPingEvent.LoadBalancerPingEventData)}
    ...
    -   []{#method.detail}
        ...
        -   #### getData
            ...
            ``` methodSignature
            public LoadBalancerPingEvent.LoadBalancerPingEventData getData()
            ```
