...
## Class ExternalTestRunnerDescriptionArg {#class-externaltestrunnerdescriptionarg .title title="Class ExternalTestRunnerDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.core.test.rule.impl.ExternalTestRunnerDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ExternalTestRunnerDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `ExternalTestRunnerDescription.AbstractExternalTestRunnerDescriptionArg`.
    Use the builder to create immutable instances:
    `ExternalTestRunnerDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `ExternalTestRunnerDe | ::: block             |
        |                       | scriptionArg.Builder` | Builds instances of   |
        |                       |                       | type                  |
        |                       |                       | [`ExternalTestRunner  |
        |                       |                       | DescriptionArg`](Exte |
        |                       |                       | rnalTestRunnerDescrip |
    ...
    -   []{#method.summary}
        ...
        |  ExternalTestRunnerDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`ExternalTestRunner  |
        |                       |                       | DescriptionArg`](Exte |
        |                       |                       | rnalTestRunnerDescrip |
        |                       |                       | tionArg.html "class i |
        |                       |                       | n com.facebook.buck.c |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `ExternalTestRunnerDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `binary`, `licenses`,
        ...
        -   #### toString
            ...
            `ExternalTestRunnerDescriptionArg` with attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static ExternalTestRunnerDescriptionArg.Builder builder()
            ```

            ::: block
            Creates a builder for
            [`ExternalTestRunnerDescriptionArg`](ExternalTestRunnerDescriptionArg.html "class in com.facebook.buck.core.test.rule.impl").
            :::

            [Returns:]{.returnLabel}
            :   A new ExternalTestRunnerDescriptionArg builder
    :::
:::
:::
:::
