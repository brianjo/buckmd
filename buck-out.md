...
of your [project](/about/overview.html).
...
particular target, use the `--show-output` option with the
[`buck build`](/command/build.html) or the
[`buck targets`](/command/targets.html) command.
...
[`buck targets`](/command/targets.html) commands.
:::
