...
## Class AppleLibraryDescriptionArg {#class-applelibrarydescriptionarg .title title="Class AppleLibraryDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class AppleLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `AppleLibraryDe       | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `                     | `builder()`           | ::: block             |
        | static AppleLibraryDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`AppleLibraryD       |
        |                       |                       | escriptionArg`](Apple |
        |                       |                       | LibraryDescriptionArg |
        |                       |                       | .html "class in com.f |
        |                       |                       | acebook.buck.apple"). |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `AppleLibraryDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `AppleLibraryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static AppleLibraryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new AppleLibraryDescriptionArg builder
    :::
:::
:::
:::
