...
## Class RustBinaryDescription {#class-rustbinarydescription .title title="Class RustBinaryDescription"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.rust.RustBinaryDescription

::: description
-   

    All Implemented Interfaces:
    :   `ImplicitDepsInferringDescription<com.facebook.buck.features.rust.RustBinaryDescription.AbstractRustBinaryDescriptionArg>`,
        `BaseDescription<RustBinaryDescriptionArg>`,
        `Description<RustBinaryDescriptionArg>`, `Flavored`,
        `DescriptionWithTargetGraph<RustBinaryDescriptionArg>`,
    ...
    ------------------------------------------------------------------------
        ...
        extends Object
        implements DescriptionWithTargetGraph<RustBinaryDescriptionArg>, ImplicitDepsInferringDescription<com.facebook.buck.features.rust.RustBinaryDescription.AbstractRustBinaryDescriptionArg>, Flavored, VersionRoot<RustBinaryDescriptionArg>
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          --------------------------- ------------------------------ -------------
          `protected static class `   `RustBinaryDescription.Type`    
    ...
    -   []{#field.summary}
        ...
        ### Field Summary
          ...
          --------------------------------------------------- --------------- -------------
          `static FlavorDomain<RustBinaryDescription.Type>`   `BINARY_TYPE`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------ -------------
          `RustBinaryDescription​(ToolchainProvider toolchainProvider,                      RustBuckConfig rustBuckConfig)`    
    ...
    -   []{#method.summary}
        ...
        |                       |                       |                       |
        |                       |   com.facebook.buck.f |                       |
        |                       | eatures.rust.RustBina |                       |
        |                       | ryDescription.Abstrac |                       |
        |                       | tRustBinaryDescriptio |                       |
        |                       | nArg constructorArg,  |                       |
        |                       |                       |                       |
        |                       |                com.go |                       |
...
-   ::: {.section role="region"}
    -   []{#field.detail}
        ...
        -   #### BINARY_TYPE
                ...
                public static final FlavorDomain<RustBinaryDescription.Type> BINARY_TYPE
    :::
    ...
    -   []{#constructor.detail}
        ...
        -   #### RustBinaryDescription
                ...
                public RustBinaryDescription​(ToolchainProvider toolchainProvider,
    ...
    -   []{#method.detail}
        ...
        -   #### getConstructorArgType
            ...
            :   `getConstructorArgType` in
                interface `BaseDescription<RustBinaryDescriptionArg>`

        []{#createBuildRule(com.facebook.buck.core.rules.BuildRuleCreationContextWithTargetGraph,com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.features.rust.RustBinaryDescriptionArg)}
        ...
        -   #### createBuildRule
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createBuildRule` in
                interface `DescriptionWithTargetGraph<RustBinaryDescriptionArg>`
        ...
        -   #### findDepsForTargetFromConstructorArgs
            ...
            public void findDepsForTargetFromConstructorArgs​(BuildTarget buildTarget,
                                                             ...
                                                             com.facebook.buck.features.rust.RustBinaryDescription.AbstractRustBinaryDescriptionArg constructorArg,
            ...
            :   `findDepsForTargetFromConstructorArgs` in
                interface `ImplicitDepsInferringDescription<com.facebook.buck.features.rust.RustBinaryDescription.AbstractRustBinaryDescriptionArg>`
