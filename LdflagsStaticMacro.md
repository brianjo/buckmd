...
## Class LdflagsStaticMacro {#class-ldflagsstaticmacro .title title="Class LdflagsStaticMacro"}
:::
...
-   -   [com.facebook.buck.rules.macros.CxxGenruleFilterAndTargetsMacro](CxxGenruleFilterAndTargetsMacro.html "class in com.facebook.buck.rules.macros")
    ...
    -   -   com.facebook.buck.rules.macros.LdflagsStaticMacro
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class LdflagsStaticMacro
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static LdflagsStaticMacro`   `of​(Optional<Pattern> pattern,   com.google.common.collect.ImmutableList<BuildTarget> buildTargets)`    
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### of
            ...
            ``` methodSignature
            public static LdflagsStaticMacro of​(Optional<Pattern> pattern,
