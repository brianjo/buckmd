...
## Class BuckInitializationDurationEvent {#class-buckinitializationdurationevent .title title="Class BuckInitializationDurationEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.BuckInitializationDurationEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class BuckInitializationDurationEvent
        extends AbstractBuckEvent

    ::: block
    Event that contains the duration of time Buck took to perform
    initializations before command is about to be executed, starting
    from call to main().
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------- -------------
          `BuckInitializationDurationEvent​(long duration)`    
