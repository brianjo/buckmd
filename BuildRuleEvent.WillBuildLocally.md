...
## Class BuildRuleEvent.WillBuildLocally {#class-buildruleevent.willbuildlocally .title title="Class BuildRuleEvent.WillBuildLocally"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.core.build.event.BuildRuleEvent.WillBuildLocally
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class BuildRuleEvent.WillBuildLocally
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------ -------------
          `WillBuildLocally​(BuildRule rule)`    
