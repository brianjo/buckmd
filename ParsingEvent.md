...
## Class ParsingEvent {#class-parsingevent .title title="Class ParsingEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.ParsingEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- ------------------------------------ -------------
          `static class `     `ParsingEvent.EnvVariableChange`      
          `static class `     `ParsingEvent.SymlinkInvalidation`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------------------------------- -------------
          `ParsingEvent​(EventKey eventKey,             String eventName)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ------------------------------------------- ------------------------------------ -------------
          `static ParsingEvent.EnvVariableChange`     `environmentalChange​(String diff)`    
          `String`                                    `getEventName()`                      
          `protected String`                          `getValueString()`                    
          `static ParsingEvent.SymlinkInvalidation`   `symlinkInvalidation​(String path)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### ParsingEvent
                ...
                public ParsingEvent​(EventKey eventKey,
                                    String eventName)
    :::
    ...
    -   []{#method.detail}
        ...
        []{#symlinkInvalidation(java.lang.String)}

        -   #### symlinkInvalidation

            ``` methodSignature
            public static ParsingEvent.SymlinkInvalidation symlinkInvalidation​(String path)
            ```

        []{#environmentalChange(java.lang.String)}

        -   #### environmentalChange

            ``` methodSignature
            public static ParsingEvent.EnvVariableChange environmentalChange​(String diff)
            ```
