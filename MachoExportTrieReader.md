...
## Class MachoExportTrieReader {#class-machoexporttriereader .title title="Class MachoExportTrieReader"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.cxx.toolchain.objectfile.MachoExportTrieReader
...
-   
    ...
    ::: block
    The export info is a serialized trie. For trie format reference, see
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------------------------- ------------------------------- -------------
          `static Optional<MachoExportTrieNode>`   `read​(ByteBuffer byteBuffer)`    
