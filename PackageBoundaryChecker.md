...
## Interface PackageBoundaryChecker {#interface-packageboundarychecker .title title="Interface PackageBoundaryChecker"}
:::
...
-   
    ...
    :   `NoopPackageBoundaryChecker`, `ThrowingPackageBoundaryChecker`
    ...
    ::: block
    Performs checks around accessing files outside of a target\'s
    package.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### enforceBuckPackageBoundaries
            ...
            ``` methodSignature
            void enforceBuckPackageBoundaries​(Cell targetCell,
                                              BuildTarget target,
