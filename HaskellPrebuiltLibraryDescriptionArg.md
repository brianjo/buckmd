...
## Class HaskellPrebuiltLibraryDescriptionArg {#class-haskellprebuiltlibrarydescriptionarg .title title="Class HaskellPrebuiltLibraryDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class HaskellPrebuiltLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `Has                  | ::: block             |
        |                       | kellPrebuiltLibraryDe | Builds instances of   |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static Has           | `builder()`           | ::: block             |
        | kellPrebuiltLibraryDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`Ha                  |
        |                       |                       | skellPrebuiltLibraryD |
        |                       |                       | escriptionArg`](Haske |
        |                       |                       | llPrebuiltLibraryDesc |
        |                       |                       | riptionArg.html "clas |
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `com.google.comm      | `getCxxHeaderDirs()`  |                       |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `getExp               |                       |
        | ogle.common.collect.I | ortedCompilerFlags()` |                       |
        | mmutableList<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.go               | `getE                 |                       |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.google           | `get                  |                       |
        | .common.collect.Immut | ProfiledStaticLibs()` |                       |
        | ableList<SourcePath>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.google.commo     | `getSharedLibs()`     |                       |
        | n.collect.ImmutableMa |                       |                       |
        | p<String,​SourcePath>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.google           | `getStaticLibs()`     |                       |
        | .common.collect.Immut |                       |                       |
        | ableList<SourcePath>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `String`              | `getVersion()`        |                       |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getImportDirs
            ...
            [Returns:]{.returnLabel}
            :   The value of the `importDirs` attribute
        ...
        -   #### getStaticLibs
            ...
            [Returns:]{.returnLabel}
            :   The value of the `staticLibs` attribute
        ...
        -   #### getProfiledStaticLibs
            ...
            [Returns:]{.returnLabel}
            :   The value of the `profiledStaticLibs` attribute
        ...
        -   #### getSharedLibs
            ...
            [Returns:]{.returnLabel}
            :   The value of the `sharedLibs` attribute
        ...
        -   #### getExportedCompilerFlags
            ...
            [Returns:]{.returnLabel}
            :   The value of the `exportedCompilerFlags` attribute
        ...
        -   #### getCxxHeaderDirs
            ...
            [Returns:]{.returnLabel}
            :   The value of the `cxxHeaderDirs` attribute
        ...
        -   #### equals
            ...
            `HaskellPrebuiltLibraryDescriptionArg` that have equal
            attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `version`, `id`, `db`,
            `importDirs`, `staticLibs`, `profiledStaticLibs`,
            `sharedLibs`, `exportedLinkerFlags`,
            `exportedCompilerFlags`, `cxxHeaderDirs`, `enableProfiling`,
        ...
        -   #### toString
            ...
            `HaskellPrebuiltLibraryDescriptionArg` with attribute
            values.
            :::
