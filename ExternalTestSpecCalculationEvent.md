...
## Class ExternalTestSpecCalculationEvent {#class-externaltestspeccalculationevent .title title="Class ExternalTestSpecCalculationEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.test.external.ExternalTestSpecCalculationEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class ExternalTestSpecCalculationEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- --------------------------------------------- -------------
          `static class `     `ExternalTestSpecCalculationEvent.Finished`    
          `static class `     `ExternalTestSpecCalculationEvent.Started`     
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------------------------------------- ------------------------------------- -------------
          `static ExternalTestSpecCalculationEvent.Finished`   `finished​(BuildTarget buildTarget)`    
          `BuildTarget`                                        `getBuildTarget()`                     
          `String`                                             `getCategory()`                        
          `String`                                             `getValueString()`                     
          `static ExternalTestSpecCalculationEvent.Started`    `started​(BuildTarget buildTarget)`     
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        []{#started(com.facebook.buck.core.model.BuildTarget)}

        -   #### started

            ``` methodSignature
            public static ExternalTestSpecCalculationEvent.Started started​(BuildTarget buildTarget)
            ```

        []{#finished(com.facebook.buck.core.model.BuildTarget)}

        -   #### finished

            ``` methodSignature
            public static ExternalTestSpecCalculationEvent.Finished finished​(BuildTarget buildTarget)
            ```
    :::
:::
:::
