...
## Interface HasTestTimeout {#interface-hastesttimeout .title title="Interface HasTestTimeout"}
:::
...
-   
    ...
    :   `AndroidInstrumentationTestDescriptionArg`,
        `AppleTestDescriptionArg`, `CxxTestDescriptionArg`,
        `DTestDescriptionArg`, `GoTestDescriptionArg`,
        `GroovyTestDescriptionArg`, `JavaTestDescriptionArg`,
        `KotlinTestDescriptionArg`, `PythonTestDescriptionArg`,
        `RobolectricTestDescriptionArg`, `ScalaTestDescriptionArg`,
