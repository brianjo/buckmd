...
## Class CxxTestModuleRule {#class-cxxtestmodulerule .title title="Class CxxTestModuleRule"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.features.project.intellij.BaseIjModuleRule](../../BaseIjModuleRule.html "class in com.facebook.buck.features.project.intellij")\<[CxxTestDescriptionArg](../../../../../cxx/CxxTestDescriptionArg.html "class in com.facebook.buck.cxx")\>

    -   -   com.facebook.buck.features.project.intellij.lang.cxx.CxxTestModuleRule

::: description
-   

    All Implemented Interfaces:
    :   `IjModuleRule<CxxTestDescriptionArg>`

    ------------------------------------------------------------------------

        public class CxxTestModuleRule
        extends BaseIjModuleRule<CxxTestDescriptionArg>
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `CxxTestModuleRule​(ProjectFilesystem projectFilesystem,                  IjModuleFactoryResolver moduleFactoryResolver,                  IjProjectConfig projectConfig)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------------------------------------- ---------------------------------------------------------------------------------------- -------------
          `void`                                             `apply​(TargetNode<CxxTestDescriptionArg> targetNode,      ModuleBuildContext context)`    
          `IjModuleType`                                     `detectModuleType​(TargetNode<CxxTestDescriptionArg> targetNode)`                          
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### CxxTestModuleRule
                ...
                public CxxTestModuleRule​(ProjectFilesystem projectFilesystem,
    ...
    -   []{#method.detail}
        ...
        -   #### apply
            ...
            ``` methodSignature
            public void apply​(TargetNode<CxxTestDescriptionArg> targetNode,
