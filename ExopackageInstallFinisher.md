...
## Class ExopackageInstallFinisher {#class-exopackageinstallfinisher .title title="Class ExopackageInstallFinisher"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../core/rules/impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   com.facebook.buck.android.ExopackageInstallFinisher
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class ExopackageInstallFinisher
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `ExopackageInstallFinisher​(BuildTarget installerTarget,                          ProjectFilesystem projectFilesystem,                          SourcePathRuleFinder sourcePathRuleFinder,                          HasInstallableApk.ApkInfo apkInfo,                          ExopackageDeviceDirectoryLister directoryLister,                          com.google.common.collect.ImmutableList<BuildRule> extraDeps)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.model.BuildTarget,com.facebook.buck.io.filesystem.ProjectFilesystem,com.facebook.buck.core.rules.SourcePathRuleFinder,com.facebook.buck.android.HasInstallableApk.ApkInfo,com.facebook.buck.android.ExopackageDeviceDirectoryLister,com.google.common.collect.ImmutableList)}

        -   #### ExopackageInstallFinisher

                public ExopackageInstallFinisher​(BuildTarget installerTarget,
