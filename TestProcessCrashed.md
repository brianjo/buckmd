...
## Class TestProcessCrashed {#class-testprocesscrashed .title title="Class TestProcessCrashed"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class TestProcessCrashed
        extends RuntimeException

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../serialized-form.html#com.facebook.buck.test.TestProcessCrashed)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### TestProcessCrashed
                ...
                public TestProcessCrashed​(String msg)
    :::
:::
:::
:::
