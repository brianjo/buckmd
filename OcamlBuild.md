...
## Class OcamlBuild {#class-ocamlbuild .title title="Class OcamlBuild"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../../core/rules/impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   [com.facebook.buck.core.rules.impl.AbstractBuildRuleWithDeclaredAndExtraDeps](../../core/rules/impl/AbstractBuildRuleWithDeclaredAndExtraDeps.html "class in com.facebook.buck.core.rules.impl")
        ...
        -   -   com.facebook.buck.features.ocaml.OcamlBuild
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class OcamlBuild
        extends AbstractBuildRuleWithDeclaredAndExtraDeps

    ::: block
    A build rule which preprocesses, compiles, and assembles an OCaml
    source.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `OcamlBuild​(BuildTarget buildTarget,           ProjectFilesystem projectFilesystem,           BuildRuleParams params,           com.facebook.buck.features.ocaml.OcamlBuildContext ocamlContext,           Compiler cCompiler,           Linker cxxLinker,           boolean bytecodeOnly)`    
    ...
    -   []{#method.summary}
        ...
        |                       | xt buildableContext)` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.faceb            | `getOcamlContext()`   |                       |
        | ook.buck.features.oca |                       |                       |
        | ml.OcamlBuildContext` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `SourcePath`          | `get                  |                       |
        |                       | SourcePathToOutput()` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.model.BuildTarget,com.facebook.buck.io.filesystem.ProjectFilesystem,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.features.ocaml.OcamlBuildContext,com.facebook.buck.cxx.toolchain.Compiler,com.facebook.buck.cxx.toolchain.linker.Linker,boolean)}

        -   #### OcamlBuild

                public OcamlBuild​(BuildTarget buildTarget,
    ...
    -   []{#method.detail}
        ...
        -   #### getOcamlContext
            ...
            ``` methodSignature
            public com.facebook.buck.features.ocaml.OcamlBuildContext getOcamlContext()
            ```
    :::
:::
:::
