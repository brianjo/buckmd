...
## Class AuditBuildInfoCommand {#class-auditbuildinfocommand .title title="Class AuditBuildInfoCommand"}
:::
...
-   -   [com.facebook.buck.cli.CommandWithPluginManager](CommandWithPluginManager.html "class in com.facebook.buck.cli")
    ...
    -   -   [com.facebook.buck.cli.AbstractCommand](AbstractCommand.html "class in com.facebook.buck.cli")
        ...
        -   -   com.facebook.buck.cli.AuditBuildInfoCommand
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class AuditBuildInfoCommand
        extends AbstractCommand

    ::: block
    A subcommand in \`buck audit\` that shows information about Buck
    build.
    :::
:::
