...
## Class VersionControlStatsEvent {#class-versioncontrolstatsevent .title title="Class VersionControlStatsEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.util.versioncontrol.VersionControlStatsEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class VersionControlStatsEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------- -------------
          `VersionControlStatsEvent​(CommonSlowVersionControlStats versionControlStats)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `CommonSlowVersionControlStats`   `getVersionControlStats()`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.util.versioncontrol.CommonSlowVersionControlStats)}
