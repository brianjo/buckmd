...
## Class PrebuiltAppleFrameworkDescription {#class-prebuiltappleframeworkdescription .title title="Class PrebuiltAppleFrameworkDescription"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.apple.PrebuiltAppleFrameworkDescription

::: description
-   

    All Implemented Interfaces:
    :   `BaseDescription<PrebuiltAppleFrameworkDescriptionArg>`,
        `Description<PrebuiltAppleFrameworkDescriptionArg>`,
        `MetadataProvidingDescription<PrebuiltAppleFrameworkDescriptionArg>`,
        `Flavored`,
        `DescriptionWithTargetGraph<PrebuiltAppleFrameworkDescriptionArg>`

    ------------------------------------------------------------------------

        public class PrebuiltAppleFrameworkDescription
        extends Object
        implements DescriptionWithTargetGraph<PrebuiltAppleFrameworkDescriptionArg>, Flavored, MetadataProvidingDescription<PrebuiltAppleFrameworkDescriptionArg>
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------------------------------------------------------------------------------------- -------------
          `PrebuiltAppleFrameworkDescription​(ToolchainProvider toolchainProvider,                                  CxxBuckConfig cxxBuckConfig)`    
    ...
    -   []{#method.summary}
        ...
        |                       | ams,                P | for the given         |
        |                       | rebuiltAppleFramework | [`BuildRuleP          |
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `<U> Optional<U>`     | `createMetad          |                       |
        |                       | ata​(BuildTarget build |                       |
        |                       | Target,               |                       |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `Cl                   | `get                  | ::: block             |
        | ass<PrebuiltAppleFram | ConstructorArgType()` | The type of the       |
        | eworkDescriptionArg>` |                       | constructor argument  |
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### PrebuiltAppleFrameworkDescription
                ...
                public PrebuiltAppleFrameworkDescription​(ToolchainProvider toolchainProvider,
    ...
    -   []{#method.detail}
        ...
        -   #### getConstructorArgType
            ...
            :   `getConstructorArgType` in
                interface `BaseDescription<PrebuiltAppleFrameworkDescriptionArg>`

        []{#createBuildRule(com.facebook.buck.core.rules.BuildRuleCreationContextWithTargetGraph,com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.apple.PrebuiltAppleFrameworkDescriptionArg)}
        ...
        -   #### createBuildRule
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createBuildRule` in
                interface `DescriptionWithTargetGraph<PrebuiltAppleFrameworkDescriptionArg>`
        ...
        []{#createMetadata(com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.rules.ActionGraphBuilder,com.facebook.buck.core.cell.CellPathResolver,com.facebook.buck.apple.PrebuiltAppleFrameworkDescriptionArg,java.util.Optional,java.lang.Class)}
        ...
        -   #### createMetadata
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createMetadata` in
                interface `MetadataProvidingDescription<PrebuiltAppleFrameworkDescriptionArg>`
    :::
:::
:::
:::
