...
## Class XcodeScriptDescriptionArg {#class-xcodescriptdescriptionarg .title title="Class XcodeScriptDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class XcodeScriptDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `XcodeScriptDe        | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static XcodeScriptDe | `builder()`           | ::: block             |
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `com.google.          | `getInputFileLists()` |                       |
        | common.collect.Immuta |                       |                       |
        | bleSortedSet<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.google.          | `getInputs()`         |                       |
        | common.collect.Immuta |                       |                       |
        | bleSortedSet<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.google.          | `                     |                       |
        | common.collect.Immuta | getOutputFileLists()` |                       |
        | bleSortedSet<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `com.google.          | `getOutputs()`        |                       |
        | common.collect.Immuta |                       |                       |
        | bleSortedSet<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getInputs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSortedSet<String> getInputs()
            ```
        ...
        -   #### getInputFileLists
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSortedSet<String> getInputFileLists()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `inputFileLists` attribute
        ...
        -   #### getOutputs
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSortedSet<String> getOutputs()
            ```
        ...
        -   #### getOutputFileLists
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableSortedSet<String> getOutputFileLists()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `outputFileLists` attribute
        ...
        -   #### equals
            ...
            `XcodeScriptDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            `inputFileLists`, `outputs`, `outputFileLists`, `cmd`,
            `licenses`, `labels`, `defaultTargetPlatform`,
            `compatibleWith`, `name`, `srcs`.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `XcodeScriptDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static XcodeScriptDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new XcodeScriptDescriptionArg builder
    :::
:::
:::
:::
