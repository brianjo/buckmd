...
## Class CGoGenerateImportStep {#class-cgogenerateimportstep .title title="Class CGoGenerateImportStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.go.CGoGenerateImportStep
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class CGoGenerateImportStep
        extends ShellStep
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `CGoGenerateImportStep​(AbsPath workingDirectory,                      com.google.common.collect.ImmutableList<String> cgoCommandPrefix,                      com.facebook.buck.features.go.GoPlatform platform,                      java.util.function.Supplier<String> packageName,                      Path bin,                      Path outputFile)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.google.common.collect.ImmutableList,com.facebook.buck.features.go.GoPlatform,java.util.function.Supplier,java.nio.file.Path,java.nio.file.Path)}

        -   #### CGoGenerateImportStep

                public CGoGenerateImportStep​(AbsPath workingDirectory,
                                             com.google.common.collect.ImmutableList<String> cgoCommandPrefix,
                                             com.facebook.buck.features.go.GoPlatform platform,
                                             java.util.function.Supplier<String> packageName,
                                             Path bin,
                                             Path outputFile)
    :::
