...
-   ::: {#test}
    ### `test`{.argName} [(required)]{.argDefault} [\#](#test){.inline-link}
...
-   ::: {#args}
    ...
    The list of arguments to invoke this script with. These are literal
    values, and no shell interpolation is done. These can contain
    [string parameter macros](/function/string_parameter_macros.html),
    for example, to give the location of a generated binary to the test
    script.
    :::
...
-   ::: {#env}
    ...
    script. The key is the variable name, and the value is its value.
    The values can contain [string parameter
    macros](/function/string_parameter_macros.html) such as the location
    of a generated binary to be used by the test script.
    :::

-   ::: {#type}
    ### `type`{.argName} [(defaults to `None`)]{.argDefault} [\#](#type){.inline-link}

    If provided, this will be sent to any configured [external
    runner](/files-and-dirs/buckconfig.html#test.external_runner)
    :::
