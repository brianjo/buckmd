...
## Class IndividualTestEvent {#class-individualtestevent .title title="Class IndividualTestEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.core.test.event.IndividualTestEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class IndividualTestEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- -------------------------------- -------------
          `static class `     `IndividualTestEvent.Finished`    
          `static class `     `IndividualTestEvent.Started`     
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          --------------------------------------- ------------------------------------------------------------------- -------------
          `static IndividualTestEvent.Finished`   `finished​(Iterable<String> targets,         TestResults results)`    
          `static IndividualTestEvent.Started`    `started​(Iterable<String> targets)`                                  
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### started
            ...
            ``` methodSignature
            public static IndividualTestEvent.Started started​(Iterable<String> targets)
            ```

        []{#finished(java.lang.Iterable,com.facebook.buck.test.TestResults)}

        -   #### finished

            ``` methodSignature
            public static IndividualTestEvent.Finished finished​(Iterable<String> targets,
                                                                TestResults results)
            ```
    :::
:::
