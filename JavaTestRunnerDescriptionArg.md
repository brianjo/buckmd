...
## Class JavaTestRunnerDescriptionArg {#class-javatestrunnerdescriptionarg .title title="Class JavaTestRunnerDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class JavaTestRunnerDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `JavaTestRunnerDe     | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `st                   | `builder()`           | ::: block             |
        | atic JavaTestRunnerDe |                       | Creates a builder for |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `JavaTestRunnerDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `JavaTestRunnerDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static JavaTestRunnerDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new JavaTestRunnerDescriptionArg builder
    :::
:::
:::
:::
