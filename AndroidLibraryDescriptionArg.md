...
## Class AndroidLibraryDescriptionArg {#class-androidlibrarydescriptionarg .title title="Class AndroidLibraryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.android.AndroidLibraryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class AndroidLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `AndroidLibraryDe     | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `st                   | `builder()`           | ::: block             |
        | atic AndroidLibraryDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`AndroidLibraryDescr |
        |                       |                       | iptionArg`](AndroidLi |
        |                       |                       | braryDescriptionArg.h |
        |                       |                       | tml "class in com.fac |
        |                       |                       | ebook.buck.android"). |
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `default AndroidL     | `withDe               |                       |
        | ibraryDescriptionArg` | psQuery​(Query query)` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `default AndroidL     | `withProvidedDe       |                       |
        | ibraryDescriptionArg` | psQuery​(Query query)` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `AndroidLibraryDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            `resourceUnionPackage`, `skipNonUnionRDotJava`,
            `finalRName`, `resources`, `proguardConfig`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `AndroidLibraryDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static AndroidLibraryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new AndroidLibraryDescriptionArg builder
        ...
        -   #### withDepsQuery
            ...
            ``` methodSignature
            public default AndroidLibraryDescriptionArg withDepsQuery​(Query query)
            ```
        ...
        -   #### withProvidedDepsQuery
            ...
            ``` methodSignature
            public default AndroidLibraryDescriptionArg withProvidedDepsQuery​(Query query)
            ```
