...
## Class UninstallEvent {#class-uninstallevent .title title="Class UninstallEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.UninstallEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- --------------------------- -------------
          `static class `     `UninstallEvent.Finished`    
          `static class `     `UninstallEvent.Started`     
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------------------- --------------------------------------------------------------------- -------------
          `static UninstallEvent.Finished`   `finished​(UninstallEvent.Started started,         boolean success)`    
          `String`                           `getCategory()`                                                        
          `String`                           `getPackageName()`                                                     
          `protected String`                 `getValueString()`                                                     
          `static UninstallEvent.Started`    `started​(String packageName)`                                          
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### UninstallEvent
                ...
                protected UninstallEvent​(EventKey eventKey,
                                         String packageName)
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### started
            ...
            ``` methodSignature
            public static UninstallEvent.Started started​(String packageName)
            ```

        []{#finished(com.facebook.buck.event.UninstallEvent.Started,boolean)}

        -   #### finished

            ``` methodSignature
            public static UninstallEvent.Finished finished​(UninstallEvent.Started started,
                                                           boolean success)
            ```
    :::
:::
