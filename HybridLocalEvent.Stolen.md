...
## Class HybridLocalEvent.Stolen {#class-hybridlocalevent.stolen .title title="Class HybridLocalEvent.Stolen"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.rules.modern.builders.HybridLocalEvent](HybridLocalEvent.html "class in com.facebook.buck.rules.modern.builders")
...
-   
    ...
    Enclosing class:
    :   [HybridLocalEvent](HybridLocalEvent.html "class in com.facebook.buck.rules.modern.builders")

    ------------------------------------------------------------------------

        public static class HybridLocalEvent.Stolen
        extends HybridLocalEvent

    ::: block
    When the HybridLocalStrategy steals a delegate strategy and starts
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        -   []{#nested.classes.inherited.from.class.com.facebook.buck.rules.modern.builders.HybridLocalEvent}

            ### Nested classes/interfaces inherited from class com.facebook.buck.rules.modern.builders.[HybridLocalEvent](HybridLocalEvent.html "class in com.facebook.buck.rules.modern.builders")
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.rules.modern.builders.HybridLocalEvent}
            ...
            ### Methods inherited from class com.facebook.buck.rules.modern.builders.[HybridLocalEvent](HybridLocalEvent.html "class in com.facebook.buck.rules.modern.builders")
