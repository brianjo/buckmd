...
## Class OcamlYaccStep {#class-ocamlyaccstep .title title="Class OcamlYaccStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.ocaml.OcamlYaccStep
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- ---------------------- -------------
          `static class `     `OcamlYaccStep.Args`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------------------------------------------------------------------------------- -------------
          `OcamlYaccStep​(AbsPath workingDirectory,              SourcePathResolverAdapter resolver,              OcamlYaccStep.Args args)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.facebook.buck.core.sourcepath.resolver.SourcePathResolverAdapter,com.facebook.buck.features.ocaml.OcamlYaccStep.Args)}

        -   #### OcamlYaccStep

                public OcamlYaccStep​(AbsPath workingDirectory,
