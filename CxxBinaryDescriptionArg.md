...
## Class CxxBinaryDescriptionArg {#class-cxxbinarydescriptionarg .title title="Class CxxBinaryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.cxx.CxxBinaryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class CxxBinaryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `CxxBinaryDe          | ::: block             |
        |                       | scriptionArg.Builder` | Builds instances of   |
        |                       |                       | type                  |
        |                       |                       | [`CxxBi               |
        |                       |                       | naryDescriptionArg`]( |
        |                       |                       | CxxBinaryDescriptionA |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static CxxBinaryDe   | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `CxxBinaryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static CxxBinaryDescriptionArg.Builder builder()
            ```

            ::: block
            Creates a builder for
            [`CxxBinaryDescriptionArg`](CxxBinaryDescriptionArg.html "class in com.facebook.buck.cxx").
            :::

            [Returns:]{.returnLabel}
            :   A new CxxBinaryDescriptionArg builder
        ...
        -   #### withDepsQuery
            ...
            ``` methodSignature
            public default CxxBinaryDescriptionArg withDepsQuery​(Query query)
            ```
