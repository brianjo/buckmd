...
## Interface HttpService {#interface-httpservice .title title="Interface HttpService"}
:::
...
-   
    ...
    :   `LoadBalancedService`, `RetryingHttpService`, `SingleUriService`
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### makeRequest
            ...
            ``` methodSignature
            HttpResponse makeRequest​(String path,
