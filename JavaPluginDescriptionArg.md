...
## Class JavaPluginDescriptionArg {#class-javaplugindescriptionarg .title title="Class JavaPluginDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class JavaPluginDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `JavaPluginDe         | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static JavaPluginDe  | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getPluginName
            ...
            [Returns:]{.returnLabel}
            :   The value of the `pluginName` attribute
        ...
        -   #### hashCode
            ...
            `isolateClassLoader`, `doesNotAffectAbi`,
            `supportsAbiGenerationFromSource`, `licenses`, `labels`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `JavaPluginDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static JavaPluginDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new JavaPluginDescriptionArg builder
    :::
:::
:::
:::
