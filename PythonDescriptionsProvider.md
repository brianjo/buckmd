...
## Class PythonDescriptionsProvider {#class-pythondescriptionsprovider .title title="Class PythonDescriptionsProvider"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.python.PythonDescriptionsProvider
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Extension
        public class PythonDescriptionsProvider
        extends Object
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### PythonDescriptionsProvider
                ...
                public PythonDescriptionsProvider()
    :::
