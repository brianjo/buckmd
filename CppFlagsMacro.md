...
## Class CppFlagsMacro {#class-cppflagsmacro .title title="Class CppFlagsMacro"}
:::
...
-   -   [com.facebook.buck.rules.macros.CxxGenruleFilterAndTargetsMacro](CxxGenruleFilterAndTargetsMacro.html "class in com.facebook.buck.rules.macros")
    ...
    -   -   com.facebook.buck.rules.macros.CppFlagsMacro
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class CppFlagsMacro
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static CppFlagsMacro`     `of​(Optional<Pattern> pattern,   com.google.common.collect.ImmutableList<BuildTarget> buildTargets)`    
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### of
            ...
            ``` methodSignature
            public static CppFlagsMacro of​(Optional<Pattern> pattern,
