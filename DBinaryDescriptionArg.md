...
## Class DBinaryDescriptionArg {#class-dbinarydescriptionarg .title title="Class DBinaryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.d.DBinaryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class DBinaryDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `DBinaryDescription.AbstractDBinaryDescriptionArg`.
    Use the builder to create immutable instances:
    `DBinaryDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static DBinaryDe     | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `DBinaryDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `DBinaryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static DBinaryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new DBinaryDescriptionArg builder
    :::
:::
:::
:::
