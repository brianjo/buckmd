...
## Class TestSelectorParseException {#class-testselectorparseexception .title title="Class TestSelectorParseException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class TestSelectorParseException
    ...
    our desire to keep the dependencies of this package to a minimum
    means we\'ll subclass
    [`RuntimeException`](http://docs.oracle.com/javase/7/docs/api/java/lang/RuntimeException.html?is-external=true "class or interface in java.lang"){.externalLink}
    ...
    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.test.selectors.TestSelectorParseException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          `TestSelectorParseException​(String message,                           Exception cause)`    
