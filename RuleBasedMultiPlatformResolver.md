...
## Class RuleBasedMultiPlatformResolver {#class-rulebasedmultiplatformresolver .title title="Class RuleBasedMultiPlatformResolver"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.core.rules.platform.RuleBasedMultiPlatformResolver
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class RuleBasedMultiPlatformResolver
        extends Object
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `RuleBasedMultiPlatformResolver​(ConfigurationRuleResolver configurationRuleResolver,                               RuleBasedPlatformResolver ruleBasedPlatformResolver)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.rules.config.ConfigurationRuleResolver,com.facebook.buck.core.rules.platform.RuleBasedPlatformResolver)}

        -   #### RuleBasedMultiPlatformResolver

                public RuleBasedMultiPlatformResolver​(ConfigurationRuleResolver configurationRuleResolver,
