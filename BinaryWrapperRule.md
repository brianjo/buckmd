...
## Class BinaryWrapperRule {#class-binarywrapperrule .title title="Class BinaryWrapperRule"}
:::
...
-   -   [com.facebook.buck.core.rules.impl.AbstractBuildRule](../impl/AbstractBuildRule.html "class in com.facebook.buck.core.rules.impl")
    ...
    -   -   [com.facebook.buck.core.rules.impl.AbstractBuildRuleWithDeclaredAndExtraDeps](../impl/AbstractBuildRuleWithDeclaredAndExtraDeps.html "class in com.facebook.buck.core.rules.impl")

        -   -   com.facebook.buck.core.rules.tool.BinaryWrapperRule
...
-   
    ...
    ::: block
    A no-op stub class for binary rules which delegate to another rule
    to provide the output path and executable tool.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `BinaryWrapperRule​(BuildTarget buildTarget,                  ProjectFilesystem projectFilesystem,                  BuildRuleParams buildRuleParams)`    
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.core.rules.impl.AbstractBuildRuleWithDeclaredAndExtraDeps}
            ...
            ### Methods inherited from class com.facebook.buck.core.rules.impl.[AbstractBuildRuleWithDeclaredAndExtraDeps](../impl/AbstractBuildRuleWithDeclaredAndExtraDeps.html "class in com.facebook.buck.core.rules.impl")
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.core.rules.tool.BinaryBuildRule}
            ...
            ### Methods inherited from interface com.facebook.buck.core.rules.tool.[BinaryBuildRule](BinaryBuildRule.html "interface in com.facebook.buck.core.rules.tool")
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.core.rules.BuildRule}
            ...
            `compareTo, getBuildDeps, getBuildTarget, getFullyQualifiedName, getProjectFilesystem, getSourcePathToOutput, hasBuildSteps, isCacheable, outputFileCanBeCopied, shouldRespectInputSizeLimitForRemoteExecution, toString, updateBuildRuleResolver`
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### BinaryWrapperRule
                ...
                public BinaryWrapperRule​(BuildTarget buildTarget,
    ...
    -   []{#method.detail}
        ...
        -   #### getRuntimeDeps
            ...
            ``` methodSignature
            public final java.util.stream.Stream<BuildTarget> getRuntimeDeps​(BuildRuleResolver buildRuleResolver)
            ```
