...
## Class RobolectricTestDescriptionArg {#class-robolectrictestdescriptionarg .title title="Class RobolectricTestDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.android.RobolectricTestDescriptionArg
...
-   
    ...
    :   `AndroidKotlinCoreArg`, `BuildRuleArg`, `ConstructorArg`,
        `DataTransferObject`, `HasContacts`, `HasDeclaredDeps`,
        `HasProvidedDeps`, `HasSrcs`, `HasTests`, `HasTestTimeout`,
        `HasTestRunner`, `JavaLibraryDescription.CoreArg`,
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class RobolectricTestDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `RobolectricTestDe    | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `sta                  | `builder()`           | ::: block             |
        | tic RobolectricTestDe |                       | Creates a builder for |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `                     | `getR                 |                       |
        | Optional<SourcePath>` | obolectricManifest()` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `                     | `getRobolectri        |                       |
        | Optional<SourcePath>` | cRuntimeDependency()` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `O                    | `getRunner()`         |                       |
        | ptional<BuildTarget>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `default Robolectr    | `withDeps​(Iterabl     |                       |
        | icTestDescriptionArg` | e<BuildTarget> deps)` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `default Robolectr    | `withSrcs​(Iterab      |                       |
        | icTestDescriptionArg` | le<SourcePath> srcs)` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getRobolectricRuntimeDependency
            ...
            [Returns:]{.returnLabel}
            :   The value of the `robolectricRuntimeDependency`
                attribute
        ...
        -   #### getRobolectricManifest
            ...
            ``` methodSignature
            public Optional<SourcePath> getRobolectricManifest()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `robolectricManifest` attribute
        ...
        -   #### isUseOldStyleableFormat
            ...
            ``` methodSignature
            public boolean isUseOldStyleableFormat()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `useOldStyleableFormat` attribute
        ...
        -   #### isForceFinalResourceIds
            ...
            ``` methodSignature
            public boolean isForceFinalResourceIds()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `forceFinalResourceIds` attribute
        ...
        -   #### isUseBinaryResources
            ...
            ``` methodSignature
            public boolean isUseBinaryResources()
            ```

            [Returns:]{.returnLabel}
            :   The value of the `useBinaryResources` attribute
        ...
        -   #### equals
            ...
            `RobolectricTestDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            `robolectricRuntimeDependency`, `robolectricManifest`,
            `resourceUnionPackage`, `useOldStyleableFormat`,
            `forceFinalResourceIds`, `useBinaryResources`, `vmArgs`,
            `testType`, `runTestSeparately`, `forkMode`,
            `stdErrLogLevel`, `stdOutLogLevel`, `useCxxLibraries`,
            `cxxLibraryWhitelist`, `testCaseTimeoutMs`, `env`,
            `defaultCxxPlatform`, `contacts`, `testRuleTimeoutMs`,
            ...
            `friendPaths`, `kaptApOptions`, `kotlincPlugins`, `runner`,
            `specs`.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `RobolectricTestDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static RobolectricTestDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new RobolectricTestDescriptionArg builder

        []{#withDeps(java.lang.Iterable)}

        -   #### withDeps

            ``` methodSignature
            public default RobolectricTestDescriptionArg withDeps​(Iterable<BuildTarget> deps)
            ```

        []{#withSrcs(java.lang.Iterable)}

        -   #### withSrcs

            ``` methodSignature
            public default RobolectricTestDescriptionArg withSrcs​(Iterable<SourcePath> srcs)
            ```
    :::
:::
:::
