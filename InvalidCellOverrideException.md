...
## Class InvalidCellOverrideException {#class-invalidcelloverrideexception .title title="Class InvalidCellOverrideException"}
:::
...
-   -   [java.lang.Throwable](http://docs.oracle.com/javase/7/docs/api/java/lang/Throwable.html?is-external=true "class or interface in java.lang"){.externalLink}
    ...
    -   -   [java.lang.Exception](http://docs.oracle.com/javase/7/docs/api/java/lang/Exception.html?is-external=true "class or interface in java.lang"){.externalLink}
        ...
        -   -   com.facebook.buck.core.cell.InvalidCellOverrideException
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class InvalidCellOverrideException
        extends Exception
    ...
    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.core.cell.InvalidCellOverrideException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------ -------------
          `InvalidCellOverrideException​(String message)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### InvalidCellOverrideException
                ...
                public InvalidCellOverrideException​(String message)
    :::
:::
:::
:::
