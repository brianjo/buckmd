...
## Class AnnotationProcessingEvent.Started {#class-annotationprocessingevent.started .title title="Class AnnotationProcessingEvent.Started"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class AnnotationProcessingEvent.Started
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `Started​(BuildTarget buildTarget,        String annotationProcessorName,        AnnotationProcessingEvent.Operation operation,        int round,        boolean isLastRound)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.model.BuildTarget,java.lang.String,com.facebook.buck.jvm.java.AnnotationProcessingEvent.Operation,int,boolean)}
