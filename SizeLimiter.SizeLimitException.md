...
## Class SizeLimiter.SizeLimitException {#class-sizelimiter.sizelimitexception .title title="Class SizeLimiter.SizeLimitException"}
:::
...
-   
    ...
    Enclosing class:
    :   [SizeLimiter](SizeLimiter.html "class in com.facebook.buck.rules.keys")

    ------------------------------------------------------------------------

        public static class SizeLimiter.SizeLimitException
        extends RuntimeException

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.rules.keys.SizeLimiter.SizeLimitException)
:::
