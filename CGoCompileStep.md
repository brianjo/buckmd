...
## Class CGoCompileStep {#class-cgocompilestep .title title="Class CGoCompileStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.go.CGoCompileStep
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `CGoCompileStep​(AbsPath workingDirectory,               com.google.common.collect.ImmutableMap<String,​String> environment,               com.google.common.collect.ImmutableList<String> cgoCommandPrefix,               com.google.common.collect.ImmutableList<String> cppCommandPrefix,               com.google.common.collect.ImmutableList<String> cgoCompilerFlags,               com.google.common.collect.ImmutableList<String> cxxCompilerFlags,               com.google.common.collect.ImmutableList<Path> srcs,               com.facebook.buck.features.go.GoPlatform platform,               Path outputDir)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.google.common.collect.ImmutableMap,com.google.common.collect.ImmutableList,com.google.common.collect.ImmutableList,com.google.common.collect.ImmutableList,com.google.common.collect.ImmutableList,com.google.common.collect.ImmutableList,com.facebook.buck.features.go.GoPlatform,java.nio.file.Path)}

        -   #### CGoCompileStep

                public CGoCompileStep​(AbsPath workingDirectory,
                                      com.google.common.collect.ImmutableMap<String,​String> environment,
                                      com.google.common.collect.ImmutableList<String> cgoCommandPrefix,
                                      com.google.common.collect.ImmutableList<String> cppCommandPrefix,
                                      com.google.common.collect.ImmutableList<String> cgoCompilerFlags,
                                      com.google.common.collect.ImmutableList<String> cxxCompilerFlags,
                                      com.google.common.collect.ImmutableList<Path> srcs,
