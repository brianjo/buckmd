...
## Interface OverrideScheduleRule {#interface-overrideschedulerule .title title="Interface OverrideScheduleRule"}
:::
...
-   
    ...
    :   `CxxLink`, `CxxThinLTOIndex`

    ------------------------------------------------------------------------

        public interface OverrideScheduleRule
        extends BuildRule

    ::: block
    A interface for a
    [`BuildRule`](../BuildRule.html "interface in com.facebook.buck.core.rules")
    which overrides how it gets scheduled by the build engine.
    :::
:::
