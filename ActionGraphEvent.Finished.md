...
## Class ActionGraphEvent.Finished {#class-actiongraphevent.finished .title title="Class ActionGraphEvent.Finished"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.event.ActionGraphEvent](ActionGraphEvent.html "class in com.facebook.buck.event")
        ...
        -   -   com.facebook.buck.event.ActionGraphEvent.Finished
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class ActionGraphEvent.Finished
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------- -------------
          `Finished​(ActionGraphEvent.Started started,         OptionalInt count)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.event.ActionGraphEvent.Started,java.util.OptionalInt)}

        -   #### Finished

                public Finished​(ActionGraphEvent.Started started,
                                OptionalInt count)
    :::
