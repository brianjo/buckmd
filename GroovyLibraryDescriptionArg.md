...
## Class GroovyLibraryDescriptionArg {#class-groovylibrarydescriptionarg .title title="Class GroovyLibraryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.jvm.groovy.GroovyLibraryDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class GroovyLibraryDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `GroovyLibraryDescription.AbstractGroovyLibraryDescriptionArg`.
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `GroovyLibraryDe      | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `s                    | `builder()`           | ::: block             |
        | tatic GroovyLibraryDe |                       | Creates a builder for |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `GroovyLibraryDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `GroovyLibraryDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static GroovyLibraryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new GroovyLibraryDescriptionArg builder
    :::
:::
:::
:::
