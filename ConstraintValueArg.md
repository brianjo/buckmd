...
## Class ConstraintValueArg {#class-constraintvaluearg .title title="Class ConstraintValueArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ConstraintValueArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `Constr               | ::: block             |
        |                       | aintValueArg.Builder` | Builds instances of   |
        |                       |                       | type                  |
        |                       |                       | [`ConstraintV         |
        |                       |                       | alueArg`](ConstraintV |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static Constr        | `builder()`           | ::: block             |
        | aintValueArg.Builder` |                       | Creates a builder for |
        |                       |                       | [`ConstraintV         |
        |                       |                       | alueArg`](ConstraintV |
        |                       |                       | alueArg.html "class i |
        |                       |                       | n com.facebook.buck.c |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `Unc                  | `ge                   |                       |
        | onfiguredBuildTarget` | tConstraintSetting()` |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getConstraintSetting
            ...
            [Returns:]{.returnLabel}
            :   The value of the `constraintSetting` attribute
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `ConstraintValueArg` with
            attribute values.
            :::
