...
## Class ChunkAccumulator {#class-chunkaccumulator .title title="Class ChunkAccumulator"}
:::
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `com.google.common.collect.ImmutableList<String>`   `getChunks()`             
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(java.nio.charset.Charset,long)}

        -   #### ChunkAccumulator

                public ChunkAccumulator​(Charset charset,
                                        long maxSize)
    :::
