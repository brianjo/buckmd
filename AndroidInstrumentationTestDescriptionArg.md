...
## Class AndroidInstrumentationTestDescriptionArg {#class-androidinstrumentationtestdescriptionarg .title title="Class AndroidInstrumentationTestDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.android.AndroidInstrumentationTestDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class AndroidInstrumentationTestDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `AndroidInstrumentationTestDescription.AbstractAndroidInstrumentationTestDescriptionArg`.
    Use the builder to create immutable instances:
    `AndroidInstrumentationTestDescriptionArg.builder()`.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `Android              | ::: block             |
        |                       | InstrumentationTestDe | Builds instances of   |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static Android       | `builder()`           | ::: block             |
        | InstrumentationTestDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`A                   |
        |                       |                       | ndroidInstrumentation |
        |                       |                       | TestDescriptionArg`]( |
        |                       |                       | AndroidInstrumentatio |
        |                       |                       | nTestDescriptionArg.h |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `AndroidInstrumentationTestDescriptionArg` that have equal
            attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `apk`, `licenses`,
        ...
        -   #### toString
            ...
            `AndroidInstrumentationTestDescriptionArg` with attribute
            values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static AndroidInstrumentationTestDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new AndroidInstrumentationTestDescriptionArg builder
    :::
:::
:::
:::
