...
## Class StandardJavacPlugin {#class-standardjavacplugin .title title="Class StandardJavacPlugin"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class StandardJavacPlugin
        extends NoopBuildRuleWithDeclaredAndExtraDeps

    ::: block
    Represents a standard Java Compiler Plugin, that is, not an
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `StandardJavacPlugin​(BuildTarget buildTarget,                    ProjectFilesystem projectFilesystem,                    BuildRuleParams params,                    com.facebook.buck.jvm.java.JavacPluginProperties properties)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          ---------------------------------------------------- ----------------------------- -------------
          `ResolvedJavacPluginProperties`                      `getPluginProperties()`        
          `com.facebook.buck.jvm.java.JavacPluginProperties`   `getUnresolvedProperties()`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.model.BuildTarget,com.facebook.buck.io.filesystem.ProjectFilesystem,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.jvm.java.JavacPluginProperties)}
        ...
        -   #### StandardJavacPlugin
                ...
                public StandardJavacPlugin​(BuildTarget buildTarget,
                                           ...
                                           com.facebook.buck.jvm.java.JavacPluginProperties properties)
    :::
