...
## Interface AndroidSdkLocation {#interface-androidsdklocation .title title="Interface AndroidSdkLocation"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public interface AndroidSdkLocation
...
-   ::: {.section role="region"}
    -   []{#field.detail}
        ...
        -   #### DEFAULT_NAME
            ...
            [See Also:]{.seeLabel}
            :   [Constant Field
                Values](../../../../../constant-values.html#com.facebook.buck.android.toolchain.AndroidSdkLocation.DEFAULT_NAME)
    :::
