...
## Class RustLibraryDescriptionArg {#class-rustlibrarydescriptionarg .title title="Class RustLibraryDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.features.rust.RustLibraryDescriptionArg
...
-   
    ...
    :   `BuildRuleArg`, `ConstructorArg`, `DataTransferObject`,
        ...
        `HasNamedDeclaredDeps`, `RustCommonArgs`
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class RustLibraryDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `RustLibraryDe        | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static RustLibraryDe | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `RustLibraryDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### hashCode
            ...
            `procMacro`, `mappedSrcs`, `env`, `edition`, `features`,
            `rustcFlags`, `crate`, `crateRoot`, `platformDeps`,
            `compatibleWith`, `defaultTargetPlatform`, `labels`,
            `licenses`, `name`, `namedDeps`, `deps`, `srcs`,
            `defaultPlatform`, `tests`.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `RustLibraryDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static RustLibraryDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new RustLibraryDescriptionArg builder
    :::
:::
:::
:::
