...
## Class AppleToolchainSetDescriptionArg {#class-appletoolchainsetdescriptionarg .title title="Class AppleToolchainSetDescriptionArg"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class AppleToolchainSetDescriptionArg
        extends Object

    ::: block
    An apple_toolchain_set is a list of available apple_toolchain
    targets.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `AppleToolchainSetDe  | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `stati                | `builder()`           | ::: block             |
        | c AppleToolchainSetDe |                       | Creates a builder for |
        | scriptionArg.Builder` |                       | [`Ap                  |
        |                       |                       | pleToolchainSetDescri |
        |                       |                       | ptionArg`](AppleToolc |
        |                       |                       | hainSetDescriptionArg |
        |                       |                       | .html "class in com.f |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.google.          | `                     | ::: block             |
        | common.collect.Immuta | getAppleToolchains()` | List of available     |
        | bleList<BuildTarget>` |                       | toolchains in         |
        |                       |                       | apple_toolchain       |
        |                       |                       | targets.              |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getAppleToolchains
            ...
            ``` methodSignature
            public com.google.common.collect.ImmutableList<BuildTarget> getAppleToolchains()
            ```
        ...
        -   #### equals
            ...
            `AppleToolchainSetDescriptionArg` that have equal attribute
            values.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `AppleToolchainSetDescriptionArg`
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static AppleToolchainSetDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new AppleToolchainSetDescriptionArg builder
    :::
:::
:::
:::
