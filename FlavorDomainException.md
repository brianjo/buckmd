...
## Class FlavorDomainException {#class-flavordomainexception .title title="Class FlavorDomainException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class FlavorDomainException
        extends HumanReadableException

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.core.model.FlavorDomainException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------- -------------
          `FlavorDomainException​(String msg)`    
