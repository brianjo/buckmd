...
## Class WorkerMacroExpander {#class-workermacroexpander .title title="Class WorkerMacroExpander"}
:::
...
-   -   [com.facebook.buck.rules.macros.AbstractMacroExpanderWithoutPrecomputedWork](AbstractMacroExpanderWithoutPrecomputedWork.html "class in com.facebook.buck.rules.macros")\<M\>
    ...
    -   -   [com.facebook.buck.rules.macros.BuildTargetMacroExpander](BuildTargetMacroExpander.html "class in com.facebook.buck.rules.macros")\<[WorkerMacro](WorkerMacro.html "class in com.facebook.buck.rules.macros")\>

        -   -   com.facebook.buck.rules.macros.WorkerMacroExpander

::: description
-   

    All Implemented Interfaces:
    :   `MacroExpander<WorkerMacro,​Object>`

    ------------------------------------------------------------------------

        public class WorkerMacroExpander
        extends BuildTargetMacroExpander<WorkerMacro>
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `Class<WorkerMacro>`   `getInputClass()`                                                                                
          `protected Tool`       `getTool​(BuildRule rule)`                                                                        
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        []{#getTool(com.facebook.buck.core.rules.BuildRule)}
        ...
        []{#expand(com.facebook.buck.core.sourcepath.resolver.SourcePathResolverAdapter,com.facebook.buck.rules.macros.WorkerMacro,com.facebook.buck.core.rules.BuildRule)}
        ...
        -   #### expand
            ...
            :   `expand` in
                class `BuildTargetMacroExpander<WorkerMacro>`
