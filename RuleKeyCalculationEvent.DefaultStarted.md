...
## Class RuleKeyCalculationEvent.DefaultStarted {#class-rulekeycalculationevent.defaultstarted .title title="Class RuleKeyCalculationEvent.DefaultStarted"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.event.RuleKeyCalculationEvent.Event](RuleKeyCalculationEvent.Event.html "class in com.facebook.buck.event")

        -   -   com.facebook.buck.event.RuleKeyCalculationEvent.DefaultStarted
...
-   
    ...
    :   `BuckEvent`, `BuckEventExternalInterface`, `LeafEvent`,
        `RuleKeyCalculationEvent`, `RuleKeyCalculationEvent.Started`,
        `WorkAdvanceEvent`
    ...
    ------------------------------------------------------------------------
        ...
        public static class RuleKeyCalculationEvent.DefaultStarted
        extends RuleKeyCalculationEvent.Event
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        -   []{#methods.inherited.from.class.com.facebook.buck.event.RuleKeyCalculationEvent.Event}

            ### Methods inherited from class com.facebook.buck.event.[RuleKeyCalculationEvent.Event](RuleKeyCalculationEvent.Event.html "class in com.facebook.buck.event")

            `getEventName, getTarget, getType, getValueString`
