...
## Interface HasExtraJson {#interface-hasextrajson .title title="Interface HasExtraJson"}
:::
...
-   
    ...
    :   `JsBundleDescriptionArg`, `JsLibraryDescriptionArg`
    ...
    ::: block
    Common interface for rule args that have used-defined JSON that is
