...
## Interface DefectReporter {#interface-defectreporter .title title="Interface DefectReporter"}
:::
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static interface `   | `DefectR              |                       |
        |                       | eporter.DefectReport` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `static interface `   | `DefectReporte        |                       |
        |                       | r.DefectSubmitResult` |                       |
        +-----------------------+-----------------------+-----------------------+
        | `static interface `   | `DefectReporter.File  | ::: block             |
        |                       | ChangesIgnoredReport` | Information helpful   |
        |                       |                       | when diagnosing       |
        |                       |                       | \'buck is not picking |
        |                       |                       | up changes\' reports. |
        |                       |                       | :::                   |
