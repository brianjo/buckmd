...
The `host_info()` function is used to get the current OS and processor
architecture on the host. This will likely change as better cross
compilation tooling comes to Buck. The structure returned is laid out
thusly:
