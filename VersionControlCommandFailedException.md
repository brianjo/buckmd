...
## Class VersionControlCommandFailedException {#class-versioncontrolcommandfailedexception .title title="Class VersionControlCommandFailedException"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class VersionControlCommandFailedException
        extends Exception

    [See Also:]{.seeLabel}
    :   [Serialized
        Form](../../../../../serialized-form.html#com.facebook.buck.util.versioncontrol.VersionControlCommandFailedException)
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------- -------------
          `VersionControlCommandFailedException​(String message)`     
          `VersionControlCommandFailedException​(Throwable cause)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### VersionControlCommandFailedException
                ...
                public VersionControlCommandFailedException​(String message)
    :::
:::
:::
:::
