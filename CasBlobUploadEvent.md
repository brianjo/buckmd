...
## Class CasBlobUploadEvent {#class-casblobuploadevent .title title="Class CasBlobUploadEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.remoteexecution.event.CasBlobUploadEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class CasBlobUploadEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `CasBlob              | ::: block             |
        |                       | UploadEvent.Finished` | Upload to the CAS has |
        |                       |                       | finished.             |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `static class `       | `CasBlo               | ::: block             |
        |                       | bUploadEvent.Started` | Upload to the CAS has |
        |                       |                       | started.              |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
    ...
    -   []{#method.summary}
        ...
        | `String`              | `getEventName()`      |                       |
        +-----------------------+-----------------------+-----------------------+
        | `static Scope`        | `sendEvent​(BuckEvent  | ::: block             |
        |                       | Bus eventBus,         | Send the Started and  |
        |                       |   int blobCount,      | returns a Scoped      |
        |                       |      long sizeBytes)` | object that sends the |
        |                       |                       | Finished event.       |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        []{#sendEvent(com.facebook.buck.event.BuckEventBus,int,long)}
        ...
        -   #### sendEvent
            ...
            ::: block
            Send the Started and returns a Scoped object that sends the
            Finished event.
            :::
