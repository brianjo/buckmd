...
## Class GCMinorCollectionEvent {#class-gcminorcollectionevent .title title="Class GCMinorCollectionEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.support.jvm.GCCollectionEvent](GCCollectionEvent.html "class in com.facebook.buck.support.jvm")
        ...
        -   -   com.facebook.buck.support.jvm.GCMinorCollectionEvent
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class GCMinorCollectionEvent
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ---------------------------------------------------------- -------------
          `GCMinorCollectionEvent​(com.sun.management.GcInfo info)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### GCMinorCollectionEvent
                ...
                public GCMinorCollectionEvent​(com.sun.management.GcInfo info)
    :::
