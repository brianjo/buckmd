...
## Class BuildRuleEvent.StartedRuleKeyCalc {#class-buildruleevent.startedrulekeycalc .title title="Class BuildRuleEvent.StartedRuleKeyCalc"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](../../../event/AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   [com.facebook.buck.core.build.event.BuildRuleEvent](BuildRuleEvent.html "class in com.facebook.buck.core.build.event")
        ...
        -   -   [com.facebook.buck.core.build.event.BuildRuleEvent.BeginningBuildRuleEvent](BuildRuleEvent.BeginningBuildRuleEvent.html "class in com.facebook.buck.core.build.event")
            ...
            -   -   [com.facebook.buck.core.build.event.BuildRuleEvent.Started](BuildRuleEvent.Started.html "class in com.facebook.buck.core.build.event")

                -   -   com.facebook.buck.core.build.event.BuildRuleEvent.StartedRuleKeyCalc
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public static class BuildRuleEvent.StartedRuleKeyCalc
        extends BuildRuleEvent.Started
        implements RuleKeyCalculationEvent.Started

    ::: block
    Marks the start of processing a rule to calculate its rule key. We
    overload this as both a rule start and rule key calc start event to
    generate less events and be more efficient.
    :::
:::
