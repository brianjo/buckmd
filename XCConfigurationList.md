...
## Class XCConfigurationList {#class-xcconfigurationlist .title title="Class XCConfigurationList"}
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          --------------------------------------------------------------- -------------
          `XCConfigurationList​(AbstractPBXObjectFactory objectFactory)`    
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `com                  | `getBuildCo           |                       |
        | .google.common.cache. | nfigurationsByName()` |                       |
        | LoadingCache<String,​X |                       |                       |
        | CBuildConfiguration>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `String`              | `isa()`               |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.apple.xcode.AbstractPBXObjectFactory)}
