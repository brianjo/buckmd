...
## Class SourceSortedSetAttribute {#class-sourcesortedsetattribute .title title="Class SourceSortedSetAttribute"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   [com.facebook.buck.core.starlark.rule.attr.Attribute](../Attribute.html "class in com.facebook.buck.core.starlark.rule.attr")\<com.google.common.collect.ImmutableSortedSet\<[SourcePath](../../../../sourcepath/SourcePath.html "interface in com.facebook.buck.core.sourcepath")\>\>

    -   -   com.facebook.buck.core.starlark.rule.attr.impl.SourceSortedSetAttribute
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class SourceSortedSetAttribute
        extends Attribute<com.google.common.collect.ImmutableSortedSet<SourcePath>>

    ::: block
    Class that represents a set of source files, whether on disk or that
    are other build targets
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `PostCoercionTr       | `getPos               |                       |
        | ansform<RuleAnalysisC | tCoercionTransform()` |                       |
        | ontext,​com.google.com |                       |                       |
        ...
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `TypeCoerc            | `getTypeCoercer()`    | ::: block             |
        | er<?,​com.google.commo |                       | The type coercer to   |
        | n.collect.ImmutableSo |                       | use to convert raw    |
        | rtedSet<SourcePath>>` |                       | values from the       |
        |                       |                       | parser into something |
        |                       |                       | usable internally.    |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
        | `static Sour          | `of​(com.googl         |                       |
        | ceSortedSetAttribute` | e.common.collect.Immu |                       |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `void`                | `v                    | ::: block             |
        |                       | alidateCoercedValue​(c | Validates values      |
        |                       | om.google.common.coll | post-coercion to      |
        |                       | ect.ImmutableSortedSe | ensure other          |
        |                       | t<SourcePath> paths)` | properties besides    |
        |                       |                       | \'type\' are valid    |
        |                       |                       | :::                   |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        -   #### SourceSortedSetAttribute
                ...
                public SourceSortedSetAttribute()
    :::
    ...
    -   []{#method.detail}
        ...
        -   #### getPreCoercionDefaultValue
            ...
            :   `getPreCoercionDefaultValue` in
                class `Attribute<com.google.common.collect.ImmutableSortedSet<SourcePath>>`
        ...
        -   #### getTypeCoercer
            ...
            ``` methodSignature
            public TypeCoercer<?,​com.google.common.collect.ImmutableSortedSet<SourcePath>> getTypeCoercer()
            ```
        ...
        -   #### validateCoercedValue
            ...
            ``` methodSignature
            public void validateCoercedValue​(com.google.common.collect.ImmutableSortedSet<SourcePath> paths)
        ...
        -   #### getPostCoercionTransform
            ...
            ``` methodSignature
            public PostCoercionTransform<RuleAnalysisContext,​com.google.common.collect.ImmutableSortedSet<Artifact>> getPostCoercionTransform()
            ```
        ...
        -   #### of
            ...
            ``` methodSignature
            public static SourceSortedSetAttribute of​(com.google.common.collect.ImmutableSortedSet<String> preCoercionDefaultValue,
                                                      String doc,
                                                      boolean mandatory,
                                                      boolean allowEmpty)
            ```
