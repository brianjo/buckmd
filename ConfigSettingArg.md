...
## Class ConfigSettingArg {#class-configsettingarg .title title="Class ConfigSettingArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.core.rules.configsetting.ConfigSettingArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ConfigSettingArg
        extends Object
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `Conf                 | ::: block             |
        |                       | igSettingArg.Builder` | Builds instances of   |
        |                       |                       | type                  |
        |                       |                       | [`ConfigSettin        |
        |                       |                       | gArg`](ConfigSettingA |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static Conf          | `builder()`           | ::: block             |
        | igSettingArg.Builder` |                       | Creates a builder for |
        |                       |                       | [`ConfigSettin        |
        |                       |                       | gArg`](ConfigSettingA |
        |                       |                       | rg.html "class in com |
        |                       |                       | .facebook.buck.core.r |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `com.goo              | `g                    |                       |
        | gle.common.collect.Im | etConstraintValues()` |                       |
        | mutableSortedSet<Unco |                       |                       |
        | nfiguredBuildTarget>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getConstraintValues
            ...
            [Returns:]{.returnLabel}
            :   The value of the `constraintValues` attribute
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `ConfigSettingArg` with attribute
            values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static ConfigSettingArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new ConfigSettingArg builder
    :::
:::
:::
:::
