...
## Class LeafEvents.SimpleLeafEvent {#class-leafevents.simpleleafevent .title title="Class LeafEvents.SimpleLeafEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.LeafEvents.SimpleLeafEvent
...
-   
    ...
    Enclosing class:
    :   [LeafEvents](LeafEvents.html "class in com.facebook.buck.event")

    ------------------------------------------------------------------------

        public abstract static class LeafEvents.SimpleLeafEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- --------------------------------------- -------------
          `static class `     `LeafEvents.SimpleLeafEvent.Finished`    
          `static class `     `LeafEvents.SimpleLeafEvent.Started`     
