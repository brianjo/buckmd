...
## Class StartActivityEvent {#class-startactivityevent .title title="Class StartActivityEvent"}
:::
...
-   -   [com.facebook.buck.event.AbstractBuckEvent](AbstractBuckEvent.html "class in com.facebook.buck.event")
    ...
    -   -   com.facebook.buck.event.StartActivityEvent
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- ------------------------------- -------------
          `static class `     `StartActivityEvent.Finished`    
          `static class `     `StartActivityEvent.Started`     
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------------------------- ------------------------------------------------------------------------- -------------
          `static StartActivityEvent.Finished`   `finished​(StartActivityEvent.Started started,         boolean success)`    
          `String`                               `getActivityName()`                                                        
          `BuildTarget`                          `getBuildTarget()`                                                         
          `String`                               `getCategory()`                                                            
          `protected String`                     `getValueString()`                                                         
          `static StartActivityEvent.Started`    `started​(BuildTarget buildTarget,        String activityName)`             
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.event.EventKey,com.facebook.buck.core.model.BuildTarget,java.lang.String)}

        -   #### StartActivityEvent

                protected StartActivityEvent​(EventKey eventKey,
    ...
    -   []{#method.detail}
        ...
        []{#started(com.facebook.buck.core.model.BuildTarget,java.lang.String)}

        -   #### started

            ``` methodSignature
            public static StartActivityEvent.Started started​(BuildTarget buildTarget,
                                                             String activityName)
            ```

        []{#finished(com.facebook.buck.event.StartActivityEvent.Started,boolean)}

        -   #### finished

            ``` methodSignature
            public static StartActivityEvent.Finished finished​(StartActivityEvent.Started started,
                                                               boolean success)
            ```
    :::
:::
