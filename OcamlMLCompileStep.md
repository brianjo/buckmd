...
## Class OcamlMLCompileStep {#class-ocamlmlcompilestep .title title="Class OcamlMLCompileStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.ocaml.OcamlMLCompileStep
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class OcamlMLCompileStep
        extends ShellStep
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- --------------------------- -------------
          `static class `     `OcamlMLCompileStep.Args`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `OcamlMLCompileStep​(AbsPath workingDirectory,                   SourcePathResolverAdapter resolver,                   OcamlMLCompileStep.Args args)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.facebook.buck.core.sourcepath.resolver.SourcePathResolverAdapter,com.facebook.buck.features.ocaml.OcamlMLCompileStep.Args)}

        -   #### OcamlMLCompileStep

                public OcamlMLCompileStep​(AbsPath workingDirectory,
