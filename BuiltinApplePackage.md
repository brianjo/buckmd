...
## Class BuiltinApplePackage {#class-builtinapplepackage .title title="Class BuiltinApplePackage"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class BuiltinApplePackage
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `BuiltinApplePackage​(BuildTarget buildTarget,                    ProjectFilesystem projectFilesystem,                    BuildRuleParams params,                    BuildRule bundle,                    ZipCompressionLevel compressionLevel)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.model.BuildTarget,com.facebook.buck.io.filesystem.ProjectFilesystem,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.core.rules.BuildRule,com.facebook.buck.util.zip.ZipCompressionLevel)}

        -   #### BuiltinApplePackage

                public BuiltinApplePackage​(BuildTarget buildTarget,
