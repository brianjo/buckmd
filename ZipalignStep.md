...
## Class ZipalignStep {#class-zipalignstep .title title="Class ZipalignStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.android.ZipalignStep
...
-   ::: {.section role="region"}
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `ZipalignStep​(AbsPath workingDirectory,             AndroidPlatformTarget androidPlatformTarget,             Path inputFile,             Path outputFile)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.facebook.buck.android.toolchain.AndroidPlatformTarget,java.nio.file.Path,java.nio.file.Path)}

        -   #### ZipalignStep

                public ZipalignStep​(AbsPath workingDirectory,
