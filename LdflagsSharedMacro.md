...
## Class LdflagsSharedMacro {#class-ldflagssharedmacro .title title="Class LdflagsSharedMacro"}
:::
...
-   -   [com.facebook.buck.rules.macros.CxxGenruleFilterAndTargetsMacro](CxxGenruleFilterAndTargetsMacro.html "class in com.facebook.buck.rules.macros")
    ...
    -   -   com.facebook.buck.rules.macros.LdflagsSharedMacro
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public abstract class LdflagsSharedMacro
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          `static LdflagsSharedMacro`   `of​(Optional<Pattern> pattern,   com.google.common.collect.ImmutableList<BuildTarget> buildTargets)`    
...
-   ::: {.section role="region"}
    ...
    -   []{#method.detail}
        ...
        -   #### of
            ...
            ``` methodSignature
            public static LdflagsSharedMacro of​(Optional<Pattern> pattern,
