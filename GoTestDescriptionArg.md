...
## Class GoTestDescriptionArg {#class-gotestdescriptionarg .title title="Class GoTestDescriptionArg"}
:::
...
-   
    ...
    :   `BuildRuleArg`, `ConstructorArg`, `DataTransferObject`,
        `HasContacts`, `HasDeclaredDeps`, `HasSrcs`, `HasTestTimeout`,
        `HasTestRunner`, `HasGoLinkable`
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class GoTestDescriptionArg
        extends Object
...
-   ::: {.section role="region"}
    ...
    -   []{#method.summary}
        ...
        | bleSortedSet<String>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
        | `Optional<com.facebo  | `getCoverageMode()`   |                       |
        | ok.buck.features.go.G |                       |                       |
        | oTestCoverStep.Mode>` |                       |                       |
        +-----------------------+-----------------------+-----------------------+
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### getCoverageMode
            ...
            [Returns:]{.returnLabel}
            :   The value of the `coverageMode` attribute
        ...
        -   #### equals
            ...
            `GoTestDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            `packageName`, `coverageMode`, `env`, `runTestSeparately`,
            `compatibleWith`, `defaultTargetPlatform`, `labels`,
            `licenses`, `name`, `contacts`, `deps`, `srcs`, `runner`,
            `specs`, `testRuleTimeoutMs`, `platform`, `linkStyle`,
            `linkMode`, `compilerFlags`, `assemblerFlags`,
            `linkerFlags`, `externalLinkerFlags`, `resources`.
            :::
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `GoTestDescriptionArg` with
            attribute values.
            :::
