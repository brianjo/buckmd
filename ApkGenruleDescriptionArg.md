...
## Class ApkGenruleDescriptionArg {#class-apkgenruledescriptionarg .title title="Class ApkGenruleDescriptionArg"}
:::

::: contentContainer
-   [java.lang.Object](http://docs.oracle.com/javase/7/docs/api/java/lang/Object.html?is-external=true "class or interface in java.lang"){.externalLink}

-   -   com.facebook.buck.android.ApkGenruleDescriptionArg
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        @Immutable
        @CheckReturnValue
        public final class ApkGenruleDescriptionArg
        extends Object

    ::: block
    Immutable implementation of
    `ApkGenruleDescription.AbstractApkGenruleDescriptionArg`.
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        +=======================+=======================+=======================+
        | `static class `       | `ApkGenruleDe         | ::: block             |
    ...
    -   []{#method.summary}
        ...
        +=======================+=======================+=======================+
        | `static ApkGenruleDe  | `builder()`           | ::: block             |
...
-   ::: {.section role="region"}
    -   []{#method.detail}
        ...
        -   #### equals
            ...
            `ApkGenruleDescriptionArg` that have equal attribute values.
            :::
        ...
        -   #### hashCode
            ...
            ::: block
            Computes a hash code from attributes: `out`, `apk`,
            `isCacheable`, `bash`, `cmd`, `cmdExe`, `srcs`,
        ...
        -   #### toString
            ...
            ::: block
            Prints the immutable value `ApkGenruleDescriptionArg` with
            attribute values.
            :::
        ...
        -   #### builder
            ...
            ``` methodSignature
            public static ApkGenruleDescriptionArg.Builder builder()
            ```
            ...
            [Returns:]{.returnLabel}
            :   A new ApkGenruleDescriptionArg builder
