...
## Class RustTestDescription {#class-rusttestdescription .title title="Class RustTestDescription"}
:::
...
-   
    ...
    :   `ImplicitDepsInferringDescription<com.facebook.buck.features.rust.RustTestDescription.AbstractRustTestDescriptionArg>`,
        `BaseDescription<RustTestDescriptionArg>`,
        `Description<RustTestDescriptionArg>`, `Flavored`,
        `DescriptionWithTargetGraph<RustTestDescriptionArg>`,
    ...
    ------------------------------------------------------------------------
        ...
        extends Object
        implements DescriptionWithTargetGraph<RustTestDescriptionArg>, ImplicitDepsInferringDescription<com.facebook.buck.features.rust.RustTestDescription.AbstractRustTestDescriptionArg>, Flavored, VersionRoot<RustTestDescriptionArg>
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------- -------------
          `RustTestDescription​(ToolchainProvider toolchainProvider,                    RustBuckConfig rustBuckConfig)`    
    ...
    -   []{#method.summary}
        ...
        |                       |                       |                       |
        |                       |       com.facebook.bu |                       |
        |                       | ck.features.rust.Rust |                       |
        |                       | TestDescription.Abstr |                       |
        |                       | actRustTestDescriptio |                       |
        |                       | nArg constructorArg,  |                       |
        |                       |                       |                       |
        |                       |                com.go |                       |
        ...
        +-----------------------+-----------------------+-----------------------+
        | `Class<Rus            | `get                  | ::: block             |
        | tTestDescriptionArg>` | ConstructorArgType()` | The type of the       |
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.toolchain.ToolchainProvider,com.facebook.buck.features.rust.RustBuckConfig)}

        -   #### RustTestDescription

                public RustTestDescription​(ToolchainProvider toolchainProvider,
    ...
    -   []{#method.detail}
        ...
        -   #### getConstructorArgType
            ...
            :   `getConstructorArgType` in
                interface `BaseDescription<RustTestDescriptionArg>`

        []{#createBuildRule(com.facebook.buck.core.rules.BuildRuleCreationContextWithTargetGraph,com.facebook.buck.core.model.BuildTarget,com.facebook.buck.core.rules.BuildRuleParams,com.facebook.buck.features.rust.RustTestDescriptionArg)}
        ...
        -   #### createBuildRule
            ...
            [Specified by:]{.overrideSpecifyLabel}
            :   `createBuildRule` in
                interface `DescriptionWithTargetGraph<RustTestDescriptionArg>`
        ...
        -   #### findDepsForTargetFromConstructorArgs
            ...
            public void findDepsForTargetFromConstructorArgs​(BuildTarget buildTarget,
                                                             ...
                                                             com.facebook.buck.features.rust.RustTestDescription.AbstractRustTestDescriptionArg constructorArg,
            ...
            :   `findDepsForTargetFromConstructorArgs` in
                interface `ImplicitDepsInferringDescription<com.facebook.buck.features.rust.RustTestDescription.AbstractRustTestDescriptionArg>`
