...
## Class OcamlLexStep {#class-ocamllexstep .title title="Class OcamlLexStep"}
:::
...
-   -   [com.facebook.buck.shell.ShellStep](../../shell/ShellStep.html "class in com.facebook.buck.shell")
    ...
    -   -   com.facebook.buck.features.ocaml.OcamlLexStep
...
-   ::: {.section role="region"}
    -   []{#nested.class.summary}
        ...
        ### Nested Class Summary
          ...
          ------------------- --------------------- -------------
          `static class `     `OcamlLexStep.Args`    
    ...
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------ -------------
          `OcamlLexStep​(AbsPath workingDirectory,             SourcePathResolverAdapter resolver,             OcamlLexStep.Args args)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.filesystems.AbsPath,com.facebook.buck.core.sourcepath.resolver.SourcePathResolverAdapter,com.facebook.buck.features.ocaml.OcamlLexStep.Args)}

        -   #### OcamlLexStep

                public OcamlLexStep​(AbsPath workingDirectory,
                                    SourcePathResolverAdapter resolver,
                                    OcamlLexStep.Args args)
    :::
