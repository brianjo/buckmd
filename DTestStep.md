...
## Class DTestStep {#class-dteststep .title title="Class DTestStep"}
:::
...
-   -   [com.facebook.buck.step.AbstractTestStep](../../step/AbstractTestStep.html "class in com.facebook.buck.step")
    ...
    -   -   com.facebook.buck.features.d.DTestStep
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class DTestStep
        extends AbstractTestStep

    ::: block
    Runs a D test command, remembering its exit code and streaming its
    output to a given output file.
    :::
:::
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ -------------
          `DTestStep​(ProjectFilesystem filesystem,          com.google.common.collect.ImmutableList<String> command,          Path exitCode,          Optional<Long> testRuleTimeoutMs,          Path output)`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.io.filesystem.ProjectFilesystem,com.google.common.collect.ImmutableList,java.nio.file.Path,java.util.Optional,java.nio.file.Path)}

        -   #### DTestStep

                public DTestStep​(ProjectFilesystem filesystem,
