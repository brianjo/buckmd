...
## Class AppleToolchainBuildRule {#class-appletoolchainbuildrule .title title="Class AppleToolchainBuildRule"}
:::
...
-   
    ...
    ------------------------------------------------------------------------
        ...
        public class AppleToolchainBuildRule
    ...
    to use in
    [`AppleToolchainSetBuildRule`](AppleToolchainSetBuildRule.html "class in com.facebook.buck.apple").
    It\'s a
...
-   ::: {.section role="region"}
    -   []{#constructor.summary}
        ...
        ### Constructor Summary
          ...
          -------------------------------------------------------------------------------------------------------------------------------------------------------------------------- -------------
          `AppleToolchainBuildRule​(BuildTarget buildTarget,                        ProjectFilesystem projectFilesystem,                        AppleCxxPlatform appleCxxPlatform)`    
    ...
    -   []{#method.summary}
        ...
        ### Method Summary
          ...
          -------------------- ------------------------- -------------
          `AppleCxxPlatform`   `getAppleCxxPlatform()`    
...
-   ::: {.section role="region"}
    -   []{#constructor.detail}
        ...
        []{#<init>(com.facebook.buck.core.model.BuildTarget,com.facebook.buck.io.filesystem.ProjectFilesystem,com.facebook.buck.apple.toolchain.AppleCxxPlatform)}

        -   #### AppleToolchainBuildRule

                public AppleToolchainBuildRule​(BuildTarget buildTarget,
