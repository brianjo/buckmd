...
## Interface HasOutputName {#interface-hasoutputname .title title="Interface HasOutputName"}
:::
...
-   
    ...
    :   `ApkGenrule`, `BaseGenrule`, `CxxGenrule`, `ExportFile`,
        `ExternallyBuiltApplePackage`, `Filegroup`, `Genrule`,
        `GenruleBinary`, `JarGenrule`, `JsBundleGenrule`,
        `PrebuiltAppleFramework`, `Zip`
    ...
    instances which generate sources with logical \"names\" (e.g. Python
    modules).
    :::
:::
